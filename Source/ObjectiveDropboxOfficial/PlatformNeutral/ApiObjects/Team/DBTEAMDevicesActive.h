...
/// @param linux Array of number of linked linus (desktop) clients with activity.
...
/// @param other Array of number of other linked devices (blackberry, windows phone, etc)  with
/// activity.
