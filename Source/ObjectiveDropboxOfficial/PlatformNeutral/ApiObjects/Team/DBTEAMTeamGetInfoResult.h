...
/// @param numProvisionedUsers The number of accounts that have been invited or are already active
/// members of the team.
...
///
/// @return A json-compatible dictionary representation of the `DBTEAMTeamGetInfoResult` API object.
///
...
///
/// @param dict A json-compatible dictionary representation of the `DBTEAMTeamGetInfoResult` API
/// object.
///
