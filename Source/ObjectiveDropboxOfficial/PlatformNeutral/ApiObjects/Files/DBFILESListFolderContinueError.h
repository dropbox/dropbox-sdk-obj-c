...
/// The `DBFILESListFolderContinueErrorTag` enum type represents the possible tag states with which
/// the `DBFILESListFolderContinueError` union can exist.
...
///
/// @param instance An instance of the `DBFILESListFolderContinueError` API object.
///
/// @return A json-compatible dictionary representation of the `DBFILESListFolderContinueError` API
/// object.
///
...
///
/// @param dict A json-compatible dictionary representation of the `DBFILESListFolderContinueError`
/// API object.
///
