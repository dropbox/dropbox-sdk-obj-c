...
/// The `DBSHARINGShareFolderErrorBaseTag` enum type represents the possible tag states with which
/// the `DBSHARINGShareFolderErrorBase` union can exist.
...
///
/// @return A json-compatible dictionary representation of the `DBSHARINGShareFolderErrorBase` API
/// object.
///
...
///
/// @param dict A json-compatible dictionary representation of the `DBSHARINGShareFolderErrorBase`
/// API object.
///
