...
/// found in resolvedVisibility. This is shown only if the caller is the link's owner.
/// @param revokeFailureReason The failure reason for revoking the link. This field will only be
/// present if the canRevoke is false.
///
...
///
/// @return A json-compatible dictionary representation of the `DBSHARINGLinkPermissions` API
/// object.
///
