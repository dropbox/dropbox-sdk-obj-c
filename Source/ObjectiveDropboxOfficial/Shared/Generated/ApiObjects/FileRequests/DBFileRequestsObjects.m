...
- (instancetype)initWithTitle:(NSString *)title destination:(NSString *)destination deadline:(DBFILEREQUESTSFileRequestDeadline *)deadline open:(NSNumber *)open description_:(NSString *)description_ videoProjectId:(NSString *)videoProjectId {
...
+ (DBFILEREQUESTSCreateFileRequestArgs *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILEREQUESTSFileRequestDeadline *deadline = valueDict[@"deadline"] ? [DBFILEREQUESTSFileRequestDeadlineSerializer deserialize:valueDict[@"deadline"]] : nil;
    ...
    return [[DBFILEREQUESTSCreateFileRequestArgs alloc] initWithTitle:title destination:destination deadline:deadline open:open description_:description_ videoProjectId:videoProjectId];
}
...
- (BOOL)isEqualToDeleteAllClosedFileRequestsError:(DBFILEREQUESTSDeleteAllClosedFileRequestsError *)aDeleteAllClosedFileRequestsError {
...
- (instancetype)initWithFileRequests:(NSArray<DBFILEREQUESTSFileRequest *> *)fileRequests {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](fileRequests);
...
- (BOOL)isEqualToDeleteAllClosedFileRequestsResult:(DBFILEREQUESTSDeleteAllClosedFileRequestsResult *)aDeleteAllClosedFileRequestsResult {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILEREQUESTSDeleteAllClosedFileRequestsResult *)valueObj {
    ...
    jsonDict[@"file_requests"] = [DBArraySerializer serialize:valueObj.fileRequests withBlock:^id(id elem0) { return [DBFILEREQUESTSFileRequestSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILEREQUESTSDeleteAllClosedFileRequestsResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILEREQUESTSFileRequest *> *fileRequests = [DBArraySerializer deserialize:valueDict[@"file_requests"] withBlock:^id(id elem0) { return [DBFILEREQUESTSFileRequestSerializer deserialize:elem0]; }];
...
- (instancetype)initWithIds:(NSArray<NSString *> *)ids {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:@"[-_0-9a-zA-Z]+"]]]](ids);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILEREQUESTSDeleteFileRequestArgs *)valueObj {
    ...
    jsonDict[@"ids"] = [DBArraySerializer serialize:valueObj.ids withBlock:^id(id elem0) { return elem0; }];

    return jsonDict;
}

+ (DBFILEREQUESTSDeleteFileRequestArgs *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<NSString *> *ids = [DBArraySerializer deserialize:valueDict[@"ids"] withBlock:^id(id elem0) { return elem0; }];
...
- (instancetype)initWithId_:(NSString *)id_ url:(NSString *)url title:(NSString *)title created:(NSDate *)created isOpen:(NSNumber *)isOpen fileCount:(NSNumber *)fileCount destination:(NSString *)destination deadline:(DBFILEREQUESTSFileRequestDeadline *)deadline description_:(NSString *)description_ videoProjectId:(NSString *)videoProjectId {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:@"[-_0-9a-zA-Z]+"]](id_);
...
- (instancetype)initWithId_:(NSString *)id_ url:(NSString *)url title:(NSString *)title created:(NSDate *)created isOpen:(NSNumber *)isOpen fileCount:(NSNumber *)fileCount {
    return [self initWithId_:id_ url:url title:title created:created isOpen:isOpen fileCount:fileCount destination:nil deadline:nil description_:nil videoProjectId:nil];
}
...
+ (DBFILEREQUESTSFileRequest *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILEREQUESTSFileRequest alloc] initWithId_:id_ url:url title:title created:created isOpen:isOpen fileCount:fileCount destination:destination deadline:deadline description_:description_ videoProjectId:videoProjectId];
}
...
+ (DBFILEREQUESTSFileRequestDeadline *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILEREQUESTSGracePeriod *allowLateUploads = valueDict[@"allow_late_uploads"] ? [DBFILEREQUESTSGracePeriodSerializer deserialize:valueDict[@"allow_late_uploads"]] : nil;
...
- (BOOL)isEqualToListFileRequestsContinueError:(DBFILEREQUESTSListFileRequestsContinueError *)aListFileRequestsContinueError {
...
+ (DBFILEREQUESTSListFileRequestsV2Result *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILEREQUESTSListFileRequestsV2Result alloc] initWithFileRequests:fileRequests cursor:cursor hasMore:hasMore];
}
...
- (instancetype)initWithId_:(NSString *)id_ title:(NSString *)title destination:(NSString *)destination deadline:(DBFILEREQUESTSUpdateFileRequestDeadline *)deadline open:(NSNumber *)open description_:(NSString *)description_ {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:@"[-_0-9a-zA-Z]+"]](id_);
...
+ (DBFILEREQUESTSUpdateFileRequestArgs *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    NSString *destination = valueDict[@"destination"] ?: nil;
    DBFILEREQUESTSUpdateFileRequestDeadline *deadline = valueDict[@"deadline"] ? [DBFILEREQUESTSUpdateFileRequestDeadlineSerializer deserialize:valueDict[@"deadline"]] : [[DBFILEREQUESTSUpdateFileRequestDeadline alloc] initWithNoUpdate];
    NSNumber *open = valueDict[@"open"] ?: nil;
    NSString *description_ = valueDict[@"description"] ?: nil;

    return [[DBFILEREQUESTSUpdateFileRequestArgs alloc] initWithId_:id_ title:title destination:destination deadline:deadline open:open description_:description_];
}
...
- (DBFILEREQUESTSFileRequestDeadline *)update {
    if (![self isUpdate]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILEREQUESTSUpdateFileRequestDeadlineUpdate, but was %@.", [self tagName]];
    }
    return _update;
}
...
+ (DBFILEREQUESTSUpdateFileRequestDeadline *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"no_update"]) {
        ...
        DBFILEREQUESTSFileRequestDeadline *update = valueDict ? [DBFILEREQUESTSFileRequestDeadlineSerializer deserialize:valueDict] : nil;
