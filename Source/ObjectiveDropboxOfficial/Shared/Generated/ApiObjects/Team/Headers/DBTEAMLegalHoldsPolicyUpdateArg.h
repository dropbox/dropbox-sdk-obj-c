...
/// 
- (instancetype)initWithId_:(NSString *)id_ name:(nullable NSString *)name description_:(nullable NSString *)description_ members:(nullable NSArray<NSString *> *)members;
