...
/// 
- (instancetype)initWithName:(NSString *)name namespaceId:(NSString *)namespaceId namespaceType:(DBTEAMNamespaceType *)namespaceType teamMemberId:(nullable NSString *)teamMemberId quotaLimit:(nullable NSNumber *)quotaLimit;
...
/// @return An initialized instance.
/// 
- (instancetype)initWithName:(NSString *)name namespaceId:(NSString *)namespaceId namespaceType:(DBTEAMNamespaceType *)namespaceType;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMNamespaceMetadata *)instance;
...
/// 
+ (DBTEAMNamespaceMetadata *)deserialize:(NSDictionary<NSString *, id>  *)dict;
