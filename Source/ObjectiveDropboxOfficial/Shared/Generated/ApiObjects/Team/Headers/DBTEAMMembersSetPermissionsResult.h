...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMMembersSetPermissionsResult *)instance;
...
/// 
+ (DBTEAMMembersSetPermissionsResult *)deserialize:(NSDictionary<NSString *, id>  *)dict;
