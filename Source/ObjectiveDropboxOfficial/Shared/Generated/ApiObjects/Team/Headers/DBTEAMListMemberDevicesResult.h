...
/// 
- (instancetype)initWithActiveWebSessions:(nullable NSArray<DBTEAMActiveWebSession *> *)activeWebSessions desktopClientSessions:(nullable NSArray<DBTEAMDesktopClientSession *> *)desktopClientSessions mobileClientSessions:(nullable NSArray<DBTEAMMobileClientSession *> *)mobileClientSessions;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMListMemberDevicesResult *)instance;
...
/// 
+ (DBTEAMListMemberDevicesResult *)deserialize:(NSDictionary<NSString *, id>  *)dict;
