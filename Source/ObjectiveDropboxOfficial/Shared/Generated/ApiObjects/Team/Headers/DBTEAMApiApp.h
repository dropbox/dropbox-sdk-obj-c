...
/// 
- (instancetype)initWithAppId:(NSString *)appId appName:(NSString *)appName isAppFolder:(NSNumber *)isAppFolder publisher:(nullable NSString *)publisher publisherUrl:(nullable NSString *)publisherUrl linked:(nullable NSDate *)linked;
