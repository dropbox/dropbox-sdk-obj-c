...
/// 
- (instancetype)initWithUsers:(NSArray<DBTEAMMemberProfile *> *)users hasMore:(NSNumber *)hasMore cursor:(nullable NSString *)cursor;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMExcludedUsersListResult *)instance;
...
/// 
+ (DBTEAMExcludedUsersListResult *)deserialize:(NSDictionary<NSString *, id>  *)dict;
