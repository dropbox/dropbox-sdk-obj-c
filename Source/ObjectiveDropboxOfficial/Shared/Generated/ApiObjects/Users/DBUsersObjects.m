...
- (instancetype)initWithAccountId:(NSString *)accountId name:(DBUSERSName *)name email:(NSString *)email emailVerified:(NSNumber *)emailVerified disabled:(NSNumber *)disabled profilePhotoUrl:(NSString *)profilePhotoUrl {
...
- (instancetype)initWithAccountId:(NSString *)accountId name:(DBUSERSName *)name email:(NSString *)email emailVerified:(NSNumber *)emailVerified disabled:(NSNumber *)disabled {
...
+ (DBUSERSAccount *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBUSERSAccount alloc] initWithAccountId:accountId name:name email:email emailVerified:emailVerified disabled:disabled profilePhotoUrl:profilePhotoUrl];
}
...
- (instancetype)initWithAccountId:(NSString *)accountId name:(DBUSERSName *)name email:(NSString *)email emailVerified:(NSNumber *)emailVerified disabled:(NSNumber *)disabled isTeammate:(NSNumber *)isTeammate profilePhotoUrl:(NSString *)profilePhotoUrl teamMemberId:(NSString *)teamMemberId {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]](accountId);
    [DBStoneValidators nonnullValidator:nil](name);
    [DBStoneValidators nonnullValidator:nil](email);
    [DBStoneValidators nonnullValidator:nil](emailVerified);
...
+ (DBUSERSBasicAccount *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBUSERSBasicAccount alloc] initWithAccountId:accountId name:name email:email emailVerified:emailVerified disabled:disabled isTeammate:isTeammate profilePhotoUrl:profilePhotoUrl teamMemberId:teamMemberId];
}
...
- (NSNumber *)enabled {
    if (![self isEnabled]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSDistinctMemberHomeValueEnabled, but was %@.", [self tagName]];
    }
    return _enabled;
}
...
- (NSNumber *)enabled {
    if (![self isEnabled]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSFileLockingValueEnabled, but was %@.", [self tagName]];
    }
    return _enabled;
}
...
- (instancetype)initWithAccountId:(NSString *)accountId name:(DBUSERSName *)name email:(NSString *)email emailVerified:(NSNumber *)emailVerified disabled:(NSNumber *)disabled locale:(NSString *)locale referralLink:(NSString *)referralLink isPaired:(NSNumber *)isPaired accountType:(DBUSERSCOMMONAccountType *)accountType rootInfo:(DBCOMMONRootInfo *)rootInfo {
    return [self initWithAccountId:accountId name:name email:email emailVerified:emailVerified disabled:disabled locale:locale referralLink:referralLink isPaired:isPaired accountType:accountType rootInfo:rootInfo profilePhotoUrl:nil country:nil team:nil teamMemberId:nil];
}
...
- (instancetype)initWithId_:(NSString *)id_ name:(NSString *)name sharingPolicies:(DBTEAMPOLICIESTeamSharingPolicies *)sharingPolicies officeAddinPolicy:(DBTEAMPOLICIESOfficeAddInPolicy *)officeAddinPolicy topLevelContentPolicy:(DBTEAMPOLICIESTopLevelContentPolicy *)topLevelContentPolicy {
    [DBStoneValidators nonnullValidator:nil](id_);
    [DBStoneValidators nonnullValidator:nil](name);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBUSERSFullTeam *)valueObj {
    ...
    jsonDict[@"top_level_content_policy"] = [DBTEAMPOLICIESTopLevelContentPolicySerializer serialize:valueObj.topLevelContentPolicy];
...
+ (DBUSERSFullTeam *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *id_ = valueDict[@"id"];
    NSString *name = valueDict[@"name"];
    DBTEAMPOLICIESTeamSharingPolicies *sharingPolicies = [DBTEAMPOLICIESTeamSharingPoliciesSerializer deserialize:valueDict[@"sharing_policies"]];
    DBTEAMPOLICIESOfficeAddInPolicy *officeAddinPolicy = [DBTEAMPOLICIESOfficeAddInPolicySerializer deserialize:valueDict[@"office_addin_policy"]];
    DBTEAMPOLICIESTopLevelContentPolicy *topLevelContentPolicy = [DBTEAMPOLICIESTopLevelContentPolicySerializer deserialize:valueDict[@"top_level_content_policy"]];

    return [[DBUSERSFullTeam alloc] initWithId_:id_ name:name sharingPolicies:sharingPolicies officeAddinPolicy:officeAddinPolicy topLevelContentPolicy:topLevelContentPolicy];
}
...
- (instancetype)initWithAccountIds:(NSArray<NSString *> *)accountIds {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:@(1) maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]]]](accountIds);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBUSERSGetAccountBatchArg *)valueObj {
    ...
    jsonDict[@"account_ids"] = [DBArraySerializer serialize:valueObj.accountIds withBlock:^id(id elem0) { return elem0; }];

    return jsonDict;
}

+ (DBUSERSGetAccountBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<NSString *> *accountIds = [DBArraySerializer deserialize:valueDict[@"account_ids"] withBlock:^id(id elem0) { return elem0; }];
...
- (NSString *)noAccount {
    if (![self isNoAccount]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSGetAccountBatchErrorNoAccount, but was %@.", [self tagName]];
    }
    return _noAccount;
}
...
- (instancetype)initWithGivenName:(NSString *)givenName surname:(NSString *)surname familiarName:(NSString *)familiarName displayName:(NSString *)displayName abbreviatedName:(NSString *)abbreviatedName {
...
+ (DBUSERSName *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBUSERSName alloc] initWithGivenName:givenName surname:surname familiarName:familiarName displayName:displayName abbreviatedName:abbreviatedName];
}
...
- (NSNumber *)enabled {
    if (![self isEnabled]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSPaperAsFilesValueEnabled, but was %@.", [self tagName]];
    }
    return _enabled;
}
...
- (DBUSERSIndividualSpaceAllocation *)individual {
    if (![self isIndividual]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSSpaceAllocationIndividual, but was %@.", [self tagName]];
    }
    return _individual;
}
...
- (DBUSERSTeamSpaceAllocation *)team {
    if (![self isTeam]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSSpaceAllocationTeam, but was %@.", [self tagName]];
    }
    return _team;
}
...
- (NSNumber *)enabled {
    if (![self isEnabled]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSTeamSharedDropboxValueEnabled, but was %@.", [self tagName]];
    }
    return _enabled;
}
...
- (instancetype)initWithUsed:(NSNumber *)used allocated:(NSNumber *)allocated userWithinTeamSpaceAllocated:(NSNumber *)userWithinTeamSpaceAllocated userWithinTeamSpaceLimitType:(DBTEAMCOMMONMemberSpaceLimitType *)userWithinTeamSpaceLimitType userWithinTeamSpaceUsedCached:(NSNumber *)userWithinTeamSpaceUsedCached {
    [DBStoneValidators nonnullValidator:nil](used);
    [DBStoneValidators nonnullValidator:nil](allocated);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBUSERSTeamSpaceAllocation *)valueObj {
    ...
    jsonDict[@"user_within_team_space_limit_type"] = [DBTEAMCOMMONMemberSpaceLimitTypeSerializer serialize:valueObj.userWithinTeamSpaceLimitType];
...
+ (DBUSERSTeamSpaceAllocation *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBTEAMCOMMONMemberSpaceLimitType *userWithinTeamSpaceLimitType = [DBTEAMCOMMONMemberSpaceLimitTypeSerializer deserialize:valueDict[@"user_within_team_space_limit_type"]];
    NSNumber *userWithinTeamSpaceUsedCached = valueDict[@"user_within_team_space_used_cached"];

    return [[DBUSERSTeamSpaceAllocation alloc] initWithUsed:used allocated:allocated userWithinTeamSpaceAllocated:userWithinTeamSpaceAllocated userWithinTeamSpaceLimitType:userWithinTeamSpaceLimitType userWithinTeamSpaceUsedCached:userWithinTeamSpaceUsedCached];
}
...
- (DBUSERSPaperAsFilesValue *)paperAsFiles {
    if (![self isPaperAsFiles]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSUserFeatureValuePaperAsFiles, but was %@.", [self tagName]];
    }
...
- (DBUSERSFileLockingValue *)fileLocking {
    if (![self isFileLocking]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSUserFeatureValueFileLocking, but was %@.", [self tagName]];
    }
    return _fileLocking;
}
...
- (DBUSERSTeamSharedDropboxValue *)teamSharedDropbox {
    if (![self isTeamSharedDropbox]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSUserFeatureValueTeamSharedDropbox, but was %@.", [self tagName]];
    }
...
- (DBUSERSDistinctMemberHomeValue *)distinctMemberHome {
    if (![self isDistinctMemberHome]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBUSERSUserFeatureValueDistinctMemberHome, but was %@.", [self tagName]];
    }
...
+ (NSDictionary<NSString *, id> *)serialize:(DBUSERSUserFeatureValue *)valueObj {
    ...
    if ([valueObj isPaperAsFiles]) {
        ...
        jsonDict[@"team_shared_dropbox"] = [[DBUSERSTeamSharedDropboxValueSerializer serialize:valueObj.teamSharedDropbox] mutableCopy];
        jsonDict[@".tag"] = @"team_shared_dropbox";
    }
    else if ([valueObj isDistinctMemberHome]) {
        jsonDict[@"distinct_member_home"] = [[DBUSERSDistinctMemberHomeValueSerializer serialize:valueObj.distinctMemberHome] mutableCopy];
        jsonDict[@".tag"] = @"distinct_member_home";
    }
    else if ([valueObj isOther]) {
        jsonDict[@".tag"] = @"other";
...
+ (DBUSERSUserFeatureValue *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"paper_as_files"]) {
        DBUSERSPaperAsFilesValue *paperAsFiles = [DBUSERSPaperAsFilesValueSerializer deserialize:valueDict[@"paper_as_files"]];
        ...
        DBUSERSTeamSharedDropboxValue *teamSharedDropbox = [DBUSERSTeamSharedDropboxValueSerializer deserialize:valueDict[@"team_shared_dropbox"]];
        return [[DBUSERSUserFeatureValue alloc] initWithTeamSharedDropbox:teamSharedDropbox];
    }
    else if ([tag isEqualToString:@"distinct_member_home"]) {
        DBUSERSDistinctMemberHomeValue *distinctMemberHome = [DBUSERSDistinctMemberHomeValueSerializer deserialize:valueDict[@"distinct_member_home"]];
...
- (instancetype)initWithFeatures:(NSArray<DBUSERSUserFeature *> *)features {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](features);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBUSERSUserFeaturesGetValuesBatchArg *)valueObj {
    ...
    jsonDict[@"features"] = [DBArraySerializer serialize:valueObj.features withBlock:^id(id elem0) { return [DBUSERSUserFeatureSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBUSERSUserFeaturesGetValuesBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBUSERSUserFeature *> *features = [DBArraySerializer deserialize:valueDict[@"features"] withBlock:^id(id elem0) { return [DBUSERSUserFeatureSerializer deserialize:elem0]; }];
...
- (BOOL)isEqualToUserFeaturesGetValuesBatchError:(DBUSERSUserFeaturesGetValuesBatchError *)anUserFeaturesGetValuesBatchError {
...
- (instancetype)initWithValues:(NSArray<DBUSERSUserFeatureValue *> *)values {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](values);
...
- (BOOL)isEqualToUserFeaturesGetValuesBatchResult:(DBUSERSUserFeaturesGetValuesBatchResult *)anUserFeaturesGetValuesBatchResult {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBUSERSUserFeaturesGetValuesBatchResult *)valueObj {
    ...
    jsonDict[@"values"] = [DBArraySerializer serialize:valueObj.values withBlock:^id(id elem0) { return [DBUSERSUserFeatureValueSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBUSERSUserFeaturesGetValuesBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBUSERSUserFeatureValue *> *values = [DBArraySerializer deserialize:valueDict[@"values"] withBlock:^id(id elem0) { return [DBUSERSUserFeatureValueSerializer deserialize:elem0]; }];
