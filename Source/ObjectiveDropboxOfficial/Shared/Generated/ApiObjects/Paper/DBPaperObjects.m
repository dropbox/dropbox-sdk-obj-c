...
- (instancetype)initWithMember:(DBSHARINGMemberSelector *)member permissionLevel:(DBPAPERPaperDocPermissionLevel *)permissionLevel {
...
+ (DBPAPERAddMember *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBPAPERPaperDocPermissionLevel *permissionLevel = valueDict[@"permission_level"] ? [DBPAPERPaperDocPermissionLevelSerializer deserialize:valueDict[@"permission_level"]] : [[DBPAPERPaperDocPermissionLevel alloc] initWithEdit];
...
- (instancetype)initWithDocId:(NSString *)docId members:(NSArray<DBPAPERAddMember *> *)members customMessage:(NSString *)customMessage quiet:(NSNumber *)quiet {
    [DBStoneValidators nonnullValidator:nil](docId);
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:@(20) itemValidator:[DBStoneValidators nonnullValidator:nil]]](members);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERAddPaperDocUser *)valueObj {
    ...
    jsonDict[@"doc_id"] = valueObj.docId;
    jsonDict[@"members"] = [DBArraySerializer serialize:valueObj.members withBlock:^id(id elem0) { return [DBPAPERAddMemberSerializer serialize:elem0]; }];
...
+ (DBPAPERAddPaperDocUser *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *docId = valueDict[@"doc_id"];
    NSArray<DBPAPERAddMember *> *members = [DBArraySerializer deserialize:valueDict[@"members"] withBlock:^id(id elem0) { return [DBPAPERAddMemberSerializer deserialize:elem0]; }];
...
+ (DBPAPERCursor *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    NSDate *expiration = valueDict[@"expiration"] ? [DBNSDateSerializer deserialize:valueDict[@"expiration"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;
...
- (instancetype)initWithFolderSharingPolicyType:(DBPAPERFolderSharingPolicyType *)folderSharingPolicyType folders:(NSArray<DBPAPERFolder *> *)folders {
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](folders);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERFoldersContainingPaperDoc *)valueObj {
    ...
    if (valueObj.folderSharingPolicyType) {
        jsonDict[@"folder_sharing_policy_type"] = [DBPAPERFolderSharingPolicyTypeSerializer serialize:valueObj.folderSharingPolicyType];
    }
    if (valueObj.folders) {
        jsonDict[@"folders"] = [DBArraySerializer serialize:valueObj.folders withBlock:^id(id elem0) { return [DBPAPERFolderSerializer serialize:elem0]; }];
    }
...
+ (DBPAPERFoldersContainingPaperDoc *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    DBPAPERFolderSharingPolicyType *folderSharingPolicyType = valueDict[@"folder_sharing_policy_type"] ? [DBPAPERFolderSharingPolicyTypeSerializer deserialize:valueDict[@"folder_sharing_policy_type"]] : nil;
    NSArray<DBPAPERFolder *> *folders = valueDict[@"folders"] ? [DBArraySerializer deserialize:valueDict[@"folders"] withBlock:^id(id elem0) { return [DBPAPERFolderSerializer deserialize:elem0]; }] : nil;

    return [[DBPAPERFoldersContainingPaperDoc alloc] initWithFolderSharingPolicyType:folderSharingPolicyType folders:folders];
}
...
- (instancetype)initWithInvitee:(DBSHARINGInviteeInfo *)invitee permissionLevel:(DBPAPERPaperDocPermissionLevel *)permissionLevel {
...
- (BOOL)isEqualToInviteeInfoWithPermissionLevel:(DBPAPERInviteeInfoWithPermissionLevel *)anInviteeInfoWithPermissionLevel {
...
+ (DBPAPERInviteeInfoWithPermissionLevel *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBPAPERPaperDocPermissionLevel *permissionLevel = [DBPAPERPaperDocPermissionLevelSerializer deserialize:valueDict[@"permission_level"]];
...
- (DBPAPERPaperApiCursorError *)cursorError {
    if (![self isCursorError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBPAPERListDocsCursorErrorCursorError, but was %@.", [self tagName]];
    }
    return _cursorError;
}
...
+ (DBPAPERListDocsCursorError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"cursor_error"]) {
        DBPAPERPaperApiCursorError *cursorError = [DBPAPERPaperApiCursorErrorSerializer deserialize:valueDict[@"cursor_error"]];
...
- (instancetype)initWithFilterBy:(DBPAPERListPaperDocsFilterBy *)filterBy sortBy:(DBPAPERListPaperDocsSortBy *)sortBy sortOrder:(DBPAPERListPaperDocsSortOrder *)sortOrder limit:(NSNumber *)limit stopAtDate:(NSDate *)stopAtDate {
...
+ (DBPAPERListPaperDocsArgs *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    DBPAPERListPaperDocsFilterBy *filterBy = valueDict[@"filter_by"] ? [DBPAPERListPaperDocsFilterBySerializer deserialize:valueDict[@"filter_by"]] : [[DBPAPERListPaperDocsFilterBy alloc] initWithDocsAccessed];
    DBPAPERListPaperDocsSortBy *sortBy = valueDict[@"sort_by"] ? [DBPAPERListPaperDocsSortBySerializer deserialize:valueDict[@"sort_by"]] : [[DBPAPERListPaperDocsSortBy alloc] initWithAccessed];
    DBPAPERListPaperDocsSortOrder *sortOrder = valueDict[@"sort_order"] ? [DBPAPERListPaperDocsSortOrderSerializer deserialize:valueDict[@"sort_order"]] : [[DBPAPERListPaperDocsSortOrder alloc] initWithAscending];
    NSNumber *limit = valueDict[@"limit"] ?: @(1000);
    NSDate *stopAtDate = valueDict[@"stop_at_date"] ? [DBNSDateSerializer deserialize:valueDict[@"stop_at_date"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;

    return [[DBPAPERListPaperDocsArgs alloc] initWithFilterBy:filterBy sortBy:sortBy sortOrder:sortOrder limit:limit stopAtDate:stopAtDate];
}
...
- (instancetype)initWithDocIds:(NSArray<NSString *> *)docIds cursor:(DBPAPERCursor *)cursor hasMore:(NSNumber *)hasMore {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](docIds);
    [DBStoneValidators nonnullValidator:nil](cursor);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERListPaperDocsResponse *)valueObj {
    ...
    jsonDict[@"doc_ids"] = [DBArraySerializer serialize:valueObj.docIds withBlock:^id(id elem0) { return elem0; }];
...
+ (DBPAPERListPaperDocsResponse *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<NSString *> *docIds = [DBArraySerializer deserialize:valueDict[@"doc_ids"] withBlock:^id(id elem0) { return elem0; }];
...
- (DBPAPERPaperApiCursorError *)cursorError {
    if (![self isCursorError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBPAPERListUsersCursorErrorCursorError, but was %@.", [self tagName]];
    }
    return _cursorError;
}
...
- (instancetype)initWithInvitees:(NSArray<DBSHARINGInviteeInfo *> *)invitees users:(NSArray<DBSHARINGUserInfo *> *)users cursor:(DBPAPERCursor *)cursor hasMore:(NSNumber *)hasMore {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](invitees);
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](users);
    [DBStoneValidators nonnullValidator:nil](cursor);
    [DBStoneValidators nonnullValidator:nil](hasMore);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERListUsersOnFolderResponse *)valueObj {
    ...
    jsonDict[@"invitees"] = [DBArraySerializer serialize:valueObj.invitees withBlock:^id(id elem0) { return [DBSHARINGInviteeInfoSerializer serialize:elem0]; }];
...
+ (DBPAPERListUsersOnFolderResponse *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBSHARINGInviteeInfo *> *invitees = [DBArraySerializer deserialize:valueDict[@"invitees"] withBlock:^id(id elem0) { return [DBSHARINGInviteeInfoSerializer deserialize:elem0]; }];
    NSArray<DBSHARINGUserInfo *> *users = [DBArraySerializer deserialize:valueDict[@"users"] withBlock:^id(id elem0) { return [DBSHARINGUserInfoSerializer deserialize:elem0]; }];
    DBPAPERCursor *cursor = [DBPAPERCursorSerializer deserialize:valueDict[@"cursor"]];
    NSNumber *hasMore = valueDict[@"has_more"];
...
- (instancetype)initWithDocId:(NSString *)docId limit:(NSNumber *)limit filterBy:(DBPAPERUserOnPaperDocFilter *)filterBy {
    [DBStoneValidators nonnullValidator:nil](docId);
...
+ (DBPAPERListUsersOnPaperDocArgs *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *docId = valueDict[@"doc_id"];
    NSNumber *limit = valueDict[@"limit"] ?: @(1000);
    DBPAPERUserOnPaperDocFilter *filterBy = valueDict[@"filter_by"] ? [DBPAPERUserOnPaperDocFilterSerializer deserialize:valueDict[@"filter_by"]] : [[DBPAPERUserOnPaperDocFilter alloc] initWithShared];
...
- (BOOL)isEqualToListUsersOnPaperDocContinueArgs:(DBPAPERListUsersOnPaperDocContinueArgs *)aListUsersOnPaperDocContinueArgs {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERListUsersOnPaperDocResponse *)valueObj {
    ...
    jsonDict[@"invitees"] = [DBArraySerializer serialize:valueObj.invitees withBlock:^id(id elem0) { return [DBPAPERInviteeInfoWithPermissionLevelSerializer serialize:elem0]; }];
    jsonDict[@"users"] = [DBArraySerializer serialize:valueObj.users withBlock:^id(id elem0) { return [DBPAPERUserInfoWithPermissionLevelSerializer serialize:elem0]; }];
...
+ (DBPAPERListUsersOnPaperDocResponse *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBPAPERInviteeInfoWithPermissionLevel *> *invitees = [DBArraySerializer deserialize:valueDict[@"invitees"] withBlock:^id(id elem0) { return [DBPAPERInviteeInfoWithPermissionLevelSerializer deserialize:elem0]; }];
    NSArray<DBPAPERUserInfoWithPermissionLevel *> *users = [DBArraySerializer deserialize:valueDict[@"users"] withBlock:^id(id elem0) { return [DBPAPERUserInfoWithPermissionLevelSerializer deserialize:elem0]; }];
    DBSHARINGUserInfo *docOwner = [DBSHARINGUserInfoSerializer deserialize:valueDict[@"doc_owner"]];
    DBPAPERCursor *cursor = [DBPAPERCursorSerializer deserialize:valueDict[@"cursor"]];
    NSNumber *hasMore = valueDict[@"has_more"];

    return [[DBPAPERListUsersOnPaperDocResponse alloc] initWithInvitees:invitees users:users docOwner:docOwner cursor:cursor hasMore:hasMore];
}
...
- (instancetype)initWithDocId:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat includeComments:(NSNumber *)includeComments {
    [DBStoneValidators nonnullValidator:nil](docId);
...
- (instancetype)initWithOwner:(NSString *)owner title:(NSString *)title revision:(NSNumber *)revision mimeType:(NSString *)mimeType {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERPaperDocGetMetadataResult *)valueObj {
    ...
    jsonDict[@"revision"] = valueObj.revision;
    jsonDict[@"last_updated_date"] = [DBNSDateSerializer serialize:valueObj.lastUpdatedDate dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
...
+ (DBPAPERPaperDocGetMetadataResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    NSNumber *revision = valueDict[@"revision"];
    NSDate *lastUpdatedDate = [DBNSDateSerializer deserialize:valueDict[@"last_updated_date"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    NSString *lastEditor = valueDict[@"last_editor"];

    return [[DBPAPERPaperDocGetMetadataResult alloc] initWithDocId:docId owner:owner title:title createdDate:createdDate status:status revision:revision lastUpdatedDate:lastUpdatedDate lastEditor:lastEditor];
}
...
+ (DBPAPERPaperDocUpdateArgs *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *docId = valueDict[@"doc_id"];
    DBPAPERPaperDocUpdatePolicy *docUpdatePolicy = [DBPAPERPaperDocUpdatePolicySerializer deserialize:valueDict[@"doc_update_policy"]];
    NSNumber *revision = valueDict[@"revision"];
    DBPAPERImportFormat *importFormat = [DBPAPERImportFormatSerializer deserialize:valueDict[@"import_format"]];
...
- (instancetype)initWithName:(NSString *)name parentFolderId:(NSString *)parentFolderId isTeamFolder:(NSNumber *)isTeamFolder {
    [DBStoneValidators nonnullValidator:nil](name);
...
+ (DBPAPERPaperFolderCreateArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBPAPERPaperFolderCreateArg alloc] initWithName:name parentFolderId:parentFolderId isTeamFolder:isTeamFolder];
}
...
- (instancetype)initWithPublicSharingPolicy:(DBPAPERSharingPublicPolicyType *)publicSharingPolicy teamSharingPolicy:(DBPAPERSharingTeamPolicyType *)teamSharingPolicy {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBPAPERSharingPolicy *)valueObj {
    ...
    if (valueObj.publicSharingPolicy) {
        jsonDict[@"public_sharing_policy"] = [DBPAPERSharingPublicPolicyTypeSerializer serialize:valueObj.publicSharingPolicy];
    }
...
+ (DBPAPERSharingPolicy *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    DBPAPERSharingPublicPolicyType *publicSharingPolicy = valueDict[@"public_sharing_policy"] ? [DBPAPERSharingPublicPolicyTypeSerializer deserialize:valueDict[@"public_sharing_policy"]] : nil;
    DBPAPERSharingTeamPolicyType *teamSharingPolicy = valueDict[@"team_sharing_policy"] ? [DBPAPERSharingTeamPolicyTypeSerializer deserialize:valueDict[@"team_sharing_policy"]] : nil;

    return [[DBPAPERSharingPolicy alloc] initWithPublicSharingPolicy:publicSharingPolicy teamSharingPolicy:teamSharingPolicy];
}
