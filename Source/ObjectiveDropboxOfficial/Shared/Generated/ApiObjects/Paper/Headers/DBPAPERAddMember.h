...
/// 
- (instancetype)initWithMember:(DBSHARINGMemberSelector *)member permissionLevel:(nullable DBPAPERPaperDocPermissionLevel *)permissionLevel;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBPAPERAddMember *)instance;
...
/// 
+ (DBPAPERAddMember *)deserialize:(NSDictionary<NSString *, id>  *)dict;
