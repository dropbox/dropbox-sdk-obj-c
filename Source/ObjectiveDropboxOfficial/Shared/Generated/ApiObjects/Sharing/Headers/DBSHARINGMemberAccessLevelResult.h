...
/// 
- (instancetype)initWithAccessLevel:(nullable DBSHARINGAccessLevel *)accessLevel warning:(nullable NSString *)warning accessDetails:(nullable NSArray<DBSHARINGParentFolderAccessInfo *> *)accessDetails;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBSHARINGMemberAccessLevelResult *)instance;
...
/// 
+ (DBSHARINGMemberAccessLevelResult *)deserialize:(NSDictionary<NSString *, id>  *)dict;
