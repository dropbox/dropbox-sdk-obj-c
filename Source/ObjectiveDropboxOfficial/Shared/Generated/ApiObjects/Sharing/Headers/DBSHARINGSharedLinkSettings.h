...
/// 
- (instancetype)initWithRequirePassword:(nullable NSNumber *)requirePassword linkPassword:(nullable NSString *)linkPassword expires:(nullable NSDate *)expires audience:(nullable DBSHARINGLinkAudience *)audience access:(nullable DBSHARINGRequestedLinkAccessLevel *)access requestedVisibility:(nullable DBSHARINGRequestedVisibility *)requestedVisibility allowDownload:(nullable NSNumber *)allowDownload;
