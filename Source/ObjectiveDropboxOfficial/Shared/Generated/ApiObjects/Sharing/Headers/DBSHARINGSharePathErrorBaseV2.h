...
@class DBSHARINGSharePathErrorBaseV2;
...
/// objects.
///
@interface DBSHARINGSharePathErrorBaseV2 : NSObject <DBSerializable, NSCopying>

#pragma mark - Instance fields

/// The `DBSHARINGSharePathErrorBaseV2Tag` enum type represents the possible tag
/// states with which the `DBSHARINGSharePathErrorBaseV2` union can exist.
typedef NS_CLOSED_ENUM(NSInteger, DBSHARINGSharePathErrorBaseV2Tag) {
  /// A file is at the specified path.
  DBSHARINGSharePathErrorBaseV2IsFile,

  /// We do not support sharing a folder inside a shared folder.
  DBSHARINGSharePathErrorBaseV2InsideSharedFolder,

  /// We do not support shared folders that contain shared folders.
  DBSHARINGSharePathErrorBaseV2ContainsSharedFolder,

  /// We do not support shared folders that contain team folders.
  DBSHARINGSharePathErrorBaseV2ContainsTeamFolder,

  /// We do not support sharing an app folder.
  DBSHARINGSharePathErrorBaseV2IsAppFolder,

  /// We do not support sharing a folder inside an app folder.
  DBSHARINGSharePathErrorBaseV2InsideAppFolder,

  /// A public folder can't be shared this way. Use a public link instead.
  DBSHARINGSharePathErrorBaseV2IsPublicFolder,

  /// A folder inside a public folder can't be shared this way. Use a public
  /// link instead.
  DBSHARINGSharePathErrorBaseV2InsidePublicFolder,

  /// Folder is already shared. Contains metadata about the existing shared
  /// folder.
  DBSHARINGSharePathErrorBaseV2AlreadyShared,

  /// Path is not valid.
  DBSHARINGSharePathErrorBaseV2InvalidPath,

  /// We do not support sharing a Mac OS X package.
  DBSHARINGSharePathErrorBaseV2IsOsxPackage,
  ...
  /// (no description).
  DBSHARINGSharePathErrorBaseV2Other,

};

/// Represents the union's current tag state.
@property (nonatomic, readonly) DBSHARINGSharePathErrorBaseV2Tag tag;
...
///
/// The serialization class for the `DBSHARINGSharePathErrorBaseV2` union.
///
@interface DBSHARINGSharePathErrorBaseV2Serializer : NSObject

///
/// Serializes `DBSHARINGSharePathErrorBaseV2` instances.
///
/// @param instance An instance of the `DBSHARINGSharePathErrorBaseV2` API
/// object.
///
/// @return A json-compatible dictionary representation of the
/// `DBSHARINGSharePathErrorBaseV2` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBSHARINGSharePathErrorBaseV2 *)instance;

///
/// Deserializes `DBSHARINGSharePathErrorBaseV2` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBSHARINGSharePathErrorBaseV2` API object.
///
/// @return An instantiation of the `DBSHARINGSharePathErrorBaseV2` object.
///
+ (DBSHARINGSharePathErrorBaseV2 *)deserialize:(NSDictionary<NSString *, id> *)dict;
