...
/// 
- (instancetype)initWithAction:(DBSHARINGFileAction *)action allow:(NSNumber *)allow reason:(nullable DBSHARINGPermissionDeniedReason *)reason;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBSHARINGFilePermission *)instance;
...
/// 
+ (DBSHARINGFilePermission *)deserialize:(NSDictionary<NSString *, id>  *)dict;
