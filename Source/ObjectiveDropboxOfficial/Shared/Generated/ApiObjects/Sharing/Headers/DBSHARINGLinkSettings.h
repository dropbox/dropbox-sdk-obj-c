...
/// 
- (instancetype)initWithAccessLevel:(nullable DBSHARINGAccessLevel *)accessLevel audience:(nullable DBSHARINGLinkAudience *)audience expiry:(nullable DBSHARINGLinkExpiry *)expiry password:(nullable DBSHARINGLinkPassword *)password;
