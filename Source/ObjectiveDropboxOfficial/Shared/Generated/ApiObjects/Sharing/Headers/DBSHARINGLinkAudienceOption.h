...
/// 
- (instancetype)initWithAudience:(DBSHARINGLinkAudience *)audience allowed:(NSNumber *)allowed disallowedReason:(nullable DBSHARINGLinkAudienceDisallowedReason *)disallowedReason;
