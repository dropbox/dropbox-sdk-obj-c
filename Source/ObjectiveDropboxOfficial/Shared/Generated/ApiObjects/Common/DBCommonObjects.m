...
- (NSString *)root {
    if (![self isRoot]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBCOMMONPathRootRoot, but was %@.", [self tagName]];
    }
    return _root;
}
...
- (NSString *)namespaceId {
    if (![self isNamespaceId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBCOMMONPathRootNamespaceId, but was %@.", [self tagName]];
    }
    return _namespaceId;
}
...
- (DBCOMMONRootInfo *)invalidRoot {
    if (![self isInvalidRoot]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBCOMMONPathRootErrorInvalidRoot, but was %@.", [self tagName]];
    }
    return _invalidRoot;
}
...
- (instancetype)initWithRootNamespaceId:(NSString *)rootNamespaceId homeNamespaceId:(NSString *)homeNamespaceId {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](rootNamespaceId);
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](homeNamespaceId);
...
+ (DBCOMMONTeamRootInfo *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBCOMMONTeamRootInfo alloc] initWithRootNamespaceId:rootNamespaceId homeNamespaceId:homeNamespaceId homePath:homePath];
}
...
+ (DBCOMMONUserRootInfo *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBCOMMONUserRootInfo alloc] initWithRootNamespaceId:rootNamespaceId homeNamespaceId:homeNamespaceId homePath:homePath];
}
