...
/// 
- (instancetype)initWithDimensions:(nullable DBFILESDimensions *)dimensions location:(nullable DBFILESGpsCoordinates *)location timeTaken:(nullable NSDate *)timeTaken duration:(nullable NSNumber *)duration;
...
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBFILESVideoMetadata *)instance;
...
/// 
+ (DBFILESVideoMetadata *)deserialize:(NSDictionary<NSString *, id>  *)dict;
