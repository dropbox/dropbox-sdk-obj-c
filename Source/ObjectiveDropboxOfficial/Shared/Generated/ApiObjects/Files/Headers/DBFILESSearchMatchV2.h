...
/// 
- (instancetype)initWithMetadata:(DBFILESMetadataV2 *)metadata matchType:(nullable DBFILESSearchMatchTypeV2 *)matchType highlightSpans:(nullable NSArray<DBFILESHighlightSpan *> *)highlightSpans;
