...
- (instancetype)initWithPath:(NSString *)path tagText:(NSString *)tagText {
    ...
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:@(32) pattern:@"[\\w]+"]](tagText);
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESBaseTagErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESAddTagErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithPath:(NSString *)path includeMediaInfo:(NSNumber *)includeMediaInfo includeDeleted:(NSNumber *)includeDeleted includeHasExplicitSharedMembers:(NSNumber *)includeHasExplicitSharedMembers includePropertyGroups:(DBFILEPROPERTIESTemplateFilterBase *)includePropertyGroups {
...
- (instancetype)initWithPath:(NSString *)path {
    return [self initWithPath:path includeMediaInfo:nil includeDeleted:nil includeHasExplicitSharedMembers:nil includePropertyGroups:nil];
}
...
+ (DBFILESGetMetadataArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILEPROPERTIESTemplateFilterBase *includePropertyGroups = valueDict[@"include_property_groups"] ? [DBFILEPROPERTIESTemplateFilterBaseSerializer deserialize:valueDict[@"include_property_groups"]] : nil;

    return [[DBFILESGetMetadataArg alloc] initWithPath:path includeMediaInfo:includeMediaInfo includeDeleted:includeDeleted includeHasExplicitSharedMembers:includeHasExplicitSharedMembers includePropertyGroups:includePropertyGroups];
}
...
- (instancetype)initWithPath:(NSString *)path includeMediaInfo:(NSNumber *)includeMediaInfo includeDeleted:(NSNumber *)includeDeleted includeHasExplicitSharedMembers:(NSNumber *)includeHasExplicitSharedMembers includePropertyGroups:(DBFILEPROPERTIESTemplateFilterBase *)includePropertyGroups includePropertyTemplates:(NSArray<NSString *> *)includePropertyTemplates {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*|id:.*)|(rev:[0-9a-f]{9,})|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:@"(/|ptid:).*"]]]](includePropertyTemplates);

    self = [super initWithPath:path includeMediaInfo:includeMediaInfo includeDeleted:includeDeleted includeHasExplicitSharedMembers:includeHasExplicitSharedMembers includePropertyGroups:includePropertyGroups];
    if (self) {
...
- (instancetype)initWithPath:(NSString *)path {
    return [self initWithPath:path includeMediaInfo:nil includeDeleted:nil includeHasExplicitSharedMembers:nil includePropertyGroups:nil includePropertyTemplates:nil];
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESAlphaGetMetadataArg *)valueObj {
    ...
    if (valueObj.includePropertyTemplates) {
        jsonDict[@"include_property_templates"] = [DBArraySerializer serialize:valueObj.includePropertyTemplates withBlock:^id(id elem0) { return elem0; }];
    }
...
+ (DBFILESAlphaGetMetadataArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    NSNumber *includeHasExplicitSharedMembers = valueDict[@"include_has_explicit_shared_members"] ?: @NO;
    DBFILEPROPERTIESTemplateFilterBase *includePropertyGroups = valueDict[@"include_property_groups"] ? [DBFILEPROPERTIESTemplateFilterBaseSerializer deserialize:valueDict[@"include_property_groups"]] : nil;
    NSArray<NSString *> *includePropertyTemplates = valueDict[@"include_property_templates"] ? [DBArraySerializer deserialize:valueDict[@"include_property_templates"] withBlock:^id(id elem0) { return elem0; }] : nil;

    return [[DBFILESAlphaGetMetadataArg alloc] initWithPath:path includeMediaInfo:includeMediaInfo includeDeleted:includeDeleted includeHasExplicitSharedMembers:includeHasExplicitSharedMembers includePropertyGroups:includePropertyGroups includePropertyTemplates:includePropertyTemplates];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESGetMetadataErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESAlphaGetMetadataErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILEPROPERTIESLookUpPropertiesError *)propertiesError {
    if (![self isPropertiesError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESAlphaGetMetadataErrorPropertiesError, but was %@.", [self tagName]];
    }
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESAlphaGetMetadataError *)valueObj {
    ...
    if ([valueObj isPath]) {
        ...
        jsonDict[@"properties_error"] = [[DBFILEPROPERTIESLookUpPropertiesErrorSerializer serialize:valueObj.propertiesError] mutableCopy];
...
+ (DBFILESAlphaGetMetadataError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"path"]) {
        ...
        DBFILEPROPERTIESLookUpPropertiesError *propertiesError = [DBFILEPROPERTIESLookUpPropertiesErrorSerializer deserialize:valueDict[@"properties_error"]];
...
- (instancetype)initWithPath:(NSString *)path mode:(DBFILESWriteMode *)mode autorename:(NSNumber *)autorename clientModified:(NSDate *)clientModified mute:(NSNumber *)mute propertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroup *> *)propertyGroups strictConflict:(NSNumber *)strictConflict {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)|(id:.*)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](propertyGroups);
...
- (instancetype)initWithPath:(NSString *)path {
    return [self initWithPath:path mode:nil autorename:nil clientModified:nil mute:nil propertyGroups:nil strictConflict:nil];
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESCommitInfo *)valueObj {
    ...
    if (valueObj.clientModified) {
        jsonDict[@"client_modified"] = [DBNSDateSerializer serialize:valueObj.clientModified dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    }
...
+ (DBFILESCommitInfo *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *path = valueDict[@"path"];
    DBFILESWriteMode *mode = valueDict[@"mode"] ? [DBFILESWriteModeSerializer deserialize:valueDict[@"mode"]] : [[DBFILESWriteMode alloc] initWithAdd];
    NSNumber *autorename = valueDict[@"autorename"] ?: @NO;
    NSDate *clientModified = valueDict[@"client_modified"] ? [DBNSDateSerializer deserialize:valueDict[@"client_modified"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;
    NSNumber *mute = valueDict[@"mute"] ?: @NO;
    NSArray<DBFILEPROPERTIESPropertyGroup *> *propertyGroups = valueDict[@"property_groups"] ? [DBArraySerializer deserialize:valueDict[@"property_groups"] withBlock:^id(id elem0) { return [DBFILEPROPERTIESPropertyGroupSerializer deserialize:elem0]; }] : nil;
    NSNumber *strictConflict = valueDict[@"strict_conflict"] ?: @NO;

    return [[DBFILESCommitInfo alloc] initWithPath:path mode:mode autorename:autorename clientModified:clientModified mute:mute propertyGroups:propertyGroups strictConflict:strictConflict];
}
...
- (instancetype)initWithPaths:(NSArray<NSString *> *)paths autorename:(NSNumber *)autorename forceAsync:(NSNumber *)forceAsync {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:@(10000) itemValidator:[DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]]]](paths);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESCreateFolderBatchArg *)valueObj {
    ...
    jsonDict[@"paths"] = [DBArraySerializer serialize:valueObj.paths withBlock:^id(id elem0) { return elem0; }];
    jsonDict[@"autorename"] = valueObj.autorename;
...
+ (DBFILESCreateFolderBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<NSString *> *paths = [DBArraySerializer deserialize:valueDict[@"paths"] withBlock:^id(id elem0) { return elem0; }];
    NSNumber *autorename = valueDict[@"autorename"] ?: @NO;
...
- (DBFILESCreateFolderBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderBatchJobStatusComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (DBFILESCreateFolderBatchError *)failed {
    if (![self isFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderBatchJobStatusFailed, but was %@.", [self tagName]];
    }
    return _failed;
}
...
- (NSString *)asyncJobId {
    if (![self isAsyncJobId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderBatchLaunchAsyncJobId, but was %@.", [self tagName]];
    }
    return _asyncJobId;
}
...
- (DBFILESCreateFolderBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderBatchLaunchComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (instancetype)initWithEntries:(NSArray<DBFILESCreateFolderBatchResultEntry *> *)entries {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESCreateFolderBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESCreateFolderBatchResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESCreateFolderBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESCreateFolderBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESCreateFolderBatchResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESCreateFolderEntryResult *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderBatchResultEntrySuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (DBFILESCreateFolderEntryError *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderBatchResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
+ (DBFILESCreateFolderBatchResultEntry *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"success"]) {
        ...
        DBFILESCreateFolderEntryError *failure = [DBFILESCreateFolderEntryErrorSerializer deserialize:valueDict[@"failure"]];
...
- (DBFILESWriteError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESCreateFolderEntryErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithPath:(NSString *)path parentRev:(NSString *)parentRev {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)|(id:.*)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(9) maxLength:nil pattern:@"[0-9a-f]+"]](parentRev);
...
- (instancetype)initWithEntries:(NSArray<DBFILESDeleteArg *> *)entries {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:@(1000) itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESDeleteBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESDeleteArgSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESDeleteBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESDeleteArg *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESDeleteArgSerializer deserialize:elem0]; }];
...
- (DBFILESDeleteBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteBatchJobStatusComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (DBFILESDeleteBatchError *)failed {
    if (![self isFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteBatchJobStatusFailed, but was %@.", [self tagName]];
    }
    return _failed;
}
...
- (NSString *)asyncJobId {
    if (![self isAsyncJobId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteBatchLaunchAsyncJobId, but was %@.", [self tagName]];
    }
    return _asyncJobId;
}
...
- (DBFILESDeleteBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteBatchLaunchComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESDeleteBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESDeleteBatchResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESDeleteBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESDeleteBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESDeleteBatchResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESDeleteBatchResultData *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteBatchResultEntrySuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (DBFILESDeleteError *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteBatchResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
- (DBFILESLookupError *)pathLookup {
    if (![self isPathLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteErrorPathLookup, but was %@.", [self tagName]];
    }
    return _pathLookup;
}
...
- (DBFILESWriteError *)pathWrite {
    if (![self isPathWrite]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDeleteErrorPathWrite, but was %@.", [self tagName]];
    }
    return _pathWrite;
}
...
- (instancetype)initWithName:(NSString *)name pathLower:(NSString *)pathLower pathDisplay:(NSString *)pathDisplay parentSharedFolderId:(NSString *)parentSharedFolderId previewUrl:(NSString *)previewUrl {
    [DBStoneValidators nonnullValidator:nil](name);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](parentSharedFolderId);
...
- (instancetype)initWithName:(NSString *)name pathLower:(NSString *)pathLower pathDisplay:(NSString *)pathDisplay parentSharedFolderId:(NSString *)parentSharedFolderId previewUrl:(NSString *)previewUrl isRestorable:(NSNumber *)isRestorable {
    [DBStoneValidators nonnullValidator:nil](name);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](parentSharedFolderId);

    self = [super initWithName:name pathLower:pathLower pathDisplay:pathDisplay parentSharedFolderId:parentSharedFolderId previewUrl:previewUrl];
    if (self) {
...
- (instancetype)initWithName:(NSString *)name {
    return [self initWithName:name pathLower:nil pathDisplay:nil parentSharedFolderId:nil previewUrl:nil isRestorable:nil];
}
...
+ (DBFILESDeletedMetadata *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESDeletedMetadata alloc] initWithName:name pathLower:pathLower pathDisplay:pathDisplay parentSharedFolderId:parentSharedFolderId previewUrl:previewUrl isRestorable:isRestorable];
}
...
- (instancetype)initWithPath:(NSString *)path rev:(NSString *)rev {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*|id:.*)|(rev:[0-9a-f]{9,})|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(9) maxLength:nil pattern:@"[0-9a-f]+"]](rev);
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDownloadErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESDownloadZipErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESExportErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithExportAs:(NSString *)exportAs exportOptions:(NSArray<NSString *> *)exportOptions {
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](exportOptions);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESExportInfo *)valueObj {
    ...
    if (valueObj.exportOptions) {
        jsonDict[@"export_options"] = [DBArraySerializer serialize:valueObj.exportOptions withBlock:^id(id elem0) { return elem0; }];
    }
...
+ (DBFILESExportInfo *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    NSArray<NSString *> *exportOptions = valueDict[@"export_options"] ? [DBArraySerializer deserialize:valueDict[@"export_options"] withBlock:^id(id elem0) { return elem0; }] : nil;
...
- (instancetype)initWithName:(NSString *)name size:(NSNumber *)size exportHash:(NSString *)exportHash paperRevision:(NSNumber *)paperRevision {
    [DBStoneValidators nonnullValidator:nil](name);
    [DBStoneValidators nonnullValidator:nil](size);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(64) maxLength:@(64) pattern:nil]](exportHash);
...
- (instancetype)initWithExportMetadata:(DBFILESExportMetadata *)exportMetadata fileMetadata:(DBFILESFileMetadata *)fileMetadata {
...
- (DBFILESSingleUserLock *)singleUser {
    if (![self isSingleUser]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESFileLockContentSingleUser, but was %@.", [self tagName]];
    }
    return _singleUser;
}
...
- (instancetype)initWithIsLockholder:(NSNumber *)isLockholder lockholderName:(NSString *)lockholderName lockholderAccountId:(NSString *)lockholderAccountId created:(NSDate *)created {
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]](lockholderAccountId);
...
+ (DBFILESFileLockMetadata *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESFileLockMetadata alloc] initWithIsLockholder:isLockholder lockholderName:lockholderName lockholderAccountId:lockholderAccountId created:created];
}
...
- (instancetype)initWithName:(NSString *)name id_:(NSString *)id_ clientModified:(NSDate *)clientModified serverModified:(NSDate *)serverModified rev:(NSString *)rev size:(NSNumber *)size pathLower:(NSString *)pathLower pathDisplay:(NSString *)pathDisplay parentSharedFolderId:(NSString *)parentSharedFolderId previewUrl:(NSString *)previewUrl mediaInfo:(DBFILESMediaInfo *)mediaInfo symlinkInfo:(DBFILESSymlinkInfo *)symlinkInfo sharingInfo:(DBFILESFileSharingInfo *)sharingInfo isDownloadable:(NSNumber *)isDownloadable exportInfo:(DBFILESExportInfo *)exportInfo propertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroup *> *)propertyGroups hasExplicitSharedMembers:(NSNumber *)hasExplicitSharedMembers contentHash:(NSString *)contentHash fileLockInfo:(DBFILESFileLockMetadata *)fileLockInfo isRestorable:(NSNumber *)isRestorable {
    ...
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](parentSharedFolderId);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](propertyGroups);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(64) maxLength:@(64) pattern:nil]](contentHash);
...
- (instancetype)initWithName:(NSString *)name id_:(NSString *)id_ clientModified:(NSDate *)clientModified serverModified:(NSDate *)serverModified rev:(NSString *)rev size:(NSNumber *)size {
    return [self initWithName:name id_:id_ clientModified:clientModified serverModified:serverModified rev:rev size:size pathLower:nil pathDisplay:nil parentSharedFolderId:nil previewUrl:nil mediaInfo:nil symlinkInfo:nil sharingInfo:nil isDownloadable:nil exportInfo:nil propertyGroups:nil hasExplicitSharedMembers:nil contentHash:nil fileLockInfo:nil isRestorable:nil];
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESFileMetadata *)valueObj {
    ...
    jsonDict[@"id"] = valueObj.id_;
    jsonDict[@"client_modified"] = [DBNSDateSerializer serialize:valueObj.clientModified dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    jsonDict[@"server_modified"] = [DBNSDateSerializer serialize:valueObj.serverModified dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    jsonDict[@"rev"] = valueObj.rev;
    jsonDict[@"size"] = valueObj.size;
    if (valueObj.pathLower) {
        jsonDict[@"path_lower"] = valueObj.pathLower;
...
+ (DBFILESFileMetadata *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *name = valueDict[@"name"];
    NSString *id_ = valueDict[@"id"];
    NSDate *clientModified = [DBNSDateSerializer deserialize:valueDict[@"client_modified"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    NSDate *serverModified = [DBNSDateSerializer deserialize:valueDict[@"server_modified"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    ...
    NSString *parentSharedFolderId = valueDict[@"parent_shared_folder_id"] ?: nil;
    NSString *previewUrl = valueDict[@"preview_url"] ?: nil;
    DBFILESMediaInfo *mediaInfo = valueDict[@"media_info"] ? [DBFILESMediaInfoSerializer deserialize:valueDict[@"media_info"]] : nil;
    DBFILESSymlinkInfo *symlinkInfo = valueDict[@"symlink_info"] ? [DBFILESSymlinkInfoSerializer deserialize:valueDict[@"symlink_info"]] : nil;
    DBFILESFileSharingInfo *sharingInfo = valueDict[@"sharing_info"] ? [DBFILESFileSharingInfoSerializer deserialize:valueDict[@"sharing_info"]] : nil;
    NSNumber *isDownloadable = valueDict[@"is_downloadable"] ?: @YES;
    DBFILESExportInfo *exportInfo = valueDict[@"export_info"] ? [DBFILESExportInfoSerializer deserialize:valueDict[@"export_info"]] : nil;
    NSArray<DBFILEPROPERTIESPropertyGroup *> *propertyGroups = valueDict[@"property_groups"] ? [DBArraySerializer deserialize:valueDict[@"property_groups"] withBlock:^id(id elem0) { return [DBFILEPROPERTIESPropertyGroupSerializer deserialize:elem0]; }] : nil;
...
- (instancetype)initWithReadOnly:(NSNumber *)readOnly parentSharedFolderId:(NSString *)parentSharedFolderId modifiedBy:(NSString *)modifiedBy {
    [DBStoneValidators nonnullValidator:nil](readOnly);
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](parentSharedFolderId);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]](modifiedBy);
...
+ (DBFILESFileSharingInfo *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESFileSharingInfo alloc] initWithReadOnly:readOnly parentSharedFolderId:parentSharedFolderId modifiedBy:modifiedBy];
}
...
- (instancetype)initWithName:(NSString *)name id_:(NSString *)id_ pathLower:(NSString *)pathLower pathDisplay:(NSString *)pathDisplay parentSharedFolderId:(NSString *)parentSharedFolderId previewUrl:(NSString *)previewUrl sharedFolderId:(NSString *)sharedFolderId sharingInfo:(DBFILESFolderSharingInfo *)sharingInfo propertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroup *> *)propertyGroups {
    [DBStoneValidators nonnullValidator:nil](name);
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:nil]](id_);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](parentSharedFolderId);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](sharedFolderId);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](propertyGroups);
...
- (instancetype)initWithName:(NSString *)name id_:(NSString *)id_ {
    return [self initWithName:name id_:id_ pathLower:nil pathDisplay:nil parentSharedFolderId:nil previewUrl:nil sharedFolderId:nil sharingInfo:nil propertyGroups:nil];
}
...
+ (DBFILESFolderMetadata *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILESFolderSharingInfo *sharingInfo = valueDict[@"sharing_info"] ? [DBFILESFolderSharingInfoSerializer deserialize:valueDict[@"sharing_info"]] : nil;
    NSArray<DBFILEPROPERTIESPropertyGroup *> *propertyGroups = valueDict[@"property_groups"] ? [DBArraySerializer deserialize:valueDict[@"property_groups"] withBlock:^id(id elem0) { return [DBFILEPROPERTIESPropertyGroupSerializer deserialize:elem0]; }] : nil;

    return [[DBFILESFolderMetadata alloc] initWithName:name id_:id_ pathLower:pathLower pathDisplay:pathDisplay parentSharedFolderId:parentSharedFolderId previewUrl:previewUrl sharedFolderId:sharedFolderId sharingInfo:sharingInfo propertyGroups:propertyGroups];
}
...
- (instancetype)initWithReadOnly:(NSNumber *)readOnly parentSharedFolderId:(NSString *)parentSharedFolderId sharedFolderId:(NSString *)sharedFolderId traverseOnly:(NSNumber *)traverseOnly noAccess:(NSNumber *)noAccess {
    [DBStoneValidators nonnullValidator:nil](readOnly);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](parentSharedFolderId);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"[-_0-9a-zA-Z:]+"]](sharedFolderId);
...
+ (DBFILESFolderSharingInfo *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESFolderSharingInfo alloc] initWithReadOnly:readOnly parentSharedFolderId:parentSharedFolderId sharedFolderId:sharedFolderId traverseOnly:traverseOnly noAccess:noAccess];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESGetCopyReferenceErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithPaths:(NSArray<NSString *> *)paths {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"/(.|[\\r\\n])*"]]]](paths);
...
- (instancetype)initWithPathsToTags:(NSArray<DBFILESPathToTags *> *)pathsToTags {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](pathsToTags);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESGetTagsResult *)valueObj {
    ...
    jsonDict[@"paths_to_tags"] = [DBArraySerializer serialize:valueObj.pathsToTags withBlock:^id(id elem0) { return [DBFILESPathToTagsSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESGetTagsResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESPathToTags *> *pathsToTags = [DBArraySerializer deserialize:valueDict[@"paths_to_tags"] withBlock:^id(id elem0) { return [DBFILESPathToTagsSerializer deserialize:elem0]; }];
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESGetTemporaryLinkErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESGetThumbnailBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESThumbnailArgSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESGetThumbnailBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESThumbnailArg *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESThumbnailArgSerializer deserialize:elem0]; }];
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESGetThumbnailBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESGetThumbnailBatchResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESGetThumbnailBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESGetThumbnailBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESGetThumbnailBatchResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESGetThumbnailBatchResultData *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESGetThumbnailBatchResultEntrySuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (DBFILESThumbnailError *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESGetThumbnailBatchResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
- (instancetype)initWithPath:(NSString *)path {
    return [self initWithPath:path recursive:nil includeMediaInfo:nil includeDeleted:nil includeHasExplicitSharedMembers:nil includeMountedFolders:nil limit:nil sharedLink:nil includePropertyGroups:nil includeNonDownloadableFiles:nil includeRestorableInfo:nil];
}
...
+ (DBFILESListFolderArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILESSharedLink *sharedLink = valueDict[@"shared_link"] ? [DBFILESSharedLinkSerializer deserialize:valueDict[@"shared_link"]] : nil;
    DBFILEPROPERTIESTemplateFilterBase *includePropertyGroups = valueDict[@"include_property_groups"] ? [DBFILEPROPERTIESTemplateFilterBaseSerializer deserialize:valueDict[@"include_property_groups"]] : nil;
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESListFolderContinueErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESListFolderErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILEPROPERTIESTemplateError *)templateError {
    if (![self isTemplateError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESListFolderErrorTemplateError, but was %@.", [self tagName]];
    }
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESListFolderError *)valueObj {
    ...
    if ([valueObj isPath]) {
        ...
        jsonDict[@"template_error"] = [[DBFILEPROPERTIESTemplateErrorSerializer serialize:valueObj.templateError] mutableCopy];
...
+ (DBFILESListFolderError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"path"]) {
        ...
        DBFILEPROPERTIESTemplateError *templateError = [DBFILEPROPERTIESTemplateErrorSerializer deserialize:valueDict[@"template_error"]];
...
- (BOOL)isEqualToListFolderGetLatestCursorResult:(DBFILESListFolderGetLatestCursorResult *)aListFolderGetLatestCursorResult {
...
- (instancetype)initWithEntries:(NSArray<DBFILESMetadata *> *)entries cursor:(NSString *)cursor hasMore:(NSNumber *)hasMore {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:nil]](cursor);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESListFolderResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESMetadataSerializer serialize:elem0]; }];
    jsonDict[@"cursor"] = valueObj.cursor;
...
+ (DBFILESListFolderResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESMetadata *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESMetadataSerializer deserialize:elem0]; }];
    NSString *cursor = valueDict[@"cursor"];
...
- (instancetype)initWithPath:(NSString *)path mode:(DBFILESListRevisionsMode *)mode limit:(NSNumber *)limit beforeRev:(NSString *)beforeRev includeRestorableInfo:(NSNumber *)includeRestorableInfo {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"/(.|[\\r\\n])*|id:.*|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(9) maxLength:nil pattern:@"[0-9a-f]+"]](beforeRev);
...
+ (DBFILESListRevisionsArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *path = valueDict[@"path"];
    DBFILESListRevisionsMode *mode = valueDict[@"mode"] ? [DBFILESListRevisionsModeSerializer deserialize:valueDict[@"mode"]] : [[DBFILESListRevisionsMode alloc] initWithPath];
    NSNumber *limit = valueDict[@"limit"] ?: @(10);
    NSString *beforeRev = valueDict[@"before_rev"] ?: nil;
    NSNumber *includeRestorableInfo = valueDict[@"include_restorable_info"] ?: @NO;

    return [[DBFILESListRevisionsArg alloc] initWithPath:path mode:mode limit:limit beforeRev:beforeRev includeRestorableInfo:includeRestorableInfo];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESListRevisionsErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithIsDeleted:(NSNumber *)isDeleted entries:(NSArray<DBFILESFileMetadata *> *)entries hasMore:(NSNumber *)hasMore serverDeleted:(NSDate *)serverDeleted {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESListRevisionsResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESFileMetadataSerializer serialize:elem0]; }];
    jsonDict[@"has_more"] = valueObj.hasMore;
    if (valueObj.serverDeleted) {
        jsonDict[@"server_deleted"] = [DBNSDateSerializer serialize:valueObj.serverDeleted dateFormat:@"%Y-%m-%dT%H:%M:%SZ"];
    }
...
+ (DBFILESListRevisionsResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    NSArray<DBFILESFileMetadata *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESFileMetadataSerializer deserialize:elem0]; }];
    NSNumber *hasMore = valueDict[@"has_more"];
    ...
    return [[DBFILESListRevisionsResult alloc] initWithIsDeleted:isDeleted entries:entries hasMore:hasMore serverDeleted:serverDeleted];
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESLockFileBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESLockFileArgSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESLockFileBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESLockFileArg *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESLockFileArgSerializer deserialize:elem0]; }];
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESLockFileBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESLockFileResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESLockFileBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESLockFileResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESLockFileResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESLookupError *)pathLookup {
    if (![self isPathLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESLockFileErrorPathLookup, but was %@.", [self tagName]];
    }
    return _pathLookup;
}
...
- (DBFILESLockConflictError *)lockConflict {
    if (![self isLockConflict]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESLockFileErrorLockConflict, but was %@.", [self tagName]];
    }
...
- (DBFILESLockFileResult *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESLockFileResultEntrySuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (DBFILESLockFileError *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESLockFileResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
- (NSString *)malformedPath {
    if (![self isMalformedPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESLookupErrorMalformedPath, but was %@.", [self tagName]];
    }
...
- (DBFILESMediaMetadata *)metadata {
    if (![self isMetadata]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESMediaInfoMetadata, but was %@.", [self tagName]];
    }
    return _metadata;
}
...
- (instancetype)initWithDimensions:(DBFILESDimensions *)dimensions location:(DBFILESGpsCoordinates *)location timeTaken:(NSDate *)timeTaken {
...
- (DBFILESMetadata *)metadata {
    if (![self isMetadata]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESMetadataV2Metadata, but was %@.", [self tagName]];
    }
    return _metadata;
}
...
- (instancetype)initWithEntries:(NSArray<DBFILESRelocationPath *> *)entries autorename:(NSNumber *)autorename {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:@(1) maxItems:@(1000) itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESRelocationBatchArgBase *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESRelocationPathSerializer serialize:elem0]; }];
    jsonDict[@"autorename"] = valueObj.autorename;
...
+ (DBFILESRelocationBatchArgBase *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESRelocationPath *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESRelocationPathSerializer deserialize:elem0]; }];
    NSNumber *autorename = valueDict[@"autorename"] ?: @NO;
...
- (instancetype)initWithEntries:(NSArray<DBFILESRelocationPath *> *)entries autorename:(NSNumber *)autorename allowOwnershipTransfer:(NSNumber *)allowOwnershipTransfer {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:@(1) maxItems:@(1000) itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
...
+ (DBFILESMoveBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESMoveBatchArg alloc] initWithEntries:entries autorename:autorename allowOwnershipTransfer:allowOwnershipTransfer];
}
...
- (instancetype)initWithUrl:(NSString *)url resultPath:(NSString *)resultPath fileId:(NSString *)fileId paperRevision:(NSNumber *)paperRevision {
    [DBStoneValidators nonnullValidator:nil](url);
...
+ (DBFILESPaperCreateResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESPaperCreateResult alloc] initWithUrl:url resultPath:resultPath fileId:fileId paperRevision:paperRevision];
}
...
- (instancetype)initWithPath:(NSString *)path importFormat:(DBFILESImportFormat *)importFormat docUpdatePolicy:(DBFILESPaperDocUpdatePolicy *)docUpdatePolicy paperRevision:(NSNumber *)paperRevision {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)|(id:.*)"]](path);
    [DBStoneValidators nonnullValidator:nil](importFormat);
...
- (instancetype)initWithPath:(NSString *)path importFormat:(DBFILESImportFormat *)importFormat docUpdatePolicy:(DBFILESPaperDocUpdatePolicy *)docUpdatePolicy {
...
+ (DBFILESPaperUpdateArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *path = valueDict[@"path"];
    DBFILESImportFormat *importFormat = [DBFILESImportFormatSerializer deserialize:valueDict[@"import_format"]];
    DBFILESPaperDocUpdatePolicy *docUpdatePolicy = [DBFILESPaperDocUpdatePolicySerializer deserialize:valueDict[@"doc_update_policy"]];
    NSNumber *paperRevision = valueDict[@"paper_revision"] ?: nil;

    return [[DBFILESPaperUpdateArg alloc] initWithPath:path importFormat:importFormat docUpdatePolicy:docUpdatePolicy paperRevision:paperRevision];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESPaperUpdateErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (NSString *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESPathOrLinkPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESSharedLinkFileInfo *)link {
    if (![self isLink]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESPathOrLinkLink, but was %@.", [self tagName]];
    }
    return _link;
}
...
- (instancetype)initWithPath:(NSString *)path tags:(NSArray<DBFILESTag *> *)tags {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"/(.|[\\r\\n])*"]](path);
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](tags);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESPathToTags *)valueObj {
    ...
    jsonDict[@"path"] = valueObj.path;
    jsonDict[@"tags"] = [DBArraySerializer serialize:valueObj.tags withBlock:^id(id elem0) { return [DBFILESTagSerializer serialize:elem0]; }];
...
+ (DBFILESPathToTags *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *path = valueDict[@"path"];
    NSArray<DBFILESTag *> *tags = [DBArraySerializer deserialize:valueDict[@"tags"] withBlock:^id(id elem0) { return [DBFILESTagSerializer deserialize:elem0]; }];
...
+ (DBFILESPhotoMetadata *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    DBFILESDimensions *dimensions = valueDict[@"dimensions"] ? [DBFILESDimensionsSerializer deserialize:valueDict[@"dimensions"]] : nil;
    DBFILESGpsCoordinates *location = valueDict[@"location"] ? [DBFILESGpsCoordinatesSerializer deserialize:valueDict[@"location"]] : nil;
    NSDate *timeTaken = valueDict[@"time_taken"] ? [DBNSDateSerializer deserialize:valueDict[@"time_taken"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESPreviewErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithFileMetadata:(DBFILESFileMetadata *)fileMetadata linkMetadata:(DBFILESMinimalFileLinkMetadata *)linkMetadata {
...
+ (DBFILESPreviewResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    DBFILESFileMetadata *fileMetadata = valueDict[@"file_metadata"] ? [DBFILESFileMetadataSerializer deserialize:valueDict[@"file_metadata"]] : nil;
    DBFILESMinimalFileLinkMetadata *linkMetadata = valueDict[@"link_metadata"] ? [DBFILESMinimalFileLinkMetadataSerializer deserialize:valueDict[@"link_metadata"]] : nil;
...
- (instancetype)initWithFromPath:(NSString *)fromPath toPath:(NSString *)toPath allowSharedFolder:(NSNumber *)allowSharedFolder autorename:(NSNumber *)autorename allowOwnershipTransfer:(NSNumber *)allowOwnershipTransfer {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)|(id:.*)"]](fromPath);
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)|(id:.*)"]](toPath);
...
+ (DBFILESRelocationArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESRelocationArg alloc] initWithFromPath:fromPath toPath:toPath allowSharedFolder:allowSharedFolder autorename:autorename allowOwnershipTransfer:allowOwnershipTransfer];
}
...
- (instancetype)initWithEntries:(NSArray<DBFILESRelocationPath *> *)entries autorename:(NSNumber *)autorename allowSharedFolder:(NSNumber *)allowSharedFolder allowOwnershipTransfer:(NSNumber *)allowOwnershipTransfer {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:@(1) maxItems:@(1000) itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
...
+ (DBFILESRelocationBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESRelocationBatchArg alloc] initWithEntries:entries autorename:autorename allowSharedFolder:allowSharedFolder allowOwnershipTransfer:allowOwnershipTransfer];
}
...
- (DBFILESLookupError *)fromLookup {
    if (![self isFromLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationErrorFromLookup, but was %@.", [self tagName]];
    }
    return _fromLookup;
}
...
- (DBFILESWriteError *)fromWrite {
    if (![self isFromWrite]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationErrorFromWrite, but was %@.", [self tagName]];
    }
    return _fromWrite;
}
...
- (DBFILESWriteError *)to {
    if (![self isTo]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationErrorTo, but was %@.", [self tagName]];
    }
    return _to;
}
...
- (DBFILESMoveIntoVaultError *)cantMoveIntoVault {
    if (![self isCantMoveIntoVault]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationErrorCantMoveIntoVault, but was %@.", [self tagName]];
    }
...
- (DBFILESMoveIntoFamilyError *)cantMoveIntoFamily {
    if (![self isCantMoveIntoFamily]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationErrorCantMoveIntoFamily, but was %@.", [self tagName]];
    }
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESRelocationError *)valueObj {
    ...
    if ([valueObj isFromLookup]) {
        ...
        jsonDict[@"cant_move_into_vault"] = [[DBFILESMoveIntoVaultErrorSerializer serialize:valueObj.cantMoveIntoVault] mutableCopy];
        jsonDict[@".tag"] = @"cant_move_into_vault";
    }
    else if ([valueObj isCantMoveIntoFamily]) {
        jsonDict[@"cant_move_into_family"] = [[DBFILESMoveIntoFamilyErrorSerializer serialize:valueObj.cantMoveIntoFamily] mutableCopy];
...
+ (DBFILESRelocationError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"from_lookup"]) {
        ...
        DBFILESMoveIntoVaultError *cantMoveIntoVault = [DBFILESMoveIntoVaultErrorSerializer deserialize:valueDict[@"cant_move_into_vault"]];
        ...
        DBFILESMoveIntoFamilyError *cantMoveIntoFamily = [DBFILESMoveIntoFamilyErrorSerializer deserialize:valueDict[@"cant_move_into_family"]];
...
- (DBFILESLookupError *)fromLookup {
    if (![self isFromLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchErrorFromLookup, but was %@.", [self tagName]];
    }
    return _fromLookup;
}
...
- (DBFILESWriteError *)fromWrite {
    if (![self isFromWrite]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchErrorFromWrite, but was %@.", [self tagName]];
    }
    return _fromWrite;
}
...
- (DBFILESWriteError *)to {
    if (![self isTo]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchErrorTo, but was %@.", [self tagName]];
    }
    return _to;
}
...
- (DBFILESMoveIntoVaultError *)cantMoveIntoVault {
    if (![self isCantMoveIntoVault]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchErrorCantMoveIntoVault, but was %@.", [self tagName]];
    }
    return _cantMoveIntoVault;
}
...
- (DBFILESMoveIntoFamilyError *)cantMoveIntoFamily {
    if (![self isCantMoveIntoFamily]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchErrorCantMoveIntoFamily, but was %@.", [self tagName]];
    }
    return _cantMoveIntoFamily;
}
...
- (DBFILESRelocationError *)relocationError {
    if (![self isRelocationError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchErrorEntryRelocationError, but was %@.", [self tagName]];
    }
...
+ (DBFILESRelocationBatchErrorEntry *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"relocation_error"]) {
        DBFILESRelocationError *relocationError = [DBFILESRelocationErrorSerializer deserialize:valueDict[@"relocation_error"]];
...
- (DBFILESRelocationBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchJobStatusComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (DBFILESRelocationBatchError *)failed {
    if (![self isFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchJobStatusFailed, but was %@.", [self tagName]];
    }
    return _failed;
}
...
- (NSString *)asyncJobId {
    if (![self isAsyncJobId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchLaunchAsyncJobId, but was %@.", [self tagName]];
    }
    return _asyncJobId;
}
...
- (DBFILESRelocationBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchLaunchComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESRelocationBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESRelocationBatchResultDataSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESRelocationBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESRelocationBatchResultData *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESRelocationBatchResultDataSerializer deserialize:elem0]; }];
...
- (DBFILESMetadata *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchResultEntrySuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (DBFILESRelocationBatchErrorEntry *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
+ (DBFILESRelocationBatchResultEntry *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"success"]) {
        ...
        DBFILESRelocationBatchErrorEntry *failure = [DBFILESRelocationBatchErrorEntrySerializer deserialize:valueDict[@"failure"]];
...
- (DBFILESRelocationBatchV2Result *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchV2JobStatusComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (NSString *)asyncJobId {
    if (![self isAsyncJobId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchV2LaunchAsyncJobId, but was %@.", [self tagName]];
    }
    return _asyncJobId;
}
...
- (DBFILESRelocationBatchV2Result *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRelocationBatchV2LaunchComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESRelocationBatchV2Result *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESRelocationBatchResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESRelocationBatchV2Result *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESRelocationBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESRelocationBatchResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRemoveTagErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookupError *)pathLookup {
    if (![self isPathLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRestoreErrorPathLookup, but was %@.", [self tagName]];
    }
    return _pathLookup;
}
...
- (DBFILESWriteError *)pathWrite {
    if (![self isPathWrite]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRestoreErrorPathWrite, but was %@.", [self tagName]];
    }
    return _pathWrite;
}
...
- (DBFILESWriteError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSaveCopyReferenceErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESWriteError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSaveUrlErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESFileMetadata *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSaveUrlJobStatusComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (DBFILESSaveUrlError *)failed {
    if (![self isFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSaveUrlJobStatusFailed, but was %@.", [self tagName]];
    }
    return _failed;
}
...
- (NSString *)asyncJobId {
    if (![self isAsyncJobId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSaveUrlResultAsyncJobId, but was %@.", [self tagName]];
    }
    return _asyncJobId;
}
...
- (DBFILESFileMetadata *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSaveUrlResultComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (instancetype)initWithPath:(NSString *)path query:(NSString *)query start:(NSNumber *)start maxResults:(NSNumber *)maxResults mode:(DBFILESSearchMode *)mode {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)?|id:.*|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]](path);
...
+ (DBFILESSearchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILESSearchMode *mode = valueDict[@"mode"] ? [DBFILESSearchModeSerializer deserialize:valueDict[@"mode"]] : [[DBFILESSearchMode alloc] initWithFilename];
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSearchErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (NSString *)invalidArgument {
    if (![self isInvalidArgument]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSearchErrorInvalidArgument, but was %@.", [self tagName]];
    }
...
- (instancetype)initWithMetadata:(DBFILESMetadataV2 *)metadata matchType:(DBFILESSearchMatchTypeV2 *)matchType highlightSpans:(NSArray<DBFILESHighlightSpan *> *)highlightSpans {
    [DBStoneValidators nonnullValidator:nil](metadata);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](highlightSpans);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESSearchMatchV2 *)valueObj {
    ...
    if (valueObj.highlightSpans) {
        jsonDict[@"highlight_spans"] = [DBArraySerializer serialize:valueObj.highlightSpans withBlock:^id(id elem0) { return [DBFILESHighlightSpanSerializer serialize:elem0]; }];
    }
...
+ (DBFILESSearchMatchV2 *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    DBFILESSearchMatchTypeV2 *matchType = valueDict[@"match_type"] ? [DBFILESSearchMatchTypeV2Serializer deserialize:valueDict[@"match_type"]] : nil;
    NSArray<DBFILESHighlightSpan *> *highlightSpans = valueDict[@"highlight_spans"] ? [DBArraySerializer deserialize:valueDict[@"highlight_spans"] withBlock:^id(id elem0) { return [DBFILESHighlightSpanSerializer deserialize:elem0]; }] : nil;
...
- (instancetype)initWithPath:(NSString *)path maxResults:(NSNumber *)maxResults orderBy:(DBFILESSearchOrderBy *)orderBy fileStatus:(DBFILESFileStatus *)fileStatus filenameOnly:(NSNumber *)filenameOnly fileExtensions:(NSArray<NSString *> *)fileExtensions fileCategories:(NSArray<DBFILESFileCategory *> *)fileCategories accountId:(NSString *)accountId {
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)?|id:.*|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](fileExtensions);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](fileCategories);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]](accountId);
...
- (instancetype)initDefault {
    return [self initWithPath:nil maxResults:nil orderBy:nil fileStatus:nil filenameOnly:nil fileExtensions:nil fileCategories:nil accountId:nil];
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESSearchOptions *)valueObj {
    ...
    if (valueObj.fileExtensions) {
        jsonDict[@"file_extensions"] = [DBArraySerializer serialize:valueObj.fileExtensions withBlock:^id(id elem0) { return elem0; }];
    }
    if (valueObj.fileCategories) {
        jsonDict[@"file_categories"] = [DBArraySerializer serialize:valueObj.fileCategories withBlock:^id(id elem0) { return [DBFILESFileCategorySerializer serialize:elem0]; }];
    }
...
+ (DBFILESSearchOptions *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *path = valueDict[@"path"] ?: nil;
    NSNumber *maxResults = valueDict[@"max_results"] ?: @(100);
    DBFILESSearchOrderBy *orderBy = valueDict[@"order_by"] ? [DBFILESSearchOrderBySerializer deserialize:valueDict[@"order_by"]] : nil;
    DBFILESFileStatus *fileStatus = valueDict[@"file_status"] ? [DBFILESFileStatusSerializer deserialize:valueDict[@"file_status"]] : [[DBFILESFileStatus alloc] initWithActive];
    NSNumber *filenameOnly = valueDict[@"filename_only"] ?: @NO;
    NSArray<NSString *> *fileExtensions = valueDict[@"file_extensions"] ? [DBArraySerializer deserialize:valueDict[@"file_extensions"] withBlock:^id(id elem0) { return elem0; }] : nil;
    NSArray<DBFILESFileCategory *> *fileCategories = valueDict[@"file_categories"] ? [DBArraySerializer deserialize:valueDict[@"file_categories"] withBlock:^id(id elem0) { return [DBFILESFileCategorySerializer deserialize:elem0]; }] : nil;
    NSString *accountId = valueDict[@"account_id"] ?: nil;

    return [[DBFILESSearchOptions alloc] initWithPath:path maxResults:maxResults orderBy:orderBy fileStatus:fileStatus filenameOnly:filenameOnly fileExtensions:fileExtensions fileCategories:fileCategories accountId:accountId];
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESSearchResult *)valueObj {
    ...
    jsonDict[@"matches"] = [DBArraySerializer serialize:valueObj.matches withBlock:^id(id elem0) { return [DBFILESSearchMatchSerializer serialize:elem0]; }];
...
+ (DBFILESSearchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESSearchMatch *> *matches = [DBArraySerializer deserialize:valueDict[@"matches"] withBlock:^id(id elem0) { return [DBFILESSearchMatchSerializer deserialize:elem0]; }];
...
- (instancetype)initWithQuery:(NSString *)query options:(DBFILESSearchOptions *)options matchFieldOptions:(DBFILESSearchMatchFieldOptions *)matchFieldOptions includeHighlights:(NSNumber *)includeHighlights {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:@(1000) pattern:nil]](query);
...
+ (DBFILESSearchV2Arg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *query = valueDict[@"query"];
    DBFILESSearchOptions *options = valueDict[@"options"] ? [DBFILESSearchOptionsSerializer deserialize:valueDict[@"options"]] : nil;
    DBFILESSearchMatchFieldOptions *matchFieldOptions = valueDict[@"match_field_options"] ? [DBFILESSearchMatchFieldOptionsSerializer deserialize:valueDict[@"match_field_options"]] : nil;
    NSNumber *includeHighlights = valueDict[@"include_highlights"] ?: nil;

    return [[DBFILESSearchV2Arg alloc] initWithQuery:query options:options matchFieldOptions:matchFieldOptions includeHighlights:includeHighlights];
}
...
- (instancetype)initWithMatches:(NSArray<DBFILESSearchMatchV2 *> *)matches hasMore:(NSNumber *)hasMore cursor:(NSString *)cursor {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](matches);
    [DBStoneValidators nonnullValidator:nil](hasMore);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESSearchV2Result *)valueObj {
    ...
    jsonDict[@"matches"] = [DBArraySerializer serialize:valueObj.matches withBlock:^id(id elem0) { return [DBFILESSearchMatchV2Serializer serialize:elem0]; }];
    jsonDict[@"has_more"] = valueObj.hasMore;
    if (valueObj.cursor) {
        jsonDict[@"cursor"] = valueObj.cursor;
    }
...
+ (DBFILESSearchV2Result *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESSearchMatchV2 *> *matches = [DBArraySerializer deserialize:valueDict[@"matches"] withBlock:^id(id elem0) { return [DBFILESSearchMatchV2Serializer deserialize:elem0]; }];
    NSNumber *hasMore = valueDict[@"has_more"];
...
- (instancetype)initWithCreated:(NSDate *)created lockHolderAccountId:(NSString *)lockHolderAccountId lockHolderTeamId:(NSString *)lockHolderTeamId {
    [DBStoneValidators nonnullValidator:nil](created);
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]](lockHolderAccountId);
...
+ (DBFILESSingleUserLock *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESSingleUserLock alloc] initWithCreated:created lockHolderAccountId:lockHolderAccountId lockHolderTeamId:lockHolderTeamId];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESSyncSettingsErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESUserGeneratedTag *)userGeneratedTag {
    if (![self isUserGeneratedTag]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESTagUserGeneratedTag, but was %@.", [self tagName]];
    }
...
- (instancetype)initWithPath:(NSString *)path format:(DBFILESThumbnailFormat *)format size:(DBFILESThumbnailSize *)size mode:(DBFILESThumbnailMode *)mode quality:(DBFILESThumbnailQuality *)quality excludeMediaInfo:(NSNumber *)excludeMediaInfo {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*|id:.*)|(rev:[0-9a-f]{9,})|(ns:[0-9]+(/(.|[\\r\\n])*)?)"]](path);
...
+ (DBFILESThumbnailArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSString *path = valueDict[@"path"];
    DBFILESThumbnailFormat *format = valueDict[@"format"] ? [DBFILESThumbnailFormatSerializer deserialize:valueDict[@"format"]] : [[DBFILESThumbnailFormat alloc] initWithJpeg];
    DBFILESThumbnailSize *size = valueDict[@"size"] ? [DBFILESThumbnailSizeSerializer deserialize:valueDict[@"size"]] : [[DBFILESThumbnailSize alloc] initWithW64h64];
    DBFILESThumbnailMode *mode = valueDict[@"mode"] ? [DBFILESThumbnailModeSerializer deserialize:valueDict[@"mode"]] : [[DBFILESThumbnailMode alloc] initWithStrict];
    DBFILESThumbnailQuality *quality = valueDict[@"quality"] ? [DBFILESThumbnailQualitySerializer deserialize:valueDict[@"quality"]] : [[DBFILESThumbnailQuality alloc] initWithQuality80];
    NSNumber *excludeMediaInfo = valueDict[@"exclude_media_info"] ?: nil;

    return [[DBFILESThumbnailArg alloc] initWithPath:path format:format size:size mode:mode quality:quality excludeMediaInfo:excludeMediaInfo];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESThumbnailErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (instancetype)initWithResource:(DBFILESPathOrLink *)resource format:(DBFILESThumbnailFormat *)format size:(DBFILESThumbnailSize *)size mode:(DBFILESThumbnailMode *)mode quality:(DBFILESThumbnailQuality *)quality excludeMediaInfo:(NSNumber *)excludeMediaInfo {
...
+ (DBFILESThumbnailV2Arg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESThumbnailV2Arg alloc] initWithResource:resource format:format size:size mode:mode quality:quality excludeMediaInfo:excludeMediaInfo];
}
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESThumbnailV2ErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUnlockFileBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESUnlockFileArgSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESUnlockFileBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESUnlockFileArg *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESUnlockFileArgSerializer deserialize:elem0]; }];
...
- (instancetype)initWithPath:(NSString *)path mode:(DBFILESWriteMode *)mode autorename:(NSNumber *)autorename clientModified:(NSDate *)clientModified mute:(NSNumber *)mute propertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroup *> *)propertyGroups strictConflict:(NSNumber *)strictConflict contentHash:(NSString *)contentHash {
    [DBStoneValidators nonnullValidator:[DBStoneValidators stringValidator:nil maxLength:nil pattern:@"(/(.|[\\r\\n])*)|(ns:[0-9]+(/(.|[\\r\\n])*)?)|(id:.*)"]](path);
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](propertyGroups);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(64) maxLength:@(64) pattern:nil]](contentHash);

    self = [super initWithPath:path mode:mode autorename:autorename clientModified:clientModified mute:mute propertyGroups:propertyGroups strictConflict:strictConflict];
    if (self) {
        _contentHash = contentHash;
    }
    return self;
...
- (instancetype)initWithPath:(NSString *)path {
    return [self initWithPath:path mode:nil autorename:nil clientModified:nil mute:nil propertyGroups:nil strictConflict:nil contentHash:nil];
}
...
+ (DBFILESUploadArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESUploadArg alloc] initWithPath:path mode:mode autorename:autorename clientModified:clientModified mute:mute propertyGroups:propertyGroups strictConflict:strictConflict contentHash:contentHash];
}
...
- (DBFILEPROPERTIESInvalidPropertyGroupError *)propertiesError {
    if (![self isPropertiesError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadErrorPropertiesError, but was %@.", [self tagName]];
    }
    return _propertiesError;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadError *)valueObj {
    ...
    if ([valueObj isPath]) {
        ...
        jsonDict[@"properties_error"] = [[DBFILEPROPERTIESInvalidPropertyGroupErrorSerializer serialize:valueObj.propertiesError] mutableCopy];
        jsonDict[@".tag"] = @"properties_error";
    }
...
+ (DBFILESUploadError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"path"]) {
        ...
        DBFILEPROPERTIESInvalidPropertyGroupError *propertiesError = [DBFILEPROPERTIESInvalidPropertyGroupErrorSerializer deserialize:valueDict[@"properties_error"]];
...
- (instancetype)initWithCursor:(DBFILESUploadSessionCursor *)cursor close:(NSNumber *)close contentHash:(NSString *)contentHash {
...
- (instancetype)initWithEntries:(NSArray<DBFILESUploadSessionAppendBatchArgEntry *> *)entries contentHash:(NSString *)contentHash {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:@(1000) itemValidator:[DBStoneValidators nonnullValidator:nil]]](entries);
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(64) maxLength:@(64) pattern:nil]](contentHash);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionAppendBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESUploadSessionAppendBatchArgEntrySerializer serialize:elem0]; }];
    if (valueObj.contentHash) {
        jsonDict[@"content_hash"] = valueObj.contentHash;
    }
...
+ (DBFILESUploadSessionAppendBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESUploadSessionAppendBatchArgEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESUploadSessionAppendBatchArgEntrySerializer deserialize:elem0]; }];
    NSString *contentHash = valueDict[@"content_hash"] ?: nil;
...
- (BOOL)isEqualToUploadSessionAppendBatchArgEntry:(DBFILESUploadSessionAppendBatchArgEntry *)anUploadSessionAppendBatchArgEntry {
...
- (DBFILESUploadSessionOffsetError *)incorrectOffset {
    if (![self isIncorrectOffset]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionAppendBatchEntryErrorIncorrectOffset, but was %@.", [self tagName]];
    }
...
- (BOOL)isEqualToUploadSessionAppendBatchEntryError:(DBFILESUploadSessionAppendBatchEntryError *)anUploadSessionAppendBatchEntryError {
...
+ (DBFILESUploadSessionAppendBatchEntryError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"not_found"]) {
        ...
        DBFILESUploadSessionOffsetError *incorrectOffset = [DBFILESUploadSessionOffsetErrorSerializer deserialize:valueDict];
...
- (BOOL)isEqualToUploadSessionAppendBatchResult:(DBFILESUploadSessionAppendBatchResult *)anUploadSessionAppendBatchResult {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionAppendBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESUploadSessionAppendBatchResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESUploadSessionAppendBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESUploadSessionAppendBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESUploadSessionAppendBatchResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESUploadSessionAppendBatchEntryError *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionAppendBatchResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
- (BOOL)isEqualToUploadSessionAppendBatchResultEntry:(DBFILESUploadSessionAppendBatchResultEntry *)anUploadSessionAppendBatchResultEntry {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionAppendBatchResultEntry *)valueObj {
    ...
    if ([valueObj isSuccess]) {
        ...
        jsonDict[@"failure"] = [[DBFILESUploadSessionAppendBatchEntryErrorSerializer serialize:valueObj.failure] mutableCopy];
        jsonDict[@".tag"] = @"failure";
    }
    else {
        @throw([NSException exceptionWithName:@"InvalidTag" reason:@"Object not properly initialized. Tag has an unknown value." userInfo:nil]);
...
+ (DBFILESUploadSessionAppendBatchResultEntry *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"success"]) {
        ...
        DBFILESUploadSessionAppendBatchEntryError *failure = [DBFILESUploadSessionAppendBatchEntryErrorSerializer deserialize:valueDict[@"failure"]];
...
- (DBFILESUploadSessionOffsetError *)incorrectOffset {
    if (![self isIncorrectOffset]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionAppendErrorIncorrectOffset, but was %@.", [self tagName]];
    }
    return _incorrectOffset;
}
...
- (instancetype)initWithCursor:(DBFILESUploadSessionCursor *)cursor commit:(DBFILESCommitInfo *)commit contentHash:(NSString *)contentHash {
    [DBStoneValidators nonnullValidator:nil](cursor);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionFinishBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESUploadSessionFinishArgSerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESUploadSessionFinishBatchArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESUploadSessionFinishArg *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESUploadSessionFinishArgSerializer deserialize:elem0]; }];
...
- (DBFILESUploadSessionFinishBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishBatchJobStatusComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (BOOL)isEqualToUploadSessionFinishBatchJobStatus:(DBFILESUploadSessionFinishBatchJobStatus *)anUploadSessionFinishBatchJobStatus {
...
+ (DBFILESUploadSessionFinishBatchJobStatus *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"in_progress"]) {
        ...
        DBFILESUploadSessionFinishBatchResult *complete = [DBFILESUploadSessionFinishBatchResultSerializer deserialize:valueDict];
...
- (NSString *)asyncJobId {
    if (![self isAsyncJobId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishBatchLaunchAsyncJobId, but was %@.", [self tagName]];
    }
    return _asyncJobId;
}
...
- (DBFILESUploadSessionFinishBatchResult *)complete {
    if (![self isComplete]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishBatchLaunchComplete, but was %@.", [self tagName]];
    }
    return _complete;
}
...
- (BOOL)isEqualToUploadSessionFinishBatchLaunch:(DBFILESUploadSessionFinishBatchLaunch *)anUploadSessionFinishBatchLaunch {
...
- (BOOL)isEqualToUploadSessionFinishBatchResult:(DBFILESUploadSessionFinishBatchResult *)anUploadSessionFinishBatchResult {
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionFinishBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem0) { return [DBFILESUploadSessionFinishBatchResultEntrySerializer serialize:elem0]; }];

    return jsonDict;
}

+ (DBFILESUploadSessionFinishBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<DBFILESUploadSessionFinishBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem0) { return [DBFILESUploadSessionFinishBatchResultEntrySerializer deserialize:elem0]; }];
...
- (DBFILESFileMetadata *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishBatchResultEntrySuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (DBFILESUploadSessionFinishError *)failure {
    if (![self isFailure]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishBatchResultEntryFailure, but was %@.", [self tagName]];
    }
    return _failure;
}
...
- (BOOL)isEqualToUploadSessionFinishBatchResultEntry:(DBFILESUploadSessionFinishBatchResultEntry *)anUploadSessionFinishBatchResultEntry {
...
+ (DBFILESUploadSessionFinishBatchResultEntry *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"success"]) {
        ...
        DBFILESUploadSessionFinishError *failure = [DBFILESUploadSessionFinishErrorSerializer deserialize:valueDict[@"failure"]];
...
- (DBFILESUploadSessionLookupError *)lookupFailed {
    if (![self isLookupFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishErrorLookupFailed, but was %@.", [self tagName]];
    }
...
- (DBFILESWriteError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILEPROPERTIESInvalidPropertyGroupError *)propertiesError {
    if (![self isPropertiesError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionFinishErrorPropertiesError, but was %@.", [self tagName]];
    }
    return _propertiesError;
}
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionFinishError *)valueObj {
    ...
    if ([valueObj isLookupFailed]) {
        jsonDict[@"lookup_failed"] = [[DBFILESUploadSessionLookupErrorSerializer serialize:valueObj.lookupFailed] mutableCopy];
...
+ (DBFILESUploadSessionFinishError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    if ([tag isEqualToString:@"lookup_failed"]) {
        DBFILESUploadSessionLookupError *lookupFailed = [DBFILESUploadSessionLookupErrorSerializer deserialize:valueDict[@"lookup_failed"]];
...
- (DBFILESUploadSessionOffsetError *)incorrectOffset {
    if (![self isIncorrectOffset]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUploadSessionLookupErrorIncorrectOffset, but was %@.", [self tagName]];
    }
    return _incorrectOffset;
}
...
- (instancetype)initWithClose:(NSNumber *)close sessionType:(DBFILESUploadSessionType *)sessionType contentHash:(NSString *)contentHash {
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(64) maxLength:@(64) pattern:nil]](contentHash);
...
+ (DBFILESUploadSessionStartArg *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSNumber *close = valueDict[@"close"] ?: @NO;
    DBFILESUploadSessionType *sessionType = valueDict[@"session_type"] ? [DBFILESUploadSessionTypeSerializer deserialize:valueDict[@"session_type"]] : nil;
    NSString *contentHash = valueDict[@"content_hash"] ?: nil;
...
- (instancetype)initWithSessionIds:(NSArray<NSString *> *)sessionIds {
    [DBStoneValidators nonnullValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:[DBStoneValidators nonnullValidator:nil]]](sessionIds);
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESUploadSessionStartBatchResult *)valueObj {
    ...
    jsonDict[@"session_ids"] = [DBArraySerializer serialize:valueObj.sessionIds withBlock:^id(id elem0) { return elem0; }];

    return jsonDict;
}

+ (DBFILESUploadSessionStartBatchResult *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSArray<NSString *> *sessionIds = [DBArraySerializer deserialize:valueDict[@"session_ids"] withBlock:^id(id elem0) { return elem0; }];
...
- (instancetype)initWithDimensions:(DBFILESDimensions *)dimensions location:(DBFILESGpsCoordinates *)location timeTaken:(NSDate *)timeTaken duration:(NSNumber *)duration {
...
+ (DBFILESVideoMetadata *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBFILESVideoMetadata alloc] initWithDimensions:dimensions location:location timeTaken:timeTaken duration:duration];
}
...
- (NSString *)malformedPath {
    if (![self isMalformedPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESWriteErrorMalformedPath, but was %@.", [self tagName]];
    }
    return _malformedPath;
}
...
- (DBFILESWriteConflictError *)conflict {
    if (![self isConflict]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESWriteErrorConflict, but was %@.", [self tagName]];
    }
    return _conflict;
}
...
- (NSString *)update {
    if (![self isUpdate]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESWriteModeUpdate, but was %@.", [self tagName]];
    }
    return _update;
}
