...
- (instancetype)initWithUploadTrafficLimitReached {
  self = [super init];
  if (self) {
    _tag = DBFILESWriteErrorUploadTrafficLimitReached;
  }
  return self;
}
...
- (BOOL)isUploadTrafficLimitReached {
  return _tag == DBFILESWriteErrorUploadTrafficLimitReached;
}
...
- (NSString *)tagName {
  ...
  case DBFILESWriteErrorUploadTrafficLimitReached:
    return @"DBFILESWriteErrorUploadTrafficLimitReached";
...
+ (NSDictionary<NSString *, id> *)serialize:(DBFILESWriteError *)valueObj {
  ...
  } else if ([valueObj isUploadTrafficLimitReached]) {
    jsonDict[@".tag"] = @"upload_traffic_limit_reached";
  } else if ([valueObj isOther]) {
    jsonDict[@".tag"] = @"other";
  } else {
    jsonDict[@".tag"] = @"other";
...
+ (DBFILESWriteError *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
  ...
  } else if ([tag isEqualToString:@"upload_traffic_limit_reached"]) {
    return [[DBFILESWriteError alloc] initWithUploadTrafficLimitReached];
  } else if ([tag isEqualToString:@"other"]) {
