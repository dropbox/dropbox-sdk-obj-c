...
/// 
- (instancetype)initWithLoginMethod:(DBTEAMLOGLoginMethod *)loginMethod errorDetails:(DBTEAMLOGFailureDetailsLogInfo *)errorDetails isEmmManaged:(nullable NSNumber *)isEmmManaged;
...
/// @return An initialized instance.
/// 
- (instancetype)initWithLoginMethod:(DBTEAMLOGLoginMethod *)loginMethod errorDetails:(DBTEAMLOGFailureDetailsLogInfo *)errorDetails;
