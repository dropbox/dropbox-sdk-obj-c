...
/// 
- (instancetype)initWithEventUuid:(NSString *)eventUuid targetAssetIndex:(nullable NSNumber *)targetAssetIndex parentAssetIndex:(nullable NSNumber *)parentAssetIndex;
