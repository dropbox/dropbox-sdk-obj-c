...
/// 
- (instancetype)initWithSharedContentLink:(NSString *)sharedContentLink sharedContentAccessLevel:(DBSHARINGAccessLevel *)sharedContentAccessLevel destinationPath:(NSString *)destinationPath sharedContentOwner:(nullable DBTEAMLOGUserLogInfo *)sharedContentOwner;
...
/// @return An initialized instance.
/// 
- (instancetype)initWithSharedContentLink:(NSString *)sharedContentLink sharedContentAccessLevel:(DBSHARINGAccessLevel *)sharedContentAccessLevel destinationPath:(NSString *)destinationPath;
