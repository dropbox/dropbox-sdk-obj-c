...
/// 
- (instancetype)initWithSharedContentAccessLevel:(DBSHARINGAccessLevel *)sharedContentAccessLevel sharedContentLink:(nullable NSString *)sharedContentLink dNewValue:(nullable NSDate *)dNewValue previousValue:(nullable NSDate *)previousValue;
