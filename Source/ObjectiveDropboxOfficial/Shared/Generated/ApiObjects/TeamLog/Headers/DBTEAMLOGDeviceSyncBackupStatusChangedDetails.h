...
/// 
- (instancetype)initWithDesktopDeviceSessionInfo:(DBTEAMLOGDesktopDeviceSessionLogInfo *)desktopDeviceSessionInfo previousValue:(DBTEAMLOGBackupStatus *)previousValue dNewValue:(DBTEAMLOGBackupStatus *)dNewValue;
