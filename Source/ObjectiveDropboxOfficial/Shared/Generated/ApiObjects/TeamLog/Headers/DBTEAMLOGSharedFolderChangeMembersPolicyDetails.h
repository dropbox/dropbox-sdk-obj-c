...
/// 
- (instancetype)initWithDNewValue:(DBSHARINGMemberPolicy *)dNewValue previousValue:(nullable DBSHARINGMemberPolicy *)previousValue;
...
/// `DBTEAMLOGSharedFolderChangeMembersPolicyDetails` API object.
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMLOGSharedFolderChangeMembersPolicyDetails *)instance;
...
/// 
+ (DBTEAMLOGSharedFolderChangeMembersPolicyDetails *)deserialize:(NSDictionary<NSString *, id>  *)dict;
