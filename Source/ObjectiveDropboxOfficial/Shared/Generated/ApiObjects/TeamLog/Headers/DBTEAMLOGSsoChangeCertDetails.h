...
/// 
- (instancetype)initWithDNewCertificateDetails:(DBTEAMLOGCertificate *)dNewCertificateDetails previousCertificateDetails:(nullable DBTEAMLOGCertificate *)previousCertificateDetails;
