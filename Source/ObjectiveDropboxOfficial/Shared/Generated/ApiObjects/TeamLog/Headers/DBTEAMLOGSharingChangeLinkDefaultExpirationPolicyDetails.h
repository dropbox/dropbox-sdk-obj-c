...
/// 
- (instancetype)initWithDNewValue:(DBTEAMLOGDefaultLinkExpirationDaysPolicy *)dNewValue previousValue:(nullable DBTEAMLOGDefaultLinkExpirationDaysPolicy *)previousValue;
...
/// `DBTEAMLOGSharingChangeLinkDefaultExpirationPolicyDetails` API object.
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMLOGSharingChangeLinkDefaultExpirationPolicyDetails *)instance;
