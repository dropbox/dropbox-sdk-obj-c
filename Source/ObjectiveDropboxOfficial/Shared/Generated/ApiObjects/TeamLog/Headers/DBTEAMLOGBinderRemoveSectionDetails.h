...
/// objects.
/// 
@interface DBTEAMLOGBinderRemoveSectionDetails : NSObject <DBSerializable, NSCopying> 
...
/// 
/// Serializes `DBTEAMLOGBinderRemoveSectionDetails` instances.
/// 
/// @param instance An instance of the `DBTEAMLOGBinderRemoveSectionDetails` API
/// object.
/// 
/// @return A json-compatible dictionary representation of the
/// `DBTEAMLOGBinderRemoveSectionDetails` API object.
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMLOGBinderRemoveSectionDetails *)instance;

/// 
/// Deserializes `DBTEAMLOGBinderRemoveSectionDetails` instances.
/// 
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMLOGBinderRemoveSectionDetails` API object.
/// 
/// @return An instantiation of the `DBTEAMLOGBinderRemoveSectionDetails`
/// object.
/// 
+ (DBTEAMLOGBinderRemoveSectionDetails *)deserialize:(NSDictionary<NSString *, id>  *)dict;
