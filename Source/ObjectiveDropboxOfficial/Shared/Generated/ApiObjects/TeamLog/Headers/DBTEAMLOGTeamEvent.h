...
/// @return An initialized instance.
/// 
- (instancetype)initWithTimestamp:(NSDate *)timestamp eventCategory:(DBTEAMLOGEventCategory *)eventCategory eventType:(DBTEAMLOGEventType *)eventType details:(DBTEAMLOGEventDetails *)details;
