...
/// 
- (instancetype)initWithDNewValue:(DBTEAMLOGSharedFolderMembersInheritancePolicy *)dNewValue previousValue:(nullable DBTEAMLOGSharedFolderMembersInheritancePolicy *)previousValue;
...
/// `DBTEAMLOGSharedFolderChangeMembersInheritancePolicyDetails` API object.
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMLOGSharedFolderChangeMembersInheritancePolicyDetails *)instance;
