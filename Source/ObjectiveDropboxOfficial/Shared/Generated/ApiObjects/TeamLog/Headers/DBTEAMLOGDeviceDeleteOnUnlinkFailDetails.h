...
/// 
- (instancetype)initWithNumFailures:(NSNumber *)numFailures sessionInfo:(nullable DBTEAMLOGSessionLogInfo *)sessionInfo displayName:(nullable NSString *)displayName;
