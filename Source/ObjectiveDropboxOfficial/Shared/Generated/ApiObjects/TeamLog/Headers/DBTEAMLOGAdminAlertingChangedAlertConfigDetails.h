...
/// 
- (instancetype)initWithAlertName:(NSString *)alertName previousAlertConfig:(DBTEAMLOGAdminAlertingAlertConfiguration *)previousAlertConfig dNewAlertConfig:(DBTEAMLOGAdminAlertingAlertConfiguration *)dNewAlertConfig;
