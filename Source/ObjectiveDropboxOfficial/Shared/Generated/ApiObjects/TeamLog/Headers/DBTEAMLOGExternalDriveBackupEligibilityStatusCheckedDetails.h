...
/// 
- (instancetype)initWithDesktopDeviceSessionInfo:(DBTEAMLOGDesktopDeviceSessionLogInfo *)desktopDeviceSessionInfo status:(DBTEAMLOGExternalDriveBackupEligibilityStatus *)status numberOfExternalDriveBackup:(NSNumber *)numberOfExternalDriveBackup;
...
/// `DBTEAMLOGExternalDriveBackupEligibilityStatusCheckedDetails` API object.
/// 
+ (nullable NSDictionary<NSString *, id>  *)serialize:(DBTEAMLOGExternalDriveBackupEligibilityStatusCheckedDetails *)instance;
