...
/// 
- (instancetype)initWithGovernancePolicyId:(NSString *)governancePolicyId name:(NSString *)name duration:(DBTEAMLOGDurationLogInfo *)duration policyType:(nullable DBTEAMLOGPolicyType *)policyType folders:(nullable NSArray<NSString *> *)folders;
...
/// @return An initialized instance.
/// 
- (instancetype)initWithGovernancePolicyId:(NSString *)governancePolicyId name:(NSString *)name duration:(DBTEAMLOGDurationLogInfo *)duration;
