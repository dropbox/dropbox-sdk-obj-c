...
/// 
- (instancetype)initWithDNewValue:(nullable DBTEAMLOGWebSessionsIdleLengthPolicy *)dNewValue previousValue:(nullable DBTEAMLOGWebSessionsIdleLengthPolicy *)previousValue;
