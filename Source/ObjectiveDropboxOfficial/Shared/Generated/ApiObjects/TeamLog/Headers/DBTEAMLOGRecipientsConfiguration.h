...
/// 
- (instancetype)initWithRecipientSettingType:(nullable DBTEAMLOGAlertRecipientsSettingType *)recipientSettingType emails:(nullable NSArray<NSString *> *)emails groups:(nullable NSArray<NSString *> *)groups;
