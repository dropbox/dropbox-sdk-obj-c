...
/// 
- (instancetype)initWithDNewValue:(DBTEAMLOGContentPermanentDeletePolicy *)dNewValue previousValue:(nullable DBTEAMLOGContentPermanentDeletePolicy *)previousValue;
