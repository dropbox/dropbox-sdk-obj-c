...
- (instancetype)initWithGroupName:(NSString *)groupName groupId:(NSString *)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType *)groupManagementType groupExternalId:(NSString *)groupExternalId memberCount:(NSNumber *)memberCount {
...
- (instancetype)initWithGroupName:(NSString *)groupName groupId:(NSString *)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType *)groupManagementType {
...
+ (DBTEAMCOMMONGroupSummary *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    ...
    return [[DBTEAMCOMMONGroupSummary alloc] initWithGroupName:groupName groupId:groupId groupManagementType:groupManagementType groupExternalId:groupExternalId memberCount:memberCount];
}
...
+ (DBTEAMCOMMONTimeRange *)deserialize:(NSDictionary<NSString *, id> *)valueDict {
    NSDate *startTime = valueDict[@"start_time"] ? [DBNSDateSerializer deserialize:valueDict[@"start_time"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;
    NSDate *endTime = valueDict[@"end_time"] ? [DBNSDateSerializer deserialize:valueDict[@"end_time"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;
