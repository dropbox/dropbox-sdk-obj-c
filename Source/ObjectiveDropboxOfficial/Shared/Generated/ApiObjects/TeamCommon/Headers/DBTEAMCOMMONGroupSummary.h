...
/// 
- (instancetype)initWithGroupName:(NSString *)groupName groupId:(NSString *)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType *)groupManagementType groupExternalId:(nullable NSString *)groupExternalId memberCount:(nullable NSNumber *)memberCount;
