...
///
/// The `OcrExtractionApiV2Error` union.
///
...
/// objects.
///
@interface DBRIVIERAOcrExtractionApiV2Error : NSObject <DBSerializable, NSCopying>

#pragma mark - Instance fields

/// The `DBRIVIERAOcrExtractionApiV2ErrorTag` enum type represents the possible
/// tag states with which the `DBRIVIERAOcrExtractionApiV2Error` union can
/// exist.
typedef NS_CLOSED_ENUM(NSInteger, DBRIVIERAOcrExtractionApiV2ErrorTag) {
  ...
  DBRIVIERAOcrExtractionApiV2ErrorServerError,
  ...
  DBRIVIERAOcrExtractionApiV2ErrorNotFoundError,

  /// The target is a folder, not a file.
  DBRIVIERAOcrExtractionApiV2ErrorIsAFolderError,

  /// (no description).
  DBRIVIERAOcrExtractionApiV2ErrorOther,

};

/// Represents the union's current tag state.
@property (nonatomic, readonly) DBRIVIERAOcrExtractionApiV2ErrorTag tag;
...
///
/// The serialization class for the `DBRIVIERAOcrExtractionApiV2Error` union.
///
@interface DBRIVIERAOcrExtractionApiV2ErrorSerializer : NSObject

///
/// Serializes `DBRIVIERAOcrExtractionApiV2Error` instances.
///
/// @param instance An instance of the `DBRIVIERAOcrExtractionApiV2Error` API
/// object.
///
/// @return A json-compatible dictionary representation of the
/// `DBRIVIERAOcrExtractionApiV2Error` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBRIVIERAOcrExtractionApiV2Error *)instance;

///
/// Deserializes `DBRIVIERAOcrExtractionApiV2Error` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBRIVIERAOcrExtractionApiV2Error` API object.
///
/// @return An instantiation of the `DBRIVIERAOcrExtractionApiV2Error` object.
///
+ (DBRIVIERAOcrExtractionApiV2Error *)deserialize:(NSDictionary<NSString *, id> *)dict;
