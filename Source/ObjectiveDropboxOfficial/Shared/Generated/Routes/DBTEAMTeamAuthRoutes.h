...
/// 
- (DBRpcTask<DBTEAMListMemberDevicesResult *, DBTEAMListMemberDevicesError *> *)devicesListMemberDevices:(NSString *)teamMemberId;
...
/// or a `DBTEAMListMemberDevicesError` object on failure.
/// 
- (DBRpcTask<DBTEAMListMemberDevicesResult *, DBTEAMListMemberDevicesError *> *)devicesListMemberDevices:(NSString *)teamMemberId includeWebSessions:(nullable NSNumber *)includeWebSessions includeDesktopClients:(nullable NSNumber *)includeDesktopClients includeMobileClients:(nullable NSNumber *)includeMobileClients;
...
/// or a `DBTEAMListMembersDevicesError` object on failure.
/// 
- (DBRpcTask<DBTEAMListMembersDevicesResult *, DBTEAMListMembersDevicesError *> *)devicesListMembersDevices:(nullable NSString *)cursor includeWebSessions:(nullable NSNumber *)includeWebSessions includeDesktopClients:(nullable NSNumber *)includeDesktopClients includeMobileClients:(nullable NSNumber *)includeMobileClients;
...
/// 
- (DBRpcTask<DBTEAMListTeamDevicesResult *, DBTEAMListTeamDevicesError *> *)devicesListTeamDevices __deprecated_msg("devicesListTeamDevices is deprecated.");
...
/// 
- (DBRpcTask<DBNilObject *, DBTEAMRevokeDeviceSessionError *> *)devicesRevokeDeviceSession:(DBTEAMRevokeDeviceSessionArg *)revokeDeviceSessionArg;
...
/// 
- (DBRpcTask<DBTEAMRevokeDeviceSessionBatchResult *, DBTEAMRevokeDeviceSessionBatchError *> *)devicesRevokeDeviceSessionBatch:(NSArray<DBTEAMRevokeDeviceSessionArg *> *)revokeDevices;
...
/// 
- (DBRpcTask<DBTEAMFeaturesGetValuesBatchResult *, DBTEAMFeaturesGetValuesBatchError *> *)featuresGetValues:(NSArray<DBTEAMFeature *> *)features;
...
/// `DBTEAMGroupCreateError` object on failure.
/// 
- (DBRpcTask<DBTEAMGroupFullInfo *, DBTEAMGroupCreateError *> *)groupsCreate:(NSString *)groupName addCreatorAsOwner:(nullable NSNumber *)addCreatorAsOwner groupExternalId:(nullable NSString *)groupExternalId groupManagementType:(nullable DBTEAMCOMMONGroupManagementType *)groupManagementType;
...
/// 
- (DBRpcTask<NSArray<DBTEAMGroupsGetInfoItem *> *, DBTEAMGroupsGetInfoError *> *)groupsGetInfo:(DBTEAMGroupsSelector *)groupsSelector;
...
/// 
- (DBRpcTask<DBTEAMGroupMembersChangeResult *, DBTEAMGroupMembersAddError *> *)groupsMembersAdd:(DBTEAMGroupSelector *)group members:(NSArray<DBTEAMMemberAccess *> *)members;
...
/// or a `DBTEAMGroupMembersAddError` object on failure.
/// 
- (DBRpcTask<DBTEAMGroupMembersChangeResult *, DBTEAMGroupMembersAddError *> *)groupsMembersAdd:(DBTEAMGroupSelector *)group members:(NSArray<DBTEAMMemberAccess *> *)members returnMembers:(nullable NSNumber *)returnMembers;
...
/// 
- (DBRpcTask<DBTEAMGroupsMembersListResult *, DBTEAMGroupSelectorError *> *)groupsMembersList:(DBTEAMGroupSelector *)group;
...
/// or a `DBTEAMGroupSelectorError` object on failure.
/// 
- (DBRpcTask<DBTEAMGroupsMembersListResult *, DBTEAMGroupSelectorError *> *)groupsMembersList:(DBTEAMGroupSelector *)group limit:(nullable NSNumber *)limit;
...
/// 
- (DBRpcTask<DBTEAMGroupsMembersListResult *, DBTEAMGroupsMembersListContinueError *> *)groupsMembersListContinue:(NSString *)cursor;
...
/// 
- (DBRpcTask<DBTEAMGroupMembersChangeResult *, DBTEAMGroupMembersRemoveError *> *)groupsMembersRemove:(DBTEAMGroupSelector *)group users:(NSArray<DBTEAMUserSelectorArg *> *)users;
...
/// or a `DBTEAMGroupMembersRemoveError` object on failure.
/// 
- (DBRpcTask<DBTEAMGroupMembersChangeResult *, DBTEAMGroupMembersRemoveError *> *)groupsMembersRemove:(DBTEAMGroupSelector *)group users:(NSArray<DBTEAMUserSelectorArg *> *)users returnMembers:(nullable NSNumber *)returnMembers;
...
/// 
- (DBRpcTask<NSArray<DBTEAMGroupsGetInfoItem *> *, DBTEAMGroupMemberSetAccessTypeError *> *)groupsMembersSetAccessType:(DBTEAMGroupSelector *)group user:(DBTEAMUserSelectorArg *)user accessType:(DBTEAMGroupAccessType *)accessType;
...
/// success or a `DBTEAMGroupMemberSetAccessTypeError` object on failure.
/// 
- (DBRpcTask<NSArray<DBTEAMGroupsGetInfoItem *> *, DBTEAMGroupMemberSetAccessTypeError *> *)groupsMembersSetAccessType:(DBTEAMGroupSelector *)group user:(DBTEAMUserSelectorArg *)user accessType:(DBTEAMGroupAccessType *)accessType returnMembers:(nullable NSNumber *)returnMembers;
...
/// `DBTEAMGroupUpdateError` object on failure.
/// 
- (DBRpcTask<DBTEAMGroupFullInfo *, DBTEAMGroupUpdateError *> *)groupsUpdate:(DBTEAMGroupSelector *)group returnMembers:(nullable NSNumber *)returnMembers dNewGroupName:(nullable NSString *)dNewGroupName dNewGroupExternalId:(nullable NSString *)dNewGroupExternalId dNewGroupManagementType:(nullable DBTEAMCOMMONGroupManagementType *)dNewGroupManagementType;
...
/// 
- (DBRpcTask<DBTEAMLegalHoldPolicy *, DBTEAMLegalHoldsPolicyCreateError *> *)legalHoldsCreatePolicy:(NSString *)name members:(NSArray<NSString *> *)members;
...
/// `DBTEAMLegalHoldsPolicyCreateError` object on failure.
/// 
- (DBRpcTask<DBTEAMLegalHoldPolicy *, DBTEAMLegalHoldsPolicyCreateError *> *)legalHoldsCreatePolicy:(NSString *)name members:(NSArray<NSString *> *)members description_:(nullable NSString *)description_ startDate:(nullable NSDate *)startDate endDate:(nullable NSDate *)endDate;
...
/// 
- (DBRpcTask<DBTEAMLegalHoldsListHeldRevisionResult *, DBTEAMLegalHoldsListHeldRevisionsError *> *)legalHoldsListHeldRevisions:(NSString *)id_;
...
/// success or a `DBTEAMLegalHoldsListHeldRevisionsError` object on failure.
/// 
- (DBRpcTask<DBTEAMLegalHoldsListHeldRevisionResult *, DBTEAMLegalHoldsListHeldRevisionsError *> *)legalHoldsListHeldRevisionsContinue:(NSString *)id_;
...
/// success or a `DBTEAMLegalHoldsListHeldRevisionsError` object on failure.
/// 
- (DBRpcTask<DBTEAMLegalHoldsListHeldRevisionResult *, DBTEAMLegalHoldsListHeldRevisionsError *> *)legalHoldsListHeldRevisionsContinue:(NSString *)id_ cursor:(nullable NSString *)cursor;
...
/// success or a `DBTEAMLegalHoldsListPoliciesError` object on failure.
/// 
- (DBRpcTask<DBTEAMLegalHoldsListPoliciesResult *, DBTEAMLegalHoldsListPoliciesError *> *)legalHoldsListPolicies:(nullable NSNumber *)includeReleased;
...
/// `DBTEAMLegalHoldsPolicyUpdateError` object on failure.
/// 
- (DBRpcTask<DBTEAMLegalHoldPolicy *, DBTEAMLegalHoldsPolicyUpdateError *> *)legalHoldsUpdatePolicy:(NSString *)id_ name:(nullable NSString *)name description_:(nullable NSString *)description_ members:(nullable NSArray<NSString *> *)members;
...
/// 
- (DBRpcTask<DBTEAMListMemberAppsResult *, DBTEAMListMemberAppsError *> *)linkedAppsListMemberLinkedApps:(NSString *)teamMemberId;
...
/// a `DBTEAMListMembersAppsError` object on failure.
/// 
- (DBRpcTask<DBTEAMListMembersAppsResult *, DBTEAMListMembersAppsError *> *)linkedAppsListMembersLinkedApps:(nullable NSString *)cursor;
...
/// 
- (DBRpcTask<DBTEAMListTeamAppsResult *, DBTEAMListTeamAppsError *> *)linkedAppsListTeamLinkedApps __deprecated_msg("linkedAppsListTeamLinkedApps is deprecated.");
...
/// `DBTEAMListTeamAppsError` object on failure.
/// 
- (DBRpcTask<DBTEAMListTeamAppsResult *, DBTEAMListTeamAppsError *> *)linkedAppsListTeamLinkedApps:(nullable NSString *)cursor __deprecated_msg("linkedAppsListTeamLinkedApps is deprecated.");
...
/// 
- (DBRpcTask<DBNilObject *, DBTEAMRevokeLinkedAppError *> *)linkedAppsRevokeLinkedApp:(NSString *)appId teamMemberId:(NSString *)teamMemberId;
...
/// `DBTEAMRevokeLinkedAppError` object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBTEAMRevokeLinkedAppError *> *)linkedAppsRevokeLinkedApp:(NSString *)appId teamMemberId:(NSString *)teamMemberId keepAppFolder:(nullable NSNumber *)keepAppFolder;
...
/// 
- (DBRpcTask<DBTEAMRevokeLinkedAppBatchResult *, DBTEAMRevokeLinkedAppBatchError *> *)linkedAppsRevokeLinkedAppBatch:(NSArray<DBTEAMRevokeLinkedApiAppArg *> *)revokeLinkedApp;
...
/// or a `DBTEAMExcludedUsersUpdateError` object on failure.
/// 
- (DBRpcTask<DBTEAMExcludedUsersUpdateResult *, DBTEAMExcludedUsersUpdateError *> *)memberSpaceLimitsExcludedUsersAdd:(nullable NSArray<DBTEAMUserSelectorArg *> *)users;
...
/// or a `DBTEAMExcludedUsersListError` object on failure.
/// 
- (DBRpcTask<DBTEAMExcludedUsersListResult *, DBTEAMExcludedUsersListError *> *)memberSpaceLimitsExcludedUsersList:(nullable NSNumber *)limit;
...
/// 
- (DBRpcTask<DBTEAMExcludedUsersListResult *, DBTEAMExcludedUsersListContinueError *> *)memberSpaceLimitsExcludedUsersListContinue:(NSString *)cursor;
...
/// or a `DBTEAMExcludedUsersUpdateError` object on failure.
/// 
- (DBRpcTask<DBTEAMExcludedUsersUpdateResult *, DBTEAMExcludedUsersUpdateError *> *)memberSpaceLimitsExcludedUsersRemove;
...
/// or a `DBTEAMExcludedUsersUpdateError` object on failure.
/// 
- (DBRpcTask<DBTEAMExcludedUsersUpdateResult *, DBTEAMExcludedUsersUpdateError *> *)memberSpaceLimitsExcludedUsersRemove:(nullable NSArray<DBTEAMUserSelectorArg *> *)users;
...
/// 
- (DBRpcTask<NSArray<DBTEAMCustomQuotaResult *> *, DBTEAMCustomQuotaError *> *)memberSpaceLimitsGetCustomQuota:(NSArray<DBTEAMUserSelectorArg *> *)users;
...
/// 
- (DBRpcTask<NSArray<DBTEAMRemoveCustomQuotaResult *> *, DBTEAMCustomQuotaError *> *)memberSpaceLimitsRemoveCustomQuota:(NSArray<DBTEAMUserSelectorArg *> *)users;
...
/// 
- (DBRpcTask<NSArray<DBTEAMCustomQuotaResult *> *, DBTEAMSetCustomQuotaError *> *)memberSpaceLimitsSetCustomQuota:(NSArray<DBTEAMUserCustomQuotaArg *> *)usersAndQuotas;
...
/// `void` object on failure.
/// 
- (DBRpcTask<DBTEAMMembersAddLaunch *, DBNilObject *> *)membersAdd:(NSArray<DBTEAMMemberAddArg *> *)dNewMembers forceAsync:(nullable NSNumber *)forceAsync;
...
/// 
- (DBRpcTask<DBTEAMMembersAddLaunchV2Result *, DBNilObject *> *)membersAddV2:(NSArray<DBTEAMMemberAddV2Arg *> *)dNewMembers;
...
/// or a `void` object on failure.
/// 
- (DBRpcTask<DBTEAMMembersAddLaunchV2Result *, DBNilObject *> *)membersAddV2:(NSArray<DBTEAMMemberAddV2Arg *> *)dNewMembers forceAsync:(nullable NSNumber *)forceAsync;
...
/// 
- (DBRpcTask<DBNilObject *, DBTEAMMembersDeleteFormerMemberFilesError *> *)membersDeleteFormerMemberFiles:(DBTEAMUserSelectorArg *)user;
...
/// 
- (DBRpcTask<DBTEAMTeamMemberInfo *, DBTEAMMembersDeleteProfilePhotoError *> *)membersDeleteProfilePhoto:(DBTEAMUserSelectorArg *)user;
...
/// 
- (DBRpcTask<DBTEAMTeamMemberInfoV2Result *, DBTEAMMembersDeleteProfilePhotoError *> *)membersDeleteProfilePhotoV2:(DBTEAMUserSelectorArg *)user;
...
/// 
- (DBRpcTask<NSArray<DBTEAMMembersGetInfoItem *> *, DBTEAMMembersGetInfoError *> *)membersGetInfo:(NSArray<DBTEAMUserSelectorArg *> *)members;
...
/// 
- (DBRpcTask<DBTEAMMembersGetInfoV2Result *, DBTEAMMembersGetInfoError *> *)membersGetInfoV2:(NSArray<DBTEAMUserSelectorArg *> *)members;
...
/// `DBTEAMMembersListError` object on failure.
/// 
- (DBRpcTask<DBTEAMMembersListResult *, DBTEAMMembersListError *> *)membersList:(nullable NSNumber *)limit includeRemoved:(nullable NSNumber *)includeRemoved;
...
/// `DBTEAMMembersListError` object on failure.
/// 
- (DBRpcTask<DBTEAMMembersListV2Result *, DBTEAMMembersListError *> *)membersListV2:(nullable NSNumber *)limit includeRemoved:(nullable NSNumber *)includeRemoved;
...
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBTEAMMembersTransferFormerMembersFilesError *> *)membersMoveFormerMemberFiles:(DBTEAMUserSelectorArg *)user transferDestId:(DBTEAMUserSelectorArg *)transferDestId transferAdminId:(DBTEAMUserSelectorArg *)transferAdminId;
...
/// `DBASYNCPollError` object on failure.
/// 
- (DBRpcTask<DBASYNCPollEmptyResult *, DBASYNCPollError *> *)membersMoveFormerMemberFilesJobStatusCheck:(NSString *)asyncJobId;
...
/// `DBTEAMMembersRemoveError` object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBTEAMMembersRemoveError *> *)membersRemove:(DBTEAMUserSelectorArg *)user wipeData:(nullable NSNumber *)wipeData transferDestId:(nullable DBTEAMUserSelectorArg *)transferDestId transferAdminId:(nullable DBTEAMUserSelectorArg *)transferAdminId keepAccount:(nullable NSNumber *)keepAccount retainTeamShares:(nullable NSNumber *)retainTeamShares permanentlyDeleteFiles:(nullable NSNumber *)permanentlyDeleteFiles;
...
/// 
- (DBRpcTask<DBTEAMAddSecondaryEmailsResult *, DBTEAMAddSecondaryEmailsError *> *)membersSecondaryEmailsAdd:(NSArray<DBTEAMUserSecondaryEmailsArg *> *)dNewSecondaryEmails;
...
/// 
- (DBRpcTask<DBTEAMDeleteSecondaryEmailsResult *, DBNilObject *> *)membersSecondaryEmailsDelete:(NSArray<DBTEAMUserSecondaryEmailsArg *> *)emailsToDelete;
...
/// success or a `void` object on failure.
/// 
- (DBRpcTask<DBTEAMResendVerificationEmailResult *, DBNilObject *> *)membersSecondaryEmailsResendVerificationEmails:(NSArray<DBTEAMUserSecondaryEmailsArg *> *)emailsToResend;
...
/// 
- (DBRpcTask<DBNilObject *, DBTEAMMembersSendWelcomeError *> *)membersSendWelcomeEmail:(DBTEAMUserSelectorArg *)userSelectorArg;
...
/// 
- (DBRpcTask<DBTEAMMembersSetPermissionsResult *, DBTEAMMembersSetPermissionsError *> *)membersSetAdminPermissions:(DBTEAMUserSelectorArg *)user dNewRole:(DBTEAMAdminTier *)dNewRole;
...
/// 
- (DBRpcTask<DBTEAMMembersSetPermissions2Result *, DBTEAMMembersSetPermissions2Error *> *)membersSetAdminPermissionsV2:(DBTEAMUserSelectorArg *)user;
...
/// success or a `DBTEAMMembersSetPermissions2Error` object on failure.
/// 
- (DBRpcTask<DBTEAMMembersSetPermissions2Result *, DBTEAMMembersSetPermissions2Error *> *)membersSetAdminPermissionsV2:(DBTEAMUserSelectorArg *)user dNewRoles:(nullable NSArray<NSString *> *)dNewRoles;
...
/// 
- (DBRpcTask<DBTEAMTeamMemberInfoV2Result *, DBTEAMMembersSetProfileError *> *)membersSetProfileV2:(DBTEAMUserSelectorArg *)user;
...
/// a `DBTEAMMembersSetProfileError` object on failure.
/// 
- (DBRpcTask<DBTEAMTeamMemberInfoV2Result *, DBTEAMMembersSetProfileError *> *)membersSetProfileV2:(DBTEAMUserSelectorArg *)user dNewEmail:(nullable NSString *)dNewEmail dNewExternalId:(nullable NSString *)dNewExternalId dNewGivenName:(nullable NSString *)dNewGivenName dNewSurname:(nullable NSString *)dNewSurname dNewPersistentId:(nullable NSString *)dNewPersistentId dNewIsDirectoryRestricted:(nullable NSNumber *)dNewIsDirectoryRestricted;
...
/// 
- (DBRpcTask<DBTEAMTeamMemberInfo *, DBTEAMMembersSetProfilePhotoError *> *)membersSetProfilePhoto:(DBTEAMUserSelectorArg *)user photo:(DBACCOUNTPhotoSourceArg *)photo;
...
/// 
- (DBRpcTask<DBTEAMTeamMemberInfoV2Result *, DBTEAMMembersSetProfilePhotoError *> *)membersSetProfilePhotoV2:(DBTEAMUserSelectorArg *)user photo:(DBACCOUNTPhotoSourceArg *)photo;
...
/// `DBTEAMMembersSuspendError` object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBTEAMMembersSuspendError *> *)membersSuspend:(DBTEAMUserSelectorArg *)user wipeData:(nullable NSNumber *)wipeData;
...
/// or a `DBTEAMTeamNamespacesListError` object on failure.
/// 
- (DBRpcTask<DBTEAMTeamNamespacesListResult *, DBTEAMTeamNamespacesListError *> *)namespacesList:(nullable NSNumber *)limit;
...
/// 
- (DBRpcTask<DBTEAMTeamNamespacesListResult *, DBTEAMTeamNamespacesListContinueError *> *)namespacesListContinue:(NSString *)cursor;
...
/// 
- (DBRpcTask<DBFILEPROPERTIESAddTemplateResult *, DBFILEPROPERTIESModifyTemplateError *> *)propertiesTemplateAdd:(NSString *)name description_:(NSString *)description_ fields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)fields __deprecated_msg("propertiesTemplateAdd is deprecated.");
...
/// 
- (DBRpcTask<DBFILEPROPERTIESGetTemplateResult *, DBFILEPROPERTIESTemplateError *> *)propertiesTemplateGet:(NSString *)templateId __deprecated_msg("propertiesTemplateGet is deprecated.");
...
/// 
- (DBRpcTask<DBTEAMGetActivityReport *, DBTEAMDateRangeError *> *)reportsGetActivity __deprecated_msg("reportsGetActivity is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetActivityReport *, DBTEAMDateRangeError *> *)reportsGetActivity:(nullable NSDate *)startDate endDate:(nullable NSDate *)endDate __deprecated_msg("reportsGetActivity is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetDevicesReport *, DBTEAMDateRangeError *> *)reportsGetDevices __deprecated_msg("reportsGetDevices is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetDevicesReport *, DBTEAMDateRangeError *> *)reportsGetDevices:(nullable NSDate *)startDate endDate:(nullable NSDate *)endDate __deprecated_msg("reportsGetDevices is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetMembershipReport *, DBTEAMDateRangeError *> *)reportsGetMembership __deprecated_msg("reportsGetMembership is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetMembershipReport *, DBTEAMDateRangeError *> *)reportsGetMembership:(nullable NSDate *)startDate endDate:(nullable NSDate *)endDate __deprecated_msg("reportsGetMembership is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetStorageReport *, DBTEAMDateRangeError *> *)reportsGetStorage __deprecated_msg("reportsGetStorage is deprecated.");
...
/// `DBTEAMDateRangeError` object on failure.
/// 
- (DBRpcTask<DBTEAMGetStorageReport *, DBTEAMDateRangeError *> *)reportsGetStorage:(nullable NSDate *)startDate endDate:(nullable NSDate *)endDate __deprecated_msg("reportsGetStorage is deprecated.");
...
/// success or a `DBTEAMSharingAllowlistAddError` object on failure.
/// 
- (DBRpcTask<DBTEAMSharingAllowlistAddResponse *, DBTEAMSharingAllowlistAddError *> *)sharingAllowlistAdd:(nullable NSArray<NSString *> *)domains emails:(nullable NSArray<NSString *> *)emails;
...
/// success or a `DBTEAMSharingAllowlistListError` object on failure.
/// 
- (DBRpcTask<DBTEAMSharingAllowlistListResponse *, DBTEAMSharingAllowlistListError *> *)sharingAllowlistList:(nullable NSNumber *)limit;
...
/// 
- (DBRpcTask<DBTEAMSharingAllowlistListResponse *, DBTEAMSharingAllowlistListContinueError *> *)sharingAllowlistListContinue:(NSString *)cursor;
...
/// success or a `DBTEAMSharingAllowlistRemoveError` object on failure.
/// 
- (DBRpcTask<DBTEAMSharingAllowlistRemoveResponse *, DBTEAMSharingAllowlistRemoveError *> *)sharingAllowlistRemove:(nullable NSArray<NSString *> *)domains emails:(nullable NSArray<NSString *> *)emails;
...
/// 
- (DBRpcTask<DBTEAMTeamFolderArchiveLaunch *, DBTEAMTeamFolderArchiveError *> *)teamFolderArchive:(NSString *)teamFolderId;
...
/// or a `DBTEAMTeamFolderArchiveError` object on failure.
/// 
- (DBRpcTask<DBTEAMTeamFolderArchiveLaunch *, DBTEAMTeamFolderArchiveError *> *)teamFolderArchive:(NSString *)teamFolderId forceAsyncOff:(nullable NSNumber *)forceAsyncOff;
...
/// `DBTEAMTeamFolderCreateError` object on failure.
/// 
- (DBRpcTask<DBTEAMTeamFolderMetadata *, DBTEAMTeamFolderCreateError *> *)teamFolderCreate:(NSString *)name syncSetting:(nullable DBFILESSyncSettingArg *)syncSetting;
...
/// success or a `void` object on failure.
/// 
- (DBRpcTask<NSArray<DBTEAMTeamFolderGetInfoItem *> *, DBNilObject *> *)teamFolderGetInfo:(NSArray<NSString *> *)teamFolderIds;
...
/// 
- (DBRpcTask<DBTEAMTeamFolderListResult *, DBTEAMTeamFolderListContinueError *> *)teamFolderListContinue:(NSString *)cursor;
...
/// 
- (DBRpcTask<DBNilObject *, DBTEAMTeamFolderPermanentlyDeleteError *> *)teamFolderPermanentlyDelete:(NSString *)teamFolderId;
...
/// 
- (DBRpcTask<DBTEAMTeamFolderMetadata *, DBTEAMTeamFolderRenameError *> *)teamFolderRename:(NSString *)teamFolderId name:(NSString *)name;
...
/// 
- (DBRpcTask<DBTEAMTeamFolderMetadata *, DBTEAMTeamFolderUpdateSyncSettingsError *> *)teamFolderUpdateSyncSettings:(NSString *)teamFolderId;
...
/// `DBTEAMTeamFolderUpdateSyncSettingsError` object on failure.
/// 
- (DBRpcTask<DBTEAMTeamFolderMetadata *, DBTEAMTeamFolderUpdateSyncSettingsError *> *)teamFolderUpdateSyncSettings:(NSString *)teamFolderId syncSetting:(nullable DBFILESSyncSettingArg *)syncSetting contentSyncSettings:(nullable NSArray<DBFILESContentSyncSettingArg *> *)contentSyncSettings;
...
/// 
- (DBRpcTask<DBTEAMTokenGetAuthenticatedAdminResult *, DBTEAMTokenGetAuthenticatedAdminError *> *)tokenGetAuthenticatedAdmin;
