...
/// a `DBTEAMLOGGetTeamEventsError` object on failure.
/// 
- (DBRpcTask<DBTEAMLOGGetTeamEventsResult *, DBTEAMLOGGetTeamEventsError *> *)getEvents:(nullable NSNumber *)limit accountId:(nullable NSString *)accountId time:(nullable DBTEAMCOMMONTimeRange *)time category:(nullable DBTEAMLOGEventCategory *)category eventType:(nullable DBTEAMLOGEventTypeArg *)eventType;
...
/// 
- (DBRpcTask<DBTEAMLOGGetTeamEventsResult *, DBTEAMLOGGetTeamEventsContinueError *> *)getEventsContinue:(NSString *)cursor;
