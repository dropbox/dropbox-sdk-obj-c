...
- (DBRpcTask *)addFileMember:(NSString *)file members:(NSArray<DBSHARINGMemberSelector *> *)members customMessage:(NSString *)customMessage quiet:(NSNumber *)quiet accessLevel:(DBSHARINGAccessLevel *)accessLevel addMessageAsComment:(NSNumber *)addMessageAsComment fpSealedResult:(NSString *)fpSealedResult {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGAddFileMember;
    DBSHARINGAddFileMemberArgs *arg = [[DBSHARINGAddFileMemberArgs alloc] initWithFile:file members:members customMessage:customMessage quiet:quiet accessLevel:accessLevel addMessageAsComment:addMessageAsComment fpSealedResult:fpSealedResult];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)addFolderMember:(NSString *)sharedFolderId members:(NSArray<DBSHARINGAddMember *> *)members {
    ...
    DBSHARINGAddFolderMemberArg *arg = [[DBSHARINGAddFolderMemberArg alloc] initWithSharedFolderId:sharedFolderId members:members];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)addFolderMember:(NSString *)sharedFolderId members:(NSArray<DBSHARINGAddMember *> *)members quiet:(NSNumber *)quiet customMessage:(NSString *)customMessage fpSealedResult:(NSString *)fpSealedResult {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGAddFolderMember;
    DBSHARINGAddFolderMemberArg *arg = [[DBSHARINGAddFolderMemberArg alloc] initWithSharedFolderId:sharedFolderId members:members quiet:quiet customMessage:customMessage fpSealedResult:fpSealedResult];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)createSharedLink:(NSString *)path shortUrl:(NSNumber *)shortUrl pendingUpload:(DBSHARINGPendingUploadMode *)pendingUpload {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGCreateSharedLink;
    DBSHARINGCreateSharedLinkArg *arg = [[DBSHARINGCreateSharedLinkArg alloc] initWithPath:path shortUrl:shortUrl pendingUpload:pendingUpload];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)createSharedLinkWithSettings:(NSString *)path settings:(DBSHARINGSharedLinkSettings *)settings {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGCreateSharedLinkWithSettings;
    DBSHARINGCreateSharedLinkWithSettingsArg *arg = [[DBSHARINGCreateSharedLinkWithSettingsArg alloc] initWithPath:path settings:settings];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)getFileMetadataBatch:(NSArray<NSString *> *)files actions:(NSArray<DBSHARINGFileAction *> *)actions {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetFileMetadataBatch;
    DBSHARINGGetFileMetadataBatchArg *arg = [[DBSHARINGGetFileMetadataBatchArg alloc] initWithFiles:files actions:actions];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)getFolderMetadata:(NSString *)sharedFolderId actions:(NSArray<DBSHARINGFolderAction *> *)actions {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetFolderMetadata;
    DBSHARINGGetMetadataArgs *arg = [[DBSHARINGGetMetadataArgs alloc] initWithSharedFolderId:sharedFolderId actions:actions];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBDownloadUrlTask *)getSharedLinkFileUrl:(NSString *)url path:(NSString *)path linkPassword:(NSString *)linkPassword overwrite:(BOOL)overwrite destination:(NSURL *)destination {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetSharedLinkFile;
    DBSHARINGGetSharedLinkMetadataArg *arg = [[DBSHARINGGetSharedLinkMetadataArg alloc] initWithUrl:url path:path linkPassword:linkPassword];
    return [self.client requestDownload:route arg:arg overwrite:overwrite destination:destination];
}

- (DBDownloadUrlTask *)getSharedLinkFileUrl:(NSString *)url overwrite:(BOOL)overwrite destination:(NSURL *)destination byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetSharedLinkFile;
    DBSHARINGGetSharedLinkMetadataArg *arg = [[DBSHARINGGetSharedLinkMetadataArg alloc] initWithUrl:url];
...
- (DBDownloadUrlTask *)getSharedLinkFileUrl:(NSString *)url path:(NSString *)path linkPassword:(NSString *)linkPassword overwrite:(BOOL)overwrite destination:(NSURL *)destination byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetSharedLinkFile;
    DBSHARINGGetSharedLinkMetadataArg *arg = [[DBSHARINGGetSharedLinkMetadataArg alloc] initWithUrl:url path:path linkPassword:linkPassword];
    return [self.client requestDownload:route arg:arg overwrite:overwrite destination:destination byteOffsetStart:byteOffsetStart byteOffsetEnd:byteOffsetEnd];
}
...
- (DBDownloadDataTask *)getSharedLinkFileData:(NSString *)url path:(NSString *)path linkPassword:(NSString *)linkPassword {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetSharedLinkFile;
    DBSHARINGGetSharedLinkMetadataArg *arg = [[DBSHARINGGetSharedLinkMetadataArg alloc] initWithUrl:url path:path linkPassword:linkPassword];
    return [self.client requestDownload:route arg:arg];
}

- (DBDownloadDataTask *)getSharedLinkFileData:(NSString *)url byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetSharedLinkFile;
    DBSHARINGGetSharedLinkMetadataArg *arg = [[DBSHARINGGetSharedLinkMetadataArg alloc] initWithUrl:url];
    return [self.client requestDownload:route arg:arg byteOffsetStart:byteOffsetStart byteOffsetEnd:byteOffsetEnd];
}

- (DBDownloadDataTask *)getSharedLinkFileData:(NSString *)url path:(NSString *)path linkPassword:(NSString *)linkPassword byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGGetSharedLinkFile;
    DBSHARINGGetSharedLinkMetadataArg *arg = [[DBSHARINGGetSharedLinkMetadataArg alloc] initWithUrl:url path:path linkPassword:linkPassword];
    return [self.client requestDownload:route arg:arg byteOffsetStart:byteOffsetStart byteOffsetEnd:byteOffsetEnd];
}
...
- (DBRpcTask *)listFileMembers:(NSString *)file actions:(NSArray<DBSHARINGMemberAction *> *)actions includeInherited:(NSNumber *)includeInherited limit:(NSNumber *)limit {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGListFileMembers;
    DBSHARINGListFileMembersArg *arg = [[DBSHARINGListFileMembersArg alloc] initWithFile:file actions:actions includeInherited:includeInherited limit:limit];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)listFolderMembers:(NSString *)sharedFolderId actions:(NSArray<DBSHARINGMemberAction *> *)actions limit:(NSNumber *)limit path:(NSString *)path {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGListFolderMembers;
    DBSHARINGListFolderMembersArgs *arg = [[DBSHARINGListFolderMembersArgs alloc] initWithSharedFolderId:sharedFolderId actions:actions limit:limit path:path];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)listSharedLinks:(NSString *)path cursor:(NSString *)cursor directOnly:(NSNumber *)directOnly {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGListSharedLinks;
    DBSHARINGListSharedLinksArg *arg = [[DBSHARINGListSharedLinksArg alloc] initWithPath:path cursor:cursor directOnly:directOnly];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)modifySharedLinkSettings:(NSString *)url settings:(DBSHARINGSharedLinkSettings *)settings {
    ...
    DBSHARINGModifySharedLinkSettingsArgs *arg = [[DBSHARINGModifySharedLinkSettingsArgs alloc] initWithUrl:url settings:settings];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)modifySharedLinkSettings:(NSString *)url settings:(DBSHARINGSharedLinkSettings *)settings removeExpiration:(NSNumber *)removeExpiration {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGModifySharedLinkSettings;
    DBSHARINGModifySharedLinkSettingsArgs *arg = [[DBSHARINGModifySharedLinkSettingsArgs alloc] initWithUrl:url settings:settings removeExpiration:removeExpiration];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)relinquishFolderMembership:(NSString *)sharedFolderId {
    ...
    DBSHARINGRelinquishFolderMembershipArg *arg = [[DBSHARINGRelinquishFolderMembershipArg alloc] initWithSharedFolderId:sharedFolderId];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)relinquishFolderMembership:(NSString *)sharedFolderId leaveACopy:(NSNumber *)leaveACopy {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGRelinquishFolderMembership;
    DBSHARINGRelinquishFolderMembershipArg *arg = [[DBSHARINGRelinquishFolderMembershipArg alloc] initWithSharedFolderId:sharedFolderId leaveACopy:leaveACopy];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)removeFolderMember:(NSString *)sharedFolderId member:(DBSHARINGMemberSelector *)member leaveACopy:(NSNumber *)leaveACopy {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGRemoveFolderMember;
    DBSHARINGRemoveFolderMemberArg *arg = [[DBSHARINGRemoveFolderMemberArg alloc] initWithSharedFolderId:sharedFolderId member:member leaveACopy:leaveACopy];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)setAccessInheritance:(NSString *)sharedFolderId accessInheritance:(DBSHARINGAccessInheritance *)accessInheritance {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGSetAccessInheritance;
    DBSHARINGSetAccessInheritanceArg *arg = [[DBSHARINGSetAccessInheritanceArg alloc] initWithSharedFolderId:sharedFolderId accessInheritance:accessInheritance];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)transferFolder:(NSString *)sharedFolderId toDropboxId:(NSString *)toDropboxId {
    ...
    DBSHARINGTransferFolderArg *arg = [[DBSHARINGTransferFolderArg alloc] initWithSharedFolderId:sharedFolderId toDropboxId:toDropboxId];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)unshareFolder:(NSString *)sharedFolderId leaveACopy:(NSNumber *)leaveACopy {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGUnshareFolder;
    DBSHARINGUnshareFolderArg *arg = [[DBSHARINGUnshareFolderArg alloc] initWithSharedFolderId:sharedFolderId leaveACopy:leaveACopy];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)updateFileMember:(NSString *)file member:(DBSHARINGMemberSelector *)member accessLevel:(DBSHARINGAccessLevel *)accessLevel {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGUpdateFileMember;
    DBSHARINGUpdateFileMemberArgs *arg = [[DBSHARINGUpdateFileMemberArgs alloc] initWithFile:file member:member accessLevel:accessLevel];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)updateFilePolicy:(NSString *)file actions:(NSArray<DBSHARINGFileAction *> *)actions linkSettings:(DBSHARINGLinkSettings *)linkSettings viewerInfoPolicy:(DBSHARINGViewerInfoPolicy *)viewerInfoPolicy {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGUpdateFilePolicy;
    DBSHARINGUpdateFilePolicyArg *arg = [[DBSHARINGUpdateFilePolicyArg alloc] initWithFile:file actions:actions linkSettings:linkSettings viewerInfoPolicy:viewerInfoPolicy];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)updateFolderMember:(NSString *)sharedFolderId member:(DBSHARINGMemberSelector *)member accessLevel:(DBSHARINGAccessLevel *)accessLevel {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGUpdateFolderMember;
    DBSHARINGUpdateFolderMemberArg *arg = [[DBSHARINGUpdateFolderMemberArg alloc] initWithSharedFolderId:sharedFolderId member:member accessLevel:accessLevel];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)updateFolderPolicy:(NSString *)sharedFolderId memberPolicy:(DBSHARINGMemberPolicy *)memberPolicy aclUpdatePolicy:(DBSHARINGAclUpdatePolicy *)aclUpdatePolicy viewerInfoPolicy:(DBSHARINGViewerInfoPolicy *)viewerInfoPolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy *)sharedLinkPolicy linkSettings:(DBSHARINGLinkSettings *)linkSettings actions:(NSArray<DBSHARINGFolderAction *> *)actions {
    DBRoute *route = DBSHARINGRouteObjects.DBSHARINGUpdateFolderPolicy;
    DBSHARINGUpdateFolderPolicyArg *arg = [[DBSHARINGUpdateFolderPolicyArg alloc] initWithSharedFolderId:sharedFolderId memberPolicy:memberPolicy aclUpdatePolicy:aclUpdatePolicy viewerInfoPolicy:viewerInfoPolicy sharedLinkPolicy:sharedLinkPolicy linkSettings:linkSettings actions:actions];
    return [self.client requestRpc:route arg:arg];
}
