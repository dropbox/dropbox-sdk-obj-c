...
- (DBRpcTask *)templatesAddForTeam:(NSString *)name description_:(NSString *)description_ fields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)fields {
...
- (DBRpcTask *)templatesUpdateForTeam:(NSString *)templateId name:(NSString *)name description_:(NSString *)description_ addFields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)addFields {
    DBRoute *route = DBFILEPROPERTIESRouteObjects.DBFILEPROPERTIESTemplatesUpdateForTeam;
