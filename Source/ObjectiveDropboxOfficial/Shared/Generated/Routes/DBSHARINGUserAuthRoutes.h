...
/// 
- (DBRpcTask<NSArray<DBSHARINGFileMemberActionResult *> *, DBSHARINGAddFileMemberError *> *)addFileMember:(NSString *)file members:(NSArray<DBSHARINGMemberSelector *> *)members;
...
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGAddFolderMemberError *> *)addFolderMember:(NSString *)sharedFolderId members:(NSArray<DBSHARINGAddMember *> *)members;
...
/// `DBSHARINGAddFolderMemberError` object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGAddFolderMemberError *> *)addFolderMember:(NSString *)sharedFolderId members:(NSArray<DBSHARINGAddMember *> *)members quiet:(nullable NSNumber *)quiet customMessage:(nullable NSString *)customMessage fpSealedResult:(nullable NSString *)fpSealedResult;
...
/// 
- (DBRpcTask<DBSHARINGPathLinkMetadata *, DBSHARINGCreateSharedLinkError *> *)createSharedLink:(NSString *)path __deprecated_msg("createSharedLink is deprecated.");
...
/// `DBSHARINGCreateSharedLinkError` object on failure.
/// 
- (DBRpcTask<DBSHARINGPathLinkMetadata *, DBSHARINGCreateSharedLinkError *> *)createSharedLink:(NSString *)path shortUrl:(nullable NSNumber *)shortUrl pendingUpload:(nullable DBSHARINGPendingUploadMode *)pendingUpload __deprecated_msg("createSharedLink is deprecated.");
...
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGCreateSharedLinkWithSettingsError *> *)createSharedLinkWithSettings:(NSString *)path;
...
/// a `DBSHARINGCreateSharedLinkWithSettingsError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGCreateSharedLinkWithSettingsError *> *)createSharedLinkWithSettings:(NSString *)path settings:(nullable DBSHARINGSharedLinkSettings *)settings;
...
/// a `DBSHARINGGetFileMetadataError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMetadata *, DBSHARINGGetFileMetadataError *> *)getFileMetadata:(NSString *)file actions:(nullable NSArray<DBSHARINGFileAction *> *)actions;
...
/// 
- (DBRpcTask<NSArray<DBSHARINGGetFileMetadataBatchResult *> *, DBSHARINGSharingUserError *> *)getFileMetadataBatch:(NSArray<NSString *> *)files;
...
/// object on success or a `DBSHARINGSharingUserError` object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGGetFileMetadataBatchResult *> *, DBSHARINGSharingUserError *> *)getFileMetadataBatch:(NSArray<NSString *> *)files actions:(nullable NSArray<DBSHARINGFileAction *> *)actions;
...
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGSharedFolderAccessError *> *)getFolderMetadata:(NSString *)sharedFolderId;
...
/// or a `DBSHARINGSharedFolderAccessError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGSharedFolderAccessError *> *)getFolderMetadata:(NSString *)sharedFolderId actions:(nullable NSArray<DBSHARINGFolderAction *> *)actions;
...
/// 
- (DBRpcTask<DBSHARINGGetSharedLinksResult *, DBSHARINGGetSharedLinksError *> *)getSharedLinks __deprecated_msg("getSharedLinks is deprecated.");
...
/// or a `DBSHARINGGetSharedLinksError` object on failure.
/// 
- (DBRpcTask<DBSHARINGGetSharedLinksResult *, DBSHARINGGetSharedLinksError *> *)getSharedLinks:(nullable NSString *)path __deprecated_msg("getSharedLinks is deprecated.");
...
/// `DBSHARINGListFileMembersError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMembers *, DBSHARINGListFileMembersError *> *)listFileMembers:(NSString *)file actions:(nullable NSArray<DBSHARINGMemberAction *> *)actions includeInherited:(nullable NSNumber *)includeInherited limit:(nullable NSNumber *)limit;
...
/// object on success or a `DBSHARINGSharingUserError` object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGListFileMembersBatchResult *> *, DBSHARINGSharingUserError *> *)listFileMembersBatch:(NSArray<NSString *> *)files;
...
/// object on success or a `DBSHARINGSharingUserError` object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGListFileMembersBatchResult *> *, DBSHARINGSharingUserError *> *)listFileMembersBatch:(NSArray<NSString *> *)files limit:(nullable NSNumber *)limit;
...
/// 
- (DBRpcTask<DBSHARINGSharedFileMembers *, DBSHARINGListFileMembersContinueError *> *)listFileMembersContinue:(NSString *)cursor;
...
/// 
- (DBRpcTask<DBSHARINGSharedFolderMembers *, DBSHARINGSharedFolderAccessError *> *)listFolderMembers:(NSString *)sharedFolderId;
...
/// a `DBSHARINGSharedFolderAccessError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMembers *, DBSHARINGSharedFolderAccessError *> *)listFolderMembers:(NSString *)sharedFolderId actions:(nullable NSArray<DBSHARINGMemberAction *> *)actions limit:(nullable NSNumber *)limit path:(nullable NSString *)path;
...
/// 
- (DBRpcTask<DBSHARINGSharedFolderMembers *, DBSHARINGListFolderMembersContinueError *> *)listFolderMembersContinue:(NSString *)cursor;
...
/// `void` object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBNilObject *> *)listFolders:(nullable NSNumber *)limit actions:(nullable NSArray<DBSHARINGFolderAction *> *)actions;
...
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBSHARINGListFoldersContinueError *> *)listFoldersContinue:(NSString *)cursor;
...
/// `void` object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBNilObject *> *)listMountableFolders:(nullable NSNumber *)limit actions:(nullable NSArray<DBSHARINGFolderAction *> *)actions;
...
/// `DBSHARINGListFoldersContinueError` object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBSHARINGListFoldersContinueError *> *)listMountableFoldersContinue:(NSString *)cursor;
...
/// `DBSHARINGSharingUserError` object on failure.
/// 
- (DBRpcTask<DBSHARINGListFilesResult *, DBSHARINGSharingUserError *> *)listReceivedFiles:(nullable NSNumber *)limit actions:(nullable NSArray<DBSHARINGFileAction *> *)actions;
...
/// 
- (DBRpcTask<DBSHARINGListFilesResult *, DBSHARINGListFilesContinueError *> *)listReceivedFilesContinue:(NSString *)cursor;
...
/// or a `DBSHARINGListSharedLinksError` object on failure.
/// 
- (DBRpcTask<DBSHARINGListSharedLinksResult *, DBSHARINGListSharedLinksError *> *)listSharedLinks:(nullable NSString *)path cursor:(nullable NSString *)cursor directOnly:(nullable NSNumber *)directOnly;
...
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGModifySharedLinkSettingsError *> *)modifySharedLinkSettings:(NSString *)url settings:(DBSHARINGSharedLinkSettings *)settings;
...
/// a `DBSHARINGModifySharedLinkSettingsError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGModifySharedLinkSettingsError *> *)modifySharedLinkSettings:(NSString *)url settings:(DBSHARINGSharedLinkSettings *)settings removeExpiration:(nullable NSNumber *)removeExpiration;
...
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGRelinquishFolderMembershipError *> *)relinquishFolderMembership:(NSString *)sharedFolderId;
...
/// `DBSHARINGRelinquishFolderMembershipError` object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGRelinquishFolderMembershipError *> *)relinquishFolderMembership:(NSString *)sharedFolderId leaveACopy:(nullable NSNumber *)leaveACopy;
...
/// 
- (DBRpcTask<DBSHARINGFileMemberActionIndividualResult *, DBSHARINGRemoveFileMemberError *> *)removeFileMember:(NSString *)file member:(DBSHARINGMemberSelector *)member __deprecated_msg("removeFileMember is deprecated.");
...
/// 
- (DBRpcTask<DBSHARINGFileMemberRemoveActionResult *, DBSHARINGRemoveFileMemberError *> *)removeFileMember2:(NSString *)file member:(DBSHARINGMemberSelector *)member;
...
/// 
- (DBRpcTask<DBASYNCLaunchResultBase *, DBSHARINGRemoveFolderMemberError *> *)removeFolderMember:(NSString *)sharedFolderId member:(DBSHARINGMemberSelector *)member leaveACopy:(NSNumber *)leaveACopy;
...
/// 
- (DBRpcTask<DBSHARINGShareFolderLaunch *, DBSHARINGSetAccessInheritanceError *> *)setAccessInheritance:(NSString *)sharedFolderId;
...
/// `DBSHARINGSetAccessInheritanceError` object on failure.
/// 
- (DBRpcTask<DBSHARINGShareFolderLaunch *, DBSHARINGSetAccessInheritanceError *> *)setAccessInheritance:(NSString *)sharedFolderId accessInheritance:(nullable DBSHARINGAccessInheritance *)accessInheritance;
...
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGTransferFolderError *> *)transferFolder:(NSString *)sharedFolderId toDropboxId:(NSString *)toDropboxId;
...
/// `DBSHARINGUnshareFolderError` object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGUnshareFolderError *> *)unshareFolder:(NSString *)sharedFolderId leaveACopy:(nullable NSNumber *)leaveACopy;
...
/// 
- (DBRpcTask<DBSHARINGMemberAccessLevelResult *, DBSHARINGFileMemberActionError *> *)updateFileMember:(NSString *)file member:(DBSHARINGMemberSelector *)member accessLevel:(DBSHARINGAccessLevel *)accessLevel;
...
/// a `DBSHARINGUpdateFilePolicyError` object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMetadata *, DBSHARINGUpdateFilePolicyError *> *)updateFilePolicy:(NSString *)file actions:(nullable NSArray<DBSHARINGFileAction *> *)actions linkSettings:(nullable DBSHARINGLinkSettings *)linkSettings viewerInfoPolicy:(nullable DBSHARINGViewerInfoPolicy *)viewerInfoPolicy;
...
/// 
- (DBRpcTask<DBSHARINGMemberAccessLevelResult *, DBSHARINGUpdateFolderMemberError *> *)updateFolderMember:(NSString *)sharedFolderId member:(DBSHARINGMemberSelector *)member accessLevel:(DBSHARINGAccessLevel *)accessLevel;
...
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGUpdateFolderPolicyError *> *)updateFolderPolicy:(NSString *)sharedFolderId;
