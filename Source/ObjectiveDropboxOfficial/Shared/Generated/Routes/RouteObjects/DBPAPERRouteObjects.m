...
+ (DBRoute *)DBPAPERDocsArchive {
    @synchronized(lockObj) {
        if (!DBPAPERDocsArchive) {
            DBPAPERDocsArchive = [[DBRoute alloc] init:
                @"docs/archive"
                namespace_:@"paper"
                deprecated:@YES
                resultType:nil
...
+ (DBRoute *)DBPAPERDocsCreate {
    @synchronized(lockObj) {
        if (!DBPAPERDocsCreate) {
            DBPAPERDocsCreate = [[DBRoute alloc] init:
                @"docs/create"
                namespace_:@"paper"
                deprecated:@YES
...
+ (DBRoute *)DBPAPERDocsDownload {
    @synchronized(lockObj) {
        if (!DBPAPERDocsDownload) {
            DBPAPERDocsDownload = [[DBRoute alloc] init:
                @"docs/download"
                namespace_:@"paper"
                deprecated:@YES
...
+ (DBRoute *)DBPAPERDocsFolderUsersList {
    @synchronized(lockObj) {
        if (!DBPAPERDocsFolderUsersList) {
            DBPAPERDocsFolderUsersList = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsFolderUsersListContinue {
    @synchronized(lockObj) {
        if (!DBPAPERDocsFolderUsersListContinue) {
            DBPAPERDocsFolderUsersListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsGetFolderInfo {
    @synchronized(lockObj) {
        if (!DBPAPERDocsGetFolderInfo) {
            DBPAPERDocsGetFolderInfo = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsGetMetadata {
    @synchronized(lockObj) {
        if (!DBPAPERDocsGetMetadata) {
            DBPAPERDocsGetMetadata = [[DBRoute alloc] init:
                @"docs/get_metadata"
                namespace_:@"paper"
                deprecated:@NO
...
+ (DBRoute *)DBPAPERDocsList {
    @synchronized(lockObj) {
        if (!DBPAPERDocsList) {
            DBPAPERDocsList = [[DBRoute alloc] init:
                @"docs/list"
                namespace_:@"paper"
                deprecated:@YES
...
+ (DBRoute *)DBPAPERDocsListContinue {
    @synchronized(lockObj) {
        if (!DBPAPERDocsListContinue) {
            DBPAPERDocsListContinue = [[DBRoute alloc] init:
                @"docs/list/continue"
                namespace_:@"paper"
                deprecated:@YES
                resultType:[DBPAPERListPaperDocsResponse class]
...
+ (DBRoute *)DBPAPERDocsPermanentlyDelete {
    @synchronized(lockObj) {
        if (!DBPAPERDocsPermanentlyDelete) {
            DBPAPERDocsPermanentlyDelete = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsSharingPolicyGet {
    @synchronized(lockObj) {
        if (!DBPAPERDocsSharingPolicyGet) {
            DBPAPERDocsSharingPolicyGet = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsSharingPolicySet {
    @synchronized(lockObj) {
        if (!DBPAPERDocsSharingPolicySet) {
            DBPAPERDocsSharingPolicySet = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsUpdate {
    @synchronized(lockObj) {
        if (!DBPAPERDocsUpdate) {
            DBPAPERDocsUpdate = [[DBRoute alloc] init:
                @"docs/update"
                namespace_:@"paper"
                deprecated:@YES
                resultType:[DBPAPERPaperDocCreateUpdateResult class]
...
+ (DBRoute *)DBPAPERDocsUsersAdd {
    @synchronized(lockObj) {
        if (!DBPAPERDocsUsersAdd) {
            DBPAPERDocsUsersAdd = [[DBRoute alloc] init:
                @"docs/users/add"
                namespace_:@"paper"
                deprecated:@YES
                ...
                attrs:@{@"auth": @"user",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBPAPERAddPaperDocUserMemberResultSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBPAPERDocsUsersList {
    @synchronized(lockObj) {
        if (!DBPAPERDocsUsersList) {
            DBPAPERDocsUsersList = [[DBRoute alloc] init:
                @"docs/users/list"
                namespace_:@"paper"
                deprecated:@YES
...
+ (DBRoute *)DBPAPERDocsUsersListContinue {
    @synchronized(lockObj) {
        if (!DBPAPERDocsUsersListContinue) {
            DBPAPERDocsUsersListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBPAPERDocsUsersRemove {
    @synchronized(lockObj) {
        if (!DBPAPERDocsUsersRemove) {
            DBPAPERDocsUsersRemove = [[DBRoute alloc] init:
                @"docs/users/remove"
                namespace_:@"paper"
                deprecated:@YES
                resultType:nil
...
+ (DBRoute *)DBPAPERFoldersCreate {
    @synchronized(lockObj) {
        if (!DBPAPERFoldersCreate) {
            DBPAPERFoldersCreate = [[DBRoute alloc] init:
                @"folders/create"
                namespace_:@"paper"
                deprecated:@YES
