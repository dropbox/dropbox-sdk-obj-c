...
+ (DBRoute *)DBTEAMDevicesListMemberDevices {
    @synchronized(lockObj) {
        if (!DBTEAMDevicesListMemberDevices) {
            DBTEAMDevicesListMemberDevices = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMDevicesListMembersDevices {
    @synchronized(lockObj) {
        if (!DBTEAMDevicesListMembersDevices) {
            DBTEAMDevicesListMembersDevices = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMDevicesListTeamDevices {
    @synchronized(lockObj) {
        if (!DBTEAMDevicesListTeamDevices) {
            DBTEAMDevicesListTeamDevices = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMDevicesRevokeDeviceSession {
    @synchronized(lockObj) {
        if (!DBTEAMDevicesRevokeDeviceSession) {
            DBTEAMDevicesRevokeDeviceSession = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMDevicesRevokeDeviceSessionBatch {
    @synchronized(lockObj) {
        if (!DBTEAMDevicesRevokeDeviceSessionBatch) {
            DBTEAMDevicesRevokeDeviceSessionBatch = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMFeaturesGetValues {
    @synchronized(lockObj) {
        if (!DBTEAMFeaturesGetValues) {
            DBTEAMFeaturesGetValues = [[DBRoute alloc] init:
                @"features/get_values"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGetInfo {
    @synchronized(lockObj) {
        if (!DBTEAMGetInfo) {
            DBTEAMGetInfo = [[DBRoute alloc] init:
                @"get_info"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGroupsCreate {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsCreate) {
            DBTEAMGroupsCreate = [[DBRoute alloc] init:
                @"groups/create"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGroupsDelete {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsDelete) {
            DBTEAMGroupsDelete = [[DBRoute alloc] init:
                @"groups/delete"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGroupsGetInfo {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsGetInfo) {
            DBTEAMGroupsGetInfo = [[DBRoute alloc] init:
                @"groups/get_info"
                namespace_:@"team"
                deprecated:@NO
                ...
                attrs:@{@"auth": @"team",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBTEAMGroupsGetInfoItemSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBTEAMGroupsJobStatusGet {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsJobStatusGet) {
            DBTEAMGroupsJobStatusGet = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMGroupsList {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsList) {
            DBTEAMGroupsList = [[DBRoute alloc] init:
                @"groups/list"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGroupsListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsListContinue) {
            DBTEAMGroupsListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMGroupsMembersAdd {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsMembersAdd) {
            DBTEAMGroupsMembersAdd = [[DBRoute alloc] init:
                @"groups/members/add"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGroupsMembersList {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsMembersList) {
            DBTEAMGroupsMembersList = [[DBRoute alloc] init:
                @"groups/members/list"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMGroupsMembersListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsMembersListContinue) {
            DBTEAMGroupsMembersListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMGroupsMembersRemove {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsMembersRemove) {
            DBTEAMGroupsMembersRemove = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMGroupsMembersSetAccessType {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsMembersSetAccessType) {
            DBTEAMGroupsMembersSetAccessType = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMGroupsUpdate {
    @synchronized(lockObj) {
        if (!DBTEAMGroupsUpdate) {
            DBTEAMGroupsUpdate = [[DBRoute alloc] init:
                @"groups/update"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMGroupFullInfo class]
...
+ (DBRoute *)DBTEAMLegalHoldsCreatePolicy {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsCreatePolicy) {
            DBTEAMLegalHoldsCreatePolicy = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLegalHoldsGetPolicy {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsGetPolicy) {
            DBTEAMLegalHoldsGetPolicy = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLegalHoldsListHeldRevisions {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsListHeldRevisions) {
            DBTEAMLegalHoldsListHeldRevisions = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLegalHoldsListHeldRevisionsContinue {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsListHeldRevisionsContinue) {
            DBTEAMLegalHoldsListHeldRevisionsContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLegalHoldsListPolicies {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsListPolicies) {
            DBTEAMLegalHoldsListPolicies = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLegalHoldsReleasePolicy {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsReleasePolicy) {
            DBTEAMLegalHoldsReleasePolicy = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLegalHoldsUpdatePolicy {
    @synchronized(lockObj) {
        if (!DBTEAMLegalHoldsUpdatePolicy) {
            DBTEAMLegalHoldsUpdatePolicy = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLinkedAppsListMemberLinkedApps {
    @synchronized(lockObj) {
        if (!DBTEAMLinkedAppsListMemberLinkedApps) {
            DBTEAMLinkedAppsListMemberLinkedApps = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLinkedAppsListMembersLinkedApps {
    @synchronized(lockObj) {
        if (!DBTEAMLinkedAppsListMembersLinkedApps) {
            DBTEAMLinkedAppsListMembersLinkedApps = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLinkedAppsListTeamLinkedApps {
    @synchronized(lockObj) {
        if (!DBTEAMLinkedAppsListTeamLinkedApps) {
            DBTEAMLinkedAppsListTeamLinkedApps = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLinkedAppsRevokeLinkedApp {
    @synchronized(lockObj) {
        if (!DBTEAMLinkedAppsRevokeLinkedApp) {
            DBTEAMLinkedAppsRevokeLinkedApp = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMLinkedAppsRevokeLinkedAppBatch {
    @synchronized(lockObj) {
        if (!DBTEAMLinkedAppsRevokeLinkedAppBatch) {
            DBTEAMLinkedAppsRevokeLinkedAppBatch = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsExcludedUsersAdd {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsExcludedUsersAdd) {
            DBTEAMMemberSpaceLimitsExcludedUsersAdd = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsExcludedUsersList {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsExcludedUsersList) {
            DBTEAMMemberSpaceLimitsExcludedUsersList = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsExcludedUsersListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsExcludedUsersListContinue) {
            DBTEAMMemberSpaceLimitsExcludedUsersListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsExcludedUsersRemove {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsExcludedUsersRemove) {
            DBTEAMMemberSpaceLimitsExcludedUsersRemove = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsGetCustomQuota {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsGetCustomQuota) {
            DBTEAMMemberSpaceLimitsGetCustomQuota = [[DBRoute alloc] init:
                ...
                attrs:@{@"auth": @"team",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBTEAMCustomQuotaResultSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsRemoveCustomQuota {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsRemoveCustomQuota) {
            DBTEAMMemberSpaceLimitsRemoveCustomQuota = [[DBRoute alloc] init:
                ...
                attrs:@{@"auth": @"team",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBTEAMRemoveCustomQuotaResultSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBTEAMMemberSpaceLimitsSetCustomQuota {
    @synchronized(lockObj) {
        if (!DBTEAMMemberSpaceLimitsSetCustomQuota) {
            DBTEAMMemberSpaceLimitsSetCustomQuota = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersAdd {
    @synchronized(lockObj) {
        if (!DBTEAMMembersAdd) {
            DBTEAMMembersAdd = [[DBRoute alloc] init:
                @"members/add"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersAddV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersAddV2) {
            DBTEAMMembersAddV2 = [[DBRoute alloc] init:
                @"members/add_v2"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersAddJobStatusGet {
    @synchronized(lockObj) {
        if (!DBTEAMMembersAddJobStatusGet) {
            DBTEAMMembersAddJobStatusGet = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersAddJobStatusGetV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersAddJobStatusGetV2) {
            DBTEAMMembersAddJobStatusGetV2 = [[DBRoute alloc] init:
                @"members/add/job_status/get_v2"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersDeleteFormerMemberFiles {
    @synchronized(lockObj) {
        if (!DBTEAMMembersDeleteFormerMemberFiles) {
            DBTEAMMembersDeleteFormerMemberFiles = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersDeleteProfilePhoto {
    @synchronized(lockObj) {
        if (!DBTEAMMembersDeleteProfilePhoto) {
            DBTEAMMembersDeleteProfilePhoto = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersDeleteProfilePhotoV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersDeleteProfilePhotoV2) {
            DBTEAMMembersDeleteProfilePhotoV2 = [[DBRoute alloc] init:
                @"members/delete_profile_photo_v2"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersGetAvailableTeamMemberRoles {
    @synchronized(lockObj) {
        if (!DBTEAMMembersGetAvailableTeamMemberRoles) {
            DBTEAMMembersGetAvailableTeamMemberRoles = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersGetInfo {
    @synchronized(lockObj) {
        if (!DBTEAMMembersGetInfo) {
            DBTEAMMembersGetInfo = [[DBRoute alloc] init:
                @"members/get_info"
                namespace_:@"team"
                deprecated:@NO
                ...
                attrs:@{@"auth": @"team",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBTEAMMembersGetInfoItemSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBTEAMMembersGetInfoV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersGetInfoV2) {
            DBTEAMMembersGetInfoV2 = [[DBRoute alloc] init:
                @"members/get_info_v2"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersList {
    @synchronized(lockObj) {
        if (!DBTEAMMembersList) {
            DBTEAMMembersList = [[DBRoute alloc] init:
                @"members/list"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersListV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersListV2) {
            DBTEAMMembersListV2 = [[DBRoute alloc] init:
                @"members/list_v2"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMMembersListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMMembersListContinue) {
            DBTEAMMembersListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersListContinueV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersListContinueV2) {
            DBTEAMMembersListContinueV2 = [[DBRoute alloc] init:
                @"members/list/continue_v2"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMMembersListV2Result class]
                errorType:[DBTEAMMembersListContinueError class]
...
+ (DBRoute *)DBTEAMMembersMoveFormerMemberFiles {
    @synchronized(lockObj) {
        if (!DBTEAMMembersMoveFormerMemberFiles) {
            DBTEAMMembersMoveFormerMemberFiles = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersMoveFormerMemberFilesJobStatusCheck {
    @synchronized(lockObj) {
        if (!DBTEAMMembersMoveFormerMemberFilesJobStatusCheck) {
            DBTEAMMembersMoveFormerMemberFilesJobStatusCheck = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersRecover {
    @synchronized(lockObj) {
        if (!DBTEAMMembersRecover) {
            DBTEAMMembersRecover = [[DBRoute alloc] init:
                @"members/recover"
                namespace_:@"team"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBTEAMMembersRemove {
    @synchronized(lockObj) {
        if (!DBTEAMMembersRemove) {
            DBTEAMMembersRemove = [[DBRoute alloc] init:
                @"members/remove"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBASYNCLaunchEmptyResult class]
...
+ (DBRoute *)DBTEAMMembersRemoveJobStatusGet {
    @synchronized(lockObj) {
        if (!DBTEAMMembersRemoveJobStatusGet) {
            DBTEAMMembersRemoveJobStatusGet = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSecondaryEmailsAdd {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSecondaryEmailsAdd) {
            DBTEAMMembersSecondaryEmailsAdd = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSecondaryEmailsDelete {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSecondaryEmailsDelete) {
            DBTEAMMembersSecondaryEmailsDelete = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSecondaryEmailsResendVerificationEmails {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSecondaryEmailsResendVerificationEmails) {
            DBTEAMMembersSecondaryEmailsResendVerificationEmails = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSendWelcomeEmail {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSendWelcomeEmail) {
            DBTEAMMembersSendWelcomeEmail = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSetAdminPermissions {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSetAdminPermissions) {
            DBTEAMMembersSetAdminPermissions = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSetAdminPermissionsV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSetAdminPermissionsV2) {
            DBTEAMMembersSetAdminPermissionsV2 = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSetProfile {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSetProfile) {
            DBTEAMMembersSetProfile = [[DBRoute alloc] init:
                @"members/set_profile"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMTeamMemberInfo class]
...
+ (DBRoute *)DBTEAMMembersSetProfileV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSetProfileV2) {
            DBTEAMMembersSetProfileV2 = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSetProfilePhoto {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSetProfilePhoto) {
            DBTEAMMembersSetProfilePhoto = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMMembersSetProfilePhotoV2 {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSetProfilePhotoV2) {
            DBTEAMMembersSetProfilePhotoV2 = [[DBRoute alloc] init:
                @"members/set_profile_photo_v2"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMTeamMemberInfoV2Result class]
                errorType:[DBTEAMMembersSetProfilePhotoError class]
...
+ (DBRoute *)DBTEAMMembersSuspend {
    @synchronized(lockObj) {
        if (!DBTEAMMembersSuspend) {
            DBTEAMMembersSuspend = [[DBRoute alloc] init:
                @"members/suspend"
                namespace_:@"team"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBTEAMMembersUnsuspend {
    @synchronized(lockObj) {
        if (!DBTEAMMembersUnsuspend) {
            DBTEAMMembersUnsuspend = [[DBRoute alloc] init:
                @"members/unsuspend"
                namespace_:@"team"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBTEAMNamespacesList {
    @synchronized(lockObj) {
        if (!DBTEAMNamespacesList) {
            DBTEAMNamespacesList = [[DBRoute alloc] init:
                @"namespaces/list"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMNamespacesListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMNamespacesListContinue) {
            DBTEAMNamespacesListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMPropertiesTemplateAdd {
    @synchronized(lockObj) {
        if (!DBTEAMPropertiesTemplateAdd) {
            DBTEAMPropertiesTemplateAdd = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMPropertiesTemplateGet {
    @synchronized(lockObj) {
        if (!DBTEAMPropertiesTemplateGet) {
            DBTEAMPropertiesTemplateGet = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMReportsGetActivity {
    @synchronized(lockObj) {
        if (!DBTEAMReportsGetActivity) {
            DBTEAMReportsGetActivity = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMReportsGetDevices {
    @synchronized(lockObj) {
        if (!DBTEAMReportsGetDevices) {
            DBTEAMReportsGetDevices = [[DBRoute alloc] init:
                @"reports/get_devices"
                namespace_:@"team"
                deprecated:@YES
...
+ (DBRoute *)DBTEAMReportsGetMembership {
    @synchronized(lockObj) {
        if (!DBTEAMReportsGetMembership) {
            DBTEAMReportsGetMembership = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMReportsGetStorage {
    @synchronized(lockObj) {
        if (!DBTEAMReportsGetStorage) {
            DBTEAMReportsGetStorage = [[DBRoute alloc] init:
                @"reports/get_storage"
                namespace_:@"team"
                deprecated:@YES
...
+ (DBRoute *)DBTEAMSharingAllowlistAdd {
    @synchronized(lockObj) {
        if (!DBTEAMSharingAllowlistAdd) {
            DBTEAMSharingAllowlistAdd = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMSharingAllowlistList {
    @synchronized(lockObj) {
        if (!DBTEAMSharingAllowlistList) {
            DBTEAMSharingAllowlistList = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMSharingAllowlistListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMSharingAllowlistListContinue) {
            DBTEAMSharingAllowlistListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMSharingAllowlistRemove {
    @synchronized(lockObj) {
        if (!DBTEAMSharingAllowlistRemove) {
            DBTEAMSharingAllowlistRemove = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMTeamFolderActivate {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderActivate) {
            DBTEAMTeamFolderActivate = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMTeamFolderArchive {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderArchive) {
            DBTEAMTeamFolderArchive = [[DBRoute alloc] init:
                @"team_folder/archive"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMTeamFolderArchiveCheck {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderArchiveCheck) {
            DBTEAMTeamFolderArchiveCheck = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMTeamFolderCreate {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderCreate) {
            DBTEAMTeamFolderCreate = [[DBRoute alloc] init:
                @"team_folder/create"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMTeamFolderMetadata class]
...
+ (DBRoute *)DBTEAMTeamFolderGetInfo {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderGetInfo) {
            DBTEAMTeamFolderGetInfo = [[DBRoute alloc] init:
                ...
                attrs:@{@"auth": @"team",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBTEAMTeamFolderGetInfoItemSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBTEAMTeamFolderList {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderList) {
            DBTEAMTeamFolderList = [[DBRoute alloc] init:
                @"team_folder/list"
                namespace_:@"team"
                deprecated:@NO
...
+ (DBRoute *)DBTEAMTeamFolderListContinue {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderListContinue) {
            DBTEAMTeamFolderListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMTeamFolderPermanentlyDelete {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderPermanentlyDelete) {
            DBTEAMTeamFolderPermanentlyDelete = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMTeamFolderRename {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderRename) {
            DBTEAMTeamFolderRename = [[DBRoute alloc] init:
                @"team_folder/rename"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMTeamFolderMetadata class]
...
+ (DBRoute *)DBTEAMTeamFolderRestore {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderRestore) {
            DBTEAMTeamFolderRestore = [[DBRoute alloc] init:
                @"team_folder/restore"
                namespace_:@"team"
                deprecated:@NO
                resultType:[DBTEAMTeamFolderMetadata class]
...
+ (DBRoute *)DBTEAMTeamFolderUpdateSyncSettings {
    @synchronized(lockObj) {
        if (!DBTEAMTeamFolderUpdateSyncSettings) {
            DBTEAMTeamFolderUpdateSyncSettings = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMTokenGetAuthenticatedAdmin {
    @synchronized(lockObj) {
        if (!DBTEAMTokenGetAuthenticatedAdmin) {
            DBTEAMTokenGetAuthenticatedAdmin = [[DBRoute alloc] init:
