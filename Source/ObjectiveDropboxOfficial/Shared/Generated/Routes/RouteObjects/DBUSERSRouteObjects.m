...
+ (DBRoute *)DBUSERSFeaturesGetValues {
    @synchronized(lockObj) {
        if (!DBUSERSFeaturesGetValues) {
            DBUSERSFeaturesGetValues = [[DBRoute alloc] init:
                @"features/get_values"
                namespace_:@"users"
                deprecated:@NO
...
+ (DBRoute *)DBUSERSGetAccount {
    @synchronized(lockObj) {
        if (!DBUSERSGetAccount) {
            DBUSERSGetAccount = [[DBRoute alloc] init:
                @"get_account"
                namespace_:@"users"
                deprecated:@NO
...
+ (DBRoute *)DBUSERSGetAccountBatch {
    @synchronized(lockObj) {
        if (!DBUSERSGetAccountBatch) {
            DBUSERSGetAccountBatch = [[DBRoute alloc] init:
                @"get_account_batch"
                namespace_:@"users"
                deprecated:@NO
                ...
                attrs:@{@"auth": @"user",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBUSERSBasicAccountSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBUSERSGetCurrentAccount {
    @synchronized(lockObj) {
        if (!DBUSERSGetCurrentAccount) {
            DBUSERSGetCurrentAccount = [[DBRoute alloc] init:
                @"get_current_account"
                namespace_:@"users"
                deprecated:@NO
...
+ (DBRoute *)DBUSERSGetSpaceUsage {
    @synchronized(lockObj) {
        if (!DBUSERSGetSpaceUsage) {
            DBUSERSGetSpaceUsage = [[DBRoute alloc] init:
                @"get_space_usage"
                namespace_:@"users"
                deprecated:@NO
