...
+ (DBRoute *)DBSHARINGAddFileMember {
    @synchronized(lockObj) {
        if (!DBSHARINGAddFileMember) {
            DBSHARINGAddFileMember = [[DBRoute alloc] init:
                @"add_file_member"
                namespace_:@"sharing"
                deprecated:@NO
                ...
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBSHARINGFileMemberActionResultSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBSHARINGAddFolderMember {
    @synchronized(lockObj) {
        if (!DBSHARINGAddFolderMember) {
            DBSHARINGAddFolderMember = [[DBRoute alloc] init:
                @"add_folder_member"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBSHARINGCheckJobStatus {
    @synchronized(lockObj) {
        if (!DBSHARINGCheckJobStatus) {
            DBSHARINGCheckJobStatus = [[DBRoute alloc] init:
                @"check_job_status"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGCheckRemoveMemberJobStatus {
    @synchronized(lockObj) {
        if (!DBSHARINGCheckRemoveMemberJobStatus) {
            DBSHARINGCheckRemoveMemberJobStatus = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGCheckShareJobStatus {
    @synchronized(lockObj) {
        if (!DBSHARINGCheckShareJobStatus) {
            DBSHARINGCheckShareJobStatus = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGCreateSharedLink {
    @synchronized(lockObj) {
        if (!DBSHARINGCreateSharedLink) {
            DBSHARINGCreateSharedLink = [[DBRoute alloc] init:
                @"create_shared_link"
                namespace_:@"sharing"
                deprecated:@YES
...
+ (DBRoute *)DBSHARINGCreateSharedLinkWithSettings {
    @synchronized(lockObj) {
        if (!DBSHARINGCreateSharedLinkWithSettings) {
            DBSHARINGCreateSharedLinkWithSettings = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGGetFileMetadata {
    @synchronized(lockObj) {
        if (!DBSHARINGGetFileMetadata) {
            DBSHARINGGetFileMetadata = [[DBRoute alloc] init:
                @"get_file_metadata"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGGetFileMetadataBatch {
    @synchronized(lockObj) {
        if (!DBSHARINGGetFileMetadataBatch) {
            DBSHARINGGetFileMetadataBatch = [[DBRoute alloc] init:
                ...
                attrs:@{@"auth": @"user",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBSHARINGGetFileMetadataBatchResultSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBSHARINGGetFolderMetadata {
    @synchronized(lockObj) {
        if (!DBSHARINGGetFolderMetadata) {
            DBSHARINGGetFolderMetadata = [[DBRoute alloc] init:
                @"get_folder_metadata"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGGetSharedLinkFile {
    @synchronized(lockObj) {
        if (!DBSHARINGGetSharedLinkFile) {
            DBSHARINGGetSharedLinkFile = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGGetSharedLinkMetadata {
    @synchronized(lockObj) {
        if (!DBSHARINGGetSharedLinkMetadata) {
            DBSHARINGGetSharedLinkMetadata = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGGetSharedLinks {
    @synchronized(lockObj) {
        if (!DBSHARINGGetSharedLinks) {
            DBSHARINGGetSharedLinks = [[DBRoute alloc] init:
                @"get_shared_links"
                namespace_:@"sharing"
                deprecated:@YES
...
+ (DBRoute *)DBSHARINGListFileMembers {
    @synchronized(lockObj) {
        if (!DBSHARINGListFileMembers) {
            DBSHARINGListFileMembers = [[DBRoute alloc] init:
                @"list_file_members"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGListFileMembersBatch {
    @synchronized(lockObj) {
        if (!DBSHARINGListFileMembersBatch) {
            DBSHARINGListFileMembersBatch = [[DBRoute alloc] init:
                ...
                attrs:@{@"auth": @"user",
                        ...
                        @"style": @"rpc"}
                dataStructSerialBlock:nil
                dataStructDeserialBlock:^id(id dataStruct) { return [DBArraySerializer deserialize:dataStruct withBlock:^id(id elem0) { return [DBSHARINGListFileMembersBatchResultSerializer deserialize:elem0]; }]; }
            ];
        }
...
+ (DBRoute *)DBSHARINGListFileMembersContinue {
    @synchronized(lockObj) {
        if (!DBSHARINGListFileMembersContinue) {
            DBSHARINGListFileMembersContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGListFolderMembers {
    @synchronized(lockObj) {
        if (!DBSHARINGListFolderMembers) {
            DBSHARINGListFolderMembers = [[DBRoute alloc] init:
                @"list_folder_members"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGListFolderMembersContinue {
    @synchronized(lockObj) {
        if (!DBSHARINGListFolderMembersContinue) {
            DBSHARINGListFolderMembersContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGListFolders {
    @synchronized(lockObj) {
        if (!DBSHARINGListFolders) {
            DBSHARINGListFolders = [[DBRoute alloc] init:
                @"list_folders"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGListFoldersContinue {
    @synchronized(lockObj) {
        if (!DBSHARINGListFoldersContinue) {
            DBSHARINGListFoldersContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGListMountableFolders {
    @synchronized(lockObj) {
        if (!DBSHARINGListMountableFolders) {
            DBSHARINGListMountableFolders = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGListMountableFoldersContinue {
    @synchronized(lockObj) {
        if (!DBSHARINGListMountableFoldersContinue) {
            DBSHARINGListMountableFoldersContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGListReceivedFiles {
    @synchronized(lockObj) {
        if (!DBSHARINGListReceivedFiles) {
            DBSHARINGListReceivedFiles = [[DBRoute alloc] init:
                @"list_received_files"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGListReceivedFilesContinue {
    @synchronized(lockObj) {
        if (!DBSHARINGListReceivedFilesContinue) {
            DBSHARINGListReceivedFilesContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGListSharedLinks {
    @synchronized(lockObj) {
        if (!DBSHARINGListSharedLinks) {
            DBSHARINGListSharedLinks = [[DBRoute alloc] init:
                @"list_shared_links"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGModifySharedLinkSettings {
    @synchronized(lockObj) {
        if (!DBSHARINGModifySharedLinkSettings) {
            DBSHARINGModifySharedLinkSettings = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGMountFolder {
    @synchronized(lockObj) {
        if (!DBSHARINGMountFolder) {
            DBSHARINGMountFolder = [[DBRoute alloc] init:
                @"mount_folder"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:[DBSHARINGSharedFolderMetadata class]
...
+ (DBRoute *)DBSHARINGRelinquishAccess {
    @synchronized(lockObj) {
        if (!DBSHARINGRelinquishAccess) {
            DBSHARINGRelinquishAccess = [[DBRoute alloc] init:
                @"relinquish_access"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGRelinquishFileMembership {
    @synchronized(lockObj) {
        if (!DBSHARINGRelinquishFileMembership) {
            DBSHARINGRelinquishFileMembership = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGRelinquishFolderMembership {
    @synchronized(lockObj) {
        if (!DBSHARINGRelinquishFolderMembership) {
            DBSHARINGRelinquishFolderMembership = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGRemoveFileMember {
    @synchronized(lockObj) {
        if (!DBSHARINGRemoveFileMember) {
            DBSHARINGRemoveFileMember = [[DBRoute alloc] init:
                @"remove_file_member"
                namespace_:@"sharing"
                deprecated:@YES
...
+ (DBRoute *)DBSHARINGRemoveFileMember2 {
    @synchronized(lockObj) {
        if (!DBSHARINGRemoveFileMember2) {
            DBSHARINGRemoveFileMember2 = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGRemoveFolderMember {
    @synchronized(lockObj) {
        if (!DBSHARINGRemoveFolderMember) {
            DBSHARINGRemoveFolderMember = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGRevokeSharedLink {
    @synchronized(lockObj) {
        if (!DBSHARINGRevokeSharedLink) {
            DBSHARINGRevokeSharedLink = [[DBRoute alloc] init:
                @"revoke_shared_link"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBSHARINGSetAccessInheritance {
    @synchronized(lockObj) {
        if (!DBSHARINGSetAccessInheritance) {
            DBSHARINGSetAccessInheritance = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGShareFolder {
    @synchronized(lockObj) {
        if (!DBSHARINGShareFolder) {
            DBSHARINGShareFolder = [[DBRoute alloc] init:
                @"share_folder"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:[DBSHARINGShareFolderLaunch class]
...
+ (DBRoute *)DBSHARINGTransferFolder {
    @synchronized(lockObj) {
        if (!DBSHARINGTransferFolder) {
            DBSHARINGTransferFolder = [[DBRoute alloc] init:
                @"transfer_folder"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBSHARINGUnmountFolder {
    @synchronized(lockObj) {
        if (!DBSHARINGUnmountFolder) {
            DBSHARINGUnmountFolder = [[DBRoute alloc] init:
                @"unmount_folder"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBSHARINGUnshareFile {
    @synchronized(lockObj) {
        if (!DBSHARINGUnshareFile) {
            DBSHARINGUnshareFile = [[DBRoute alloc] init:
                @"unshare_file"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:nil
...
+ (DBRoute *)DBSHARINGUnshareFolder {
    @synchronized(lockObj) {
        if (!DBSHARINGUnshareFolder) {
            DBSHARINGUnshareFolder = [[DBRoute alloc] init:
                @"unshare_folder"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:[DBASYNCLaunchEmptyResult class]
...
+ (DBRoute *)DBSHARINGUpdateFileMember {
    @synchronized(lockObj) {
        if (!DBSHARINGUpdateFileMember) {
            DBSHARINGUpdateFileMember = [[DBRoute alloc] init:
                @"update_file_member"
                namespace_:@"sharing"
                deprecated:@NO
...
+ (DBRoute *)DBSHARINGUpdateFilePolicy {
    @synchronized(lockObj) {
        if (!DBSHARINGUpdateFilePolicy) {
            DBSHARINGUpdateFilePolicy = [[DBRoute alloc] init:
                @"update_file_policy"
                namespace_:@"sharing"
                deprecated:@NO
                resultType:[DBSHARINGSharedFileMetadata class]
...
+ (DBRoute *)DBSHARINGUpdateFolderMember {
    @synchronized(lockObj) {
        if (!DBSHARINGUpdateFolderMember) {
            DBSHARINGUpdateFolderMember = [[DBRoute alloc] init:
...
+ (DBRoute *)DBSHARINGUpdateFolderPolicy {
    @synchronized(lockObj) {
        if (!DBSHARINGUpdateFolderPolicy) {
            DBSHARINGUpdateFolderPolicy = [[DBRoute alloc] init:
