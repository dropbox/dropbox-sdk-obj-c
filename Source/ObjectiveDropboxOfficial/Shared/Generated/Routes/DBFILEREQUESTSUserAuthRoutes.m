...
- (DBRpcTask *)create:(NSString *)title destination:(NSString *)destination {
    ...
    DBFILEREQUESTSCreateFileRequestArgs *arg = [[DBFILEREQUESTSCreateFileRequestArgs alloc] initWithTitle:title destination:destination];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)create:(NSString *)title destination:(NSString *)destination deadline:(DBFILEREQUESTSFileRequestDeadline *)deadline open:(NSNumber *)open description_:(NSString *)description_ videoProjectId:(NSString *)videoProjectId {
    DBRoute *route = DBFILEREQUESTSRouteObjects.DBFILEREQUESTSCreate;
    DBFILEREQUESTSCreateFileRequestArgs *arg = [[DBFILEREQUESTSCreateFileRequestArgs alloc] initWithTitle:title destination:destination deadline:deadline open:open description_:description_ videoProjectId:videoProjectId];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)listContinue:(NSString *)cursor {
    ...
    DBFILEREQUESTSListFileRequestsContinueArg *arg = [[DBFILEREQUESTSListFileRequestsContinueArg alloc] initWithCursor:cursor];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)update:(NSString *)id_ title:(NSString *)title destination:(NSString *)destination deadline:(DBFILEREQUESTSUpdateFileRequestDeadline *)deadline open:(NSNumber *)open description_:(NSString *)description_ {
    DBRoute *route = DBFILEREQUESTSRouteObjects.DBFILEREQUESTSUpdate;
    DBFILEREQUESTSUpdateFileRequestArgs *arg = [[DBFILEREQUESTSUpdateFileRequestArgs alloc] initWithId_:id_ title:title destination:destination deadline:deadline open:open description_:description_];
    return [self.client requestRpc:route arg:arg];
}
