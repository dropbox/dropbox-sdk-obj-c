...
- (DBUploadTask *)docsCreateUrl:(DBPAPERImportFormat *)importFormat parentFolderId:(NSString *)parentFolderId inputUrl:(NSString *)inputUrl {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsCreate;
    DBPAPERPaperDocCreateArgs *arg = [[DBPAPERPaperDocCreateArgs alloc] initWithImportFormat:importFormat parentFolderId:parentFolderId];
    return [self.client requestUpload:route arg:arg inputUrl:inputUrl];
}
...
- (DBUploadTask *)docsCreateData:(DBPAPERImportFormat *)importFormat parentFolderId:(NSString *)parentFolderId inputData:(NSData *)inputData {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsCreate;
    DBPAPERPaperDocCreateArgs *arg = [[DBPAPERPaperDocCreateArgs alloc] initWithImportFormat:importFormat parentFolderId:parentFolderId];
    return [self.client requestUpload:route arg:arg inputData:inputData];
}
...
- (DBUploadTask *)docsCreateStream:(DBPAPERImportFormat *)importFormat parentFolderId:(NSString *)parentFolderId inputStream:(NSInputStream *)inputStream {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsCreate;
    DBPAPERPaperDocCreateArgs *arg = [[DBPAPERPaperDocCreateArgs alloc] initWithImportFormat:importFormat parentFolderId:parentFolderId];
    return [self.client requestUpload:route arg:arg inputStream:inputStream];
}

- (DBDownloadUrlTask *)docsDownloadUrl:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat overwrite:(BOOL)overwrite destination:(NSURL *)destination {
...
- (DBDownloadUrlTask *)docsDownloadUrl:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat includeComments:(NSNumber *)includeComments overwrite:(BOOL)overwrite destination:(NSURL *)destination {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsDownload;
    DBPAPERPaperDocExport *arg = [[DBPAPERPaperDocExport alloc] initWithDocId:docId exportFormat:exportFormat includeComments:includeComments];
    return [self.client requestDownload:route arg:arg overwrite:overwrite destination:destination];
}

- (DBDownloadUrlTask *)docsDownloadUrl:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat overwrite:(BOOL)overwrite destination:(NSURL *)destination byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsDownload;
    DBPAPERPaperDocExport *arg = [[DBPAPERPaperDocExport alloc] initWithDocId:docId exportFormat:exportFormat];
...
- (DBDownloadUrlTask *)docsDownloadUrl:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat includeComments:(NSNumber *)includeComments overwrite:(BOOL)overwrite destination:(NSURL *)destination byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsDownload;
    DBPAPERPaperDocExport *arg = [[DBPAPERPaperDocExport alloc] initWithDocId:docId exportFormat:exportFormat includeComments:includeComments];
    return [self.client requestDownload:route arg:arg overwrite:overwrite destination:destination byteOffsetStart:byteOffsetStart byteOffsetEnd:byteOffsetEnd];
}
...
- (DBDownloadDataTask *)docsDownloadData:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat includeComments:(NSNumber *)includeComments {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsDownload;
    DBPAPERPaperDocExport *arg = [[DBPAPERPaperDocExport alloc] initWithDocId:docId exportFormat:exportFormat includeComments:includeComments];
    return [self.client requestDownload:route arg:arg];
}

- (DBDownloadDataTask *)docsDownloadData:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsDownload;
    DBPAPERPaperDocExport *arg = [[DBPAPERPaperDocExport alloc] initWithDocId:docId exportFormat:exportFormat];
    return [self.client requestDownload:route arg:arg byteOffsetStart:byteOffsetStart byteOffsetEnd:byteOffsetEnd];
}

- (DBDownloadDataTask *)docsDownloadData:(NSString *)docId exportFormat:(DBPAPERExportFormat *)exportFormat includeComments:(NSNumber *)includeComments byteOffsetStart:(NSNumber *)byteOffsetStart byteOffsetEnd:(NSNumber *)byteOffsetEnd {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsDownload;
    DBPAPERPaperDocExport *arg = [[DBPAPERPaperDocExport alloc] initWithDocId:docId exportFormat:exportFormat includeComments:includeComments];
    return [self.client requestDownload:route arg:arg byteOffsetStart:byteOffsetStart byteOffsetEnd:byteOffsetEnd];
}
...
- (DBRpcTask *)docsFolderUsersListContinue:(NSString *)docId cursor:(NSString *)cursor {
    ...
    DBPAPERListUsersOnFolderContinueArgs *arg = [[DBPAPERListUsersOnFolderContinueArgs alloc] initWithDocId:docId cursor:cursor];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)docsList:(DBPAPERListPaperDocsFilterBy *)filterBy sortBy:(DBPAPERListPaperDocsSortBy *)sortBy sortOrder:(DBPAPERListPaperDocsSortOrder *)sortOrder limit:(NSNumber *)limit stopAtDate:(NSDate *)stopAtDate {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsList;
    DBPAPERListPaperDocsArgs *arg = [[DBPAPERListPaperDocsArgs alloc] initWithFilterBy:filterBy sortBy:sortBy sortOrder:sortOrder limit:limit stopAtDate:stopAtDate];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)docsSharingPolicySet:(NSString *)docId sharingPolicy:(DBPAPERSharingPolicy *)sharingPolicy {
    ...
    DBPAPERPaperDocSharingPolicy *arg = [[DBPAPERPaperDocSharingPolicy alloc] initWithDocId:docId sharingPolicy:sharingPolicy];
    return [self.client requestRpc:route arg:arg];
}

- (DBUploadTask *)docsUpdateUrl:(NSString *)docId docUpdatePolicy:(DBPAPERPaperDocUpdatePolicy *)docUpdatePolicy revision:(NSNumber *)revision importFormat:(DBPAPERImportFormat *)importFormat inputUrl:(NSString *)inputUrl {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsUpdate;
    DBPAPERPaperDocUpdateArgs *arg = [[DBPAPERPaperDocUpdateArgs alloc] initWithDocId:docId docUpdatePolicy:docUpdatePolicy revision:revision importFormat:importFormat];
    return [self.client requestUpload:route arg:arg inputUrl:inputUrl];
}

- (DBUploadTask *)docsUpdateData:(NSString *)docId docUpdatePolicy:(DBPAPERPaperDocUpdatePolicy *)docUpdatePolicy revision:(NSNumber *)revision importFormat:(DBPAPERImportFormat *)importFormat inputData:(NSData *)inputData {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsUpdate;
    DBPAPERPaperDocUpdateArgs *arg = [[DBPAPERPaperDocUpdateArgs alloc] initWithDocId:docId docUpdatePolicy:docUpdatePolicy revision:revision importFormat:importFormat];
    return [self.client requestUpload:route arg:arg inputData:inputData];
}

- (DBUploadTask *)docsUpdateStream:(NSString *)docId docUpdatePolicy:(DBPAPERPaperDocUpdatePolicy *)docUpdatePolicy revision:(NSNumber *)revision importFormat:(DBPAPERImportFormat *)importFormat inputStream:(NSInputStream *)inputStream {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsUpdate;
    DBPAPERPaperDocUpdateArgs *arg = [[DBPAPERPaperDocUpdateArgs alloc] initWithDocId:docId docUpdatePolicy:docUpdatePolicy revision:revision importFormat:importFormat];
    return [self.client requestUpload:route arg:arg inputStream:inputStream];
}
...
- (DBRpcTask *)docsUsersAdd:(NSString *)docId members:(NSArray<DBPAPERAddMember *> *)members customMessage:(NSString *)customMessage quiet:(NSNumber *)quiet {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsUsersAdd;
    DBPAPERAddPaperDocUser *arg = [[DBPAPERAddPaperDocUser alloc] initWithDocId:docId members:members customMessage:customMessage quiet:quiet];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)docsUsersList:(NSString *)docId limit:(NSNumber *)limit filterBy:(DBPAPERUserOnPaperDocFilter *)filterBy {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERDocsUsersList;
    DBPAPERListUsersOnPaperDocArgs *arg = [[DBPAPERListUsersOnPaperDocArgs alloc] initWithDocId:docId limit:limit filterBy:filterBy];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)docsUsersListContinue:(NSString *)docId cursor:(NSString *)cursor {
    ...
    DBPAPERListUsersOnPaperDocContinueArgs *arg = [[DBPAPERListUsersOnPaperDocContinueArgs alloc] initWithDocId:docId cursor:cursor];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)foldersCreate:(NSString *)name parentFolderId:(NSString *)parentFolderId isTeamFolder:(NSNumber *)isTeamFolder {
    DBRoute *route = DBPAPERRouteObjects.DBPAPERFoldersCreate;
    DBPAPERPaperFolderCreateArg *arg = [[DBPAPERPaperFolderCreateArg alloc] initWithName:name parentFolderId:parentFolderId isTeamFolder:isTeamFolder];
    return [self.client requestRpc:route arg:arg];
}
