...
/// 
- (DBRpcTask<DBNilObject *, DBFILEPROPERTIESAddPropertiesError *> *)propertiesAdd:(NSString *)path propertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroup *> *)propertyGroups;
...
/// 
- (DBRpcTask<DBNilObject *, DBFILEPROPERTIESInvalidPropertyGroupError *> *)propertiesOverwrite:(NSString *)path propertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroup *> *)propertyGroups;
...
/// 
- (DBRpcTask<DBNilObject *, DBFILEPROPERTIESRemovePropertiesError *> *)propertiesRemove:(NSString *)path propertyTemplateIds:(NSArray<NSString *> *)propertyTemplateIds;
...
/// 
- (DBRpcTask<DBFILEPROPERTIESPropertiesSearchResult *, DBFILEPROPERTIESPropertiesSearchError *> *)propertiesSearch:(NSArray<DBFILEPROPERTIESPropertiesSearchQuery *> *)queries;
...
/// success or a `DBFILEPROPERTIESPropertiesSearchError` object on failure.
/// 
- (DBRpcTask<DBFILEPROPERTIESPropertiesSearchResult *, DBFILEPROPERTIESPropertiesSearchError *> *)propertiesSearch:(NSArray<DBFILEPROPERTIESPropertiesSearchQuery *> *)queries templateFilter:(nullable DBFILEPROPERTIESTemplateFilter *)templateFilter;
...
/// 
- (DBRpcTask<DBFILEPROPERTIESPropertiesSearchResult *, DBFILEPROPERTIESPropertiesSearchContinueError *> *)propertiesSearchContinue:(NSString *)cursor;
...
/// 
- (DBRpcTask<DBNilObject *, DBFILEPROPERTIESUpdatePropertiesError *> *)propertiesUpdate:(NSString *)path updatePropertyGroups:(NSArray<DBFILEPROPERTIESPropertyGroupUpdate *> *)updatePropertyGroups;
...
/// 
- (DBRpcTask<DBFILEPROPERTIESAddTemplateResult *, DBFILEPROPERTIESModifyTemplateError *> *)templatesAddForUser:(NSString *)name description_:(NSString *)description_ fields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)fields;
...
/// 
- (DBRpcTask<DBFILEPROPERTIESGetTemplateResult *, DBFILEPROPERTIESTemplateError *> *)templatesGetForUser:(NSString *)templateId;
...
/// success or a `DBFILEPROPERTIESModifyTemplateError` object on failure.
/// 
- (DBRpcTask<DBFILEPROPERTIESUpdateTemplateResult *, DBFILEPROPERTIESModifyTemplateError *> *)templatesUpdateForUser:(NSString *)templateId;
...
/// success or a `DBFILEPROPERTIESModifyTemplateError` object on failure.
/// 
- (DBRpcTask<DBFILEPROPERTIESUpdateTemplateResult *, DBFILEPROPERTIESModifyTemplateError *> *)templatesUpdateForUser:(NSString *)templateId name:(nullable NSString *)name description_:(nullable NSString *)description_ addFields:(nullable NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)addFields;
