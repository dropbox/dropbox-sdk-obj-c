...
- (DBRpcTask *)propertiesRemove:(NSString *)path propertyTemplateIds:(NSArray<NSString *> *)propertyTemplateIds {
    ...
    DBFILEPROPERTIESRemovePropertiesArg *arg = [[DBFILEPROPERTIESRemovePropertiesArg alloc] initWithPath:path propertyTemplateIds:propertyTemplateIds];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)propertiesSearch:(NSArray<DBFILEPROPERTIESPropertiesSearchQuery *> *)queries templateFilter:(DBFILEPROPERTIESTemplateFilter *)templateFilter {
    DBRoute *route = DBFILEPROPERTIESRouteObjects.DBFILEPROPERTIESPropertiesSearch;
    DBFILEPROPERTIESPropertiesSearchArg *arg = [[DBFILEPROPERTIESPropertiesSearchArg alloc] initWithQueries:queries templateFilter:templateFilter];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)propertiesSearchContinue:(NSString *)cursor {
    ...
    DBFILEPROPERTIESPropertiesSearchContinueArg *arg = [[DBFILEPROPERTIESPropertiesSearchContinueArg alloc] initWithCursor:cursor];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)templatesAddForUser:(NSString *)name description_:(NSString *)description_ fields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)fields {
...
- (DBRpcTask *)templatesUpdateForUser:(NSString *)templateId name:(NSString *)name description_:(NSString *)description_ addFields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)addFields {
    DBRoute *route = DBFILEPROPERTIESRouteObjects.DBFILEPROPERTIESTemplatesUpdateForUser;
    DBFILEPROPERTIESUpdateTemplateArg *arg = [[DBFILEPROPERTIESUpdateTemplateArg alloc] initWithTemplateId:templateId name:name description_:description_ addFields:addFields];
    return [self.client requestRpc:route arg:arg];
}
