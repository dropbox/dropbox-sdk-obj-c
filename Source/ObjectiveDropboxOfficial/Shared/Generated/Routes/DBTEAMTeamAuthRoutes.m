...
- (DBRpcTask *)groupsCreate:(NSString *)groupName addCreatorAsOwner:(NSNumber *)addCreatorAsOwner groupExternalId:(NSString *)groupExternalId groupManagementType:(DBTEAMCOMMONGroupManagementType *)groupManagementType {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMGroupsCreate;
    DBTEAMGroupCreateArg *arg = [[DBTEAMGroupCreateArg alloc] initWithGroupName:groupName addCreatorAsOwner:addCreatorAsOwner groupExternalId:groupExternalId groupManagementType:groupManagementType];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)legalHoldsCreatePolicy:(NSString *)name members:(NSArray<NSString *> *)members description_:(NSString *)description_ startDate:(NSDate *)startDate endDate:(NSDate *)endDate {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMLegalHoldsCreatePolicy;
    DBTEAMLegalHoldsPolicyCreateArg *arg = [[DBTEAMLegalHoldsPolicyCreateArg alloc] initWithName:name members:members description_:description_ startDate:startDate endDate:endDate];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)legalHoldsListHeldRevisionsContinue:(NSString *)id_ {
    ...
    DBTEAMLegalHoldsListHeldRevisionsContinueArg *arg = [[DBTEAMLegalHoldsListHeldRevisionsContinueArg alloc] initWithId_:id_];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)legalHoldsListHeldRevisionsContinue:(NSString *)id_ cursor:(NSString *)cursor {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMLegalHoldsListHeldRevisionsContinue;
    DBTEAMLegalHoldsListHeldRevisionsContinueArg *arg = [[DBTEAMLegalHoldsListHeldRevisionsContinueArg alloc] initWithId_:id_ cursor:cursor];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)legalHoldsListPolicies:(NSNumber *)includeReleased {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMLegalHoldsListPolicies;
    DBTEAMLegalHoldsListPoliciesArg *arg = [[DBTEAMLegalHoldsListPoliciesArg alloc] initWithIncludeReleased:includeReleased];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)legalHoldsUpdatePolicy:(NSString *)id_ name:(NSString *)name description_:(NSString *)description_ members:(NSArray<NSString *> *)members {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMLegalHoldsUpdatePolicy;
    DBTEAMLegalHoldsPolicyUpdateArg *arg = [[DBTEAMLegalHoldsPolicyUpdateArg alloc] initWithId_:id_ name:name description_:description_ members:members];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersDeleteFormerMemberFiles:(DBTEAMUserSelectorArg *)user {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMMembersDeleteFormerMemberFiles;
    DBTEAMMembersFormerMemberArg *arg = [[DBTEAMMembersFormerMemberArg alloc] initWithUser:user];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersMoveFormerMemberFiles:(DBTEAMUserSelectorArg *)user transferDestId:(DBTEAMUserSelectorArg *)transferDestId transferAdminId:(DBTEAMUserSelectorArg *)transferAdminId {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMMembersMoveFormerMemberFiles;
    DBTEAMMembersDataTransferArg *arg = [[DBTEAMMembersDataTransferArg alloc] initWithUser:user transferDestId:transferDestId transferAdminId:transferAdminId];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersSecondaryEmailsAdd:(NSArray<DBTEAMUserSecondaryEmailsArg *> *)dNewSecondaryEmails {
    ...
    DBTEAMAddSecondaryEmailsArg *arg = [[DBTEAMAddSecondaryEmailsArg alloc] initWithDNewSecondaryEmails:dNewSecondaryEmails];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersSecondaryEmailsResendVerificationEmails:(NSArray<DBTEAMUserSecondaryEmailsArg *> *)emailsToResend {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMMembersSecondaryEmailsResendVerificationEmails;
    DBTEAMResendVerificationEmailArg *arg = [[DBTEAMResendVerificationEmailArg alloc] initWithEmailsToResend:emailsToResend];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersSetAdminPermissionsV2:(DBTEAMUserSelectorArg *)user dNewRoles:(NSArray<NSString *> *)dNewRoles {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMMembersSetAdminPermissionsV2;
    DBTEAMMembersSetPermissions2Arg *arg = [[DBTEAMMembersSetPermissions2Arg alloc] initWithUser:user dNewRoles:dNewRoles];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersSetProfile:(DBTEAMUserSelectorArg *)user dNewEmail:(NSString *)dNewEmail dNewExternalId:(NSString *)dNewExternalId dNewGivenName:(NSString *)dNewGivenName dNewSurname:(NSString *)dNewSurname dNewPersistentId:(NSString *)dNewPersistentId dNewIsDirectoryRestricted:(NSNumber *)dNewIsDirectoryRestricted {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMMembersSetProfile;
    DBTEAMMembersSetProfileArg *arg = [[DBTEAMMembersSetProfileArg alloc] initWithUser:user dNewEmail:dNewEmail dNewExternalId:dNewExternalId dNewGivenName:dNewGivenName dNewSurname:dNewSurname dNewPersistentId:dNewPersistentId dNewIsDirectoryRestricted:dNewIsDirectoryRestricted];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)membersSetProfileV2:(DBTEAMUserSelectorArg *)user dNewEmail:(NSString *)dNewEmail dNewExternalId:(NSString *)dNewExternalId dNewGivenName:(NSString *)dNewGivenName dNewSurname:(NSString *)dNewSurname dNewPersistentId:(NSString *)dNewPersistentId dNewIsDirectoryRestricted:(NSNumber *)dNewIsDirectoryRestricted {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMMembersSetProfileV2;
    DBTEAMMembersSetProfileArg *arg = [[DBTEAMMembersSetProfileArg alloc] initWithUser:user dNewEmail:dNewEmail dNewExternalId:dNewExternalId dNewGivenName:dNewGivenName dNewSurname:dNewSurname dNewPersistentId:dNewPersistentId dNewIsDirectoryRestricted:dNewIsDirectoryRestricted];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)propertiesTemplateAdd:(NSString *)name description_:(NSString *)description_ fields:(NSArray<DBFILEPROPERTIESPropertyFieldTemplate *> *)fields {
...
- (DBRpcTask *)sharingAllowlistRemove:(NSArray<NSString *> *)domains emails:(NSArray<NSString *> *)emails {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMSharingAllowlistRemove;
    DBTEAMSharingAllowlistRemoveArgs *arg = [[DBTEAMSharingAllowlistRemoveArgs alloc] initWithDomains:domains emails:emails];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)teamFolderArchive:(NSString *)teamFolderId forceAsyncOff:(NSNumber *)forceAsyncOff {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMTeamFolderArchive;
    DBTEAMTeamFolderArchiveArg *arg = [[DBTEAMTeamFolderArchiveArg alloc] initWithTeamFolderId:teamFolderId forceAsyncOff:forceAsyncOff];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)teamFolderRestore:(NSString *)teamFolderId {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMTeamFolderRestore;
    DBTEAMTeamFolderIdArg *arg = [[DBTEAMTeamFolderIdArg alloc] initWithTeamFolderId:teamFolderId];
    return [self.client requestRpc:route arg:arg];
}
...
- (DBRpcTask *)teamFolderUpdateSyncSettings:(NSString *)teamFolderId {
    ...
    DBTEAMTeamFolderUpdateSyncSettingsArg *arg = [[DBTEAMTeamFolderUpdateSyncSettingsArg alloc] initWithTeamFolderId:teamFolderId];
    return [self.client requestRpc:route arg:arg];
}

- (DBRpcTask *)teamFolderUpdateSyncSettings:(NSString *)teamFolderId syncSetting:(DBFILESSyncSettingArg *)syncSetting contentSyncSettings:(NSArray<DBFILESContentSyncSettingArg *> *)contentSyncSettings {
    DBRoute *route = DBTEAMRouteObjects.DBTEAMTeamFolderUpdateSyncSettings;
    DBTEAMTeamFolderUpdateSyncSettingsArg *arg = [[DBTEAMTeamFolderUpdateSyncSettingsArg alloc] initWithTeamFolderId:teamFolderId syncSetting:syncSetting contentSyncSettings:contentSyncSettings];
    return [self.client requestRpc:route arg:arg];
}
