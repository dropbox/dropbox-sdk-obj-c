...
NSString *const kSDKForegroundSessionId = @"com.dropbox.dropbox_sdk_obj_c_foreground";
NSString *const kSDKBackgroundSessionId = @"com.dropbox.dropbox_sdk_obj_c_background";
