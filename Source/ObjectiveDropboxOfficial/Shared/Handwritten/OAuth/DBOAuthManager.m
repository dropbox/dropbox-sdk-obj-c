...
@property (nonatomic, strong, readwrite) DBTokenAccessType tokenAccessType;
@end
...
- (instancetype)initWithAppKey:(NSString *)appKey host:(NSString *)host redirectURL:(NSString *)redirectURL {
    return [self initWithAppKey:appKey host:host redirectURL:redirectURL tokenAccessType:nil]
}

- (instancetype)initWithAppKey:(NSString *)appKey
                          host:(NSString *)host
                   redirectURL:(NSString *)redirectURL
               tokenAccessType:(DBTokenAccessType)tokenAccessType {
    self = [super init];
    if (self) {
        if (host == nil) {
            host =
            !kDBSDKDebug ? @"www.dropbox.com" : [NSString stringWithFormat:@"meta-%@.dev.corp.dropbox.com", kDBSDKDebugHost];
        }
        ...
        self.tokenAccessType = tokenAccessType;
    }
    return self;
}
