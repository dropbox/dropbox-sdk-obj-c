...
typedef void (^DBRpcResponseBlock)(TResponse _Nullable result, TError _Nullable routeError, DBRequestError * _Nullable error);
...
typedef void (^DBUploadResponseBlock)(TResponse _Nullable result, TError _Nullable routeError, DBRequestError * _Nullable error);
...
typedef void (^DBDownloadDataTaskResponseBlock)(TResponse _Nullable result, TError _Nullable routeError, DBRequestError * _Nullable error, NSData * _Nullable fileData);
