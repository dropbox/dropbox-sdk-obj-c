...
+ (void)setupWithAppKey:(NSString *)appKey sharedOAuthManager:(DBOAuthManager *)sharedOAuthManager transportClient:(DBTransportClient *)transportClient {
    NSAssert([DBOAuthManager sharedOAuthManager] == nil, @"Only call `DropboxManager.setupWithAppKey` or `DropboxManager.setupWithTeamAppKey` once");
...
+ (void)setupWithTeamAppKey:(NSString *)appKey sharedOAuthManager:(DBOAuthManager *)sharedOAuthManager transportClient:(DBTransportClient *)transportClient {
    NSAssert([DBOAuthManager sharedOAuthManager] == nil, @"Only call `DropboxManager.setupWithAppKey` or `DropboxManager.setupWithTeamAppKey` once");
    [DBOAuthManager sharedOAuthManager:sharedOAuthManager];
...
+ (DBOAuthResult *)handleRedirectURLTeam:(NSURL *)url {
    NSAssert([DBOAuthManager sharedOAuthManager] != nil, @"Call `Dropbox.setupWithTeamAppKey` before calling this method");
    NSAssert([DropboxClientsManager authorizedClient] == nil, @"Dropbox user client is already authorized");
