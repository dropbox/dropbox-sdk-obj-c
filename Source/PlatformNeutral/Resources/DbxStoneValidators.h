...
/// Validator for `NSArray` objects. Enforces minimum number of items and/or maximum minimum number of items. Method requires a
/// validator block that can validate each item in the array.
