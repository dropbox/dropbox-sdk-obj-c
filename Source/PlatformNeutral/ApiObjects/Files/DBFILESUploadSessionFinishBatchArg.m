...
+ (NSDictionary *)serialize:(DBFILESUploadSessionFinishBatchArg *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem) { return [DBFILESUploadSessionFinishArgSerializer serialize:elem]; }];

    return jsonDict;
}

+ (DBFILESUploadSessionFinishBatchArg *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBFILESUploadSessionFinishArg *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem) { return [DBFILESUploadSessionFinishArgSerializer deserialize:elem]; }];
