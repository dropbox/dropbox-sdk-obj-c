...
/// 
/// Full constructor for the DBFILESSearchResult struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithMatches:(NSArray<DBFILESSearchMatch *> * _Nonnull)matches more:(NSNumber * _Nonnull)more start:(NSNumber * _Nonnull)start;
