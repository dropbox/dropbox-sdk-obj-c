...
/// copy).txt" or "document (Panda's conflicted copy).txt". Ensure the isUpdate
...
/// 
/// @return An initialized DBFILESWriteMode instance.
/// 
...
/// 
/// @return A json-compatible dictionary representation of the DBFILESWriteMode
/// API object.
/// 
