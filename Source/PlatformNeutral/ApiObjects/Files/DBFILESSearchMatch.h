...
/// 
/// Full constructor for the DBFILESSearchMatch struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithMatchType:(DBFILESSearchMatchType * _Nonnull)matchType metadata:(DBFILESMetadata * _Nonnull)metadata;
