...
/// 
/// Full constructor for the DBFILESSearchArg struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path query:(NSString * _Nonnull)query start:(NSNumber * _Nullable)start maxResults:(NSNumber * _Nullable)maxResults mode:(DBFILESSearchMode * _Nullable)mode;

/// 
/// Convenience constructor for the DBFILESSearchArg struct (exposes only
...
/// 
/// @return A json-compatible dictionary representation of the DBFILESSearchArg
/// API object.
/// 
