...
/// The DBFILESSaveUrlJobStatusTag enum type represents the possible tag states
/// with which the DBFILESSaveUrlJobStatus union can exist.
...
/// 
/// @return An initialized DBFILESSaveUrlJobStatus instance.
/// 
