...
/// The DBFILESSearchErrorTag enum type represents the possible tag states with
/// which the DBFILESSearchError union can exist.
...
/// 
/// @return An initialized DBFILESSearchError instance.
/// 
