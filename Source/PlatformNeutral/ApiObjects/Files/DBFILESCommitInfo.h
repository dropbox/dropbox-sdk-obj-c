...
/// 
/// Full constructor for the DBFILESCommitInfo struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path mode:(DBFILESWriteMode * _Nullable)mode autorename:(NSNumber * _Nullable)autorename clientModified:(NSDate * _Nullable)clientModified mute:(NSNumber * _Nullable)mute;

/// 
/// Convenience constructor for the DBFILESCommitInfo struct (exposes only
...
/// 
/// @return A json-compatible dictionary representation of the DBFILESCommitInfo
/// API object.
/// 
