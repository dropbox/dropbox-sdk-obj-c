...
/// 
/// Full constructor for the DBFILESListFolderLongpollArg struct (exposes all
/// instance variables).
/// 
/// @param cursor A cursor as returned by :route:`list_folder` or
...
/// 
/// Convenience constructor for the DBFILESListFolderLongpollArg struct (exposes
