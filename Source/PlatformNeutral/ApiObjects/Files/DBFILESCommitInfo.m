...
- (instancetype)initWithPath:(NSString *)path mode:(DBFILESWriteMode *)mode autorename:(NSNumber *)autorename clientModified:(NSDate *)clientModified mute:(NSNumber *)mute {
...
+ (DBFILESCommitInfo *)deserialize:(NSDictionary *)valueDict {
    ...
    return [[DBFILESCommitInfo alloc] initWithPath:path mode:mode autorename:autorename clientModified:clientModified mute:mute];
}
