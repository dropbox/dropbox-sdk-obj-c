...
/// 
/// Full constructor for the DBFILESPreviewArg struct (exposes all instance
/// variables).
/// 
...
/// 
/// Convenience constructor for the DBFILESPreviewArg struct (exposes only
...
/// 
/// @return A json-compatible dictionary representation of the DBFILESPreviewArg
/// API object.
/// 
