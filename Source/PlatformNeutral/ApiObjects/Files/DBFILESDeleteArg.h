...
/// 
/// Full constructor for the DBFILESDeleteArg struct (exposes all instance
/// variables).
/// 
/// @param path Path in the user's Dropbox to delete.
/// 
/// @return An initialized DBFILESDeleteArg instance.
/// 
...
/// 
/// @return A json-compatible dictionary representation of the DBFILESDeleteArg
/// API object.
/// 
