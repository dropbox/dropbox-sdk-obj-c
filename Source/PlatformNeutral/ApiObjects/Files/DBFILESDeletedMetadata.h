...
///
/// Full constructor for the DBFILESDeletedMetadata struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBFILESDeletedMetadata struct (exposes only non-nullable
