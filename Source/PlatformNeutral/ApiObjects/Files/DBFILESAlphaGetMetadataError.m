...
+ (NSDictionary *)serialize:(DBFILESAlphaGetMetadataError *)valueObj {
    ...
    if ([valueObj isPath]) {
        ...
        jsonDict = [[DBFILESLookUpPropertiesErrorSerializer serialize:valueObj.propertiesError] mutableCopy];
...
+ (DBFILESAlphaGetMetadataError *)deserialize:(NSDictionary *)valueDict {
    ...
    if ([tag isEqualToString:@"path"]) {
        ...
        DBFILESLookUpPropertiesError *propertiesError = [DBFILESLookUpPropertiesErrorSerializer deserialize:valueDict[@"properties_error"]];
