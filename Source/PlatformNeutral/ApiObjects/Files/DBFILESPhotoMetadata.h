...
///
/// Full constructor for the DBFILESPhotoMetadata struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBFILESPhotoMetadata struct (exposes only non-nullable instance
...
///
/// @param dict A json-compatible dictionary representation of the DBFILESPhotoMetadata API object.
///
