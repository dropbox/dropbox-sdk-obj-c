...
/// 
/// Full constructor for the DBFILESFileMetadata struct (exposes all instance
/// variables).
/// 
...
/// to the casing of paths won't be returned by :route:`list_folder/continue`.
...
/// 
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name id_:(NSString * _Nonnull)id_ clientModified:(NSDate * _Nonnull)clientModified serverModified:(NSDate * _Nonnull)serverModified rev:(NSString * _Nonnull)rev size:(NSNumber * _Nonnull)size pathLower:(NSString * _Nullable)pathLower pathDisplay:(NSString * _Nullable)pathDisplay parentSharedFolderId:(NSString * _Nullable)parentSharedFolderId mediaInfo:(DBFILESMediaInfo * _Nullable)mediaInfo sharingInfo:(DBFILESFileSharingInfo * _Nullable)sharingInfo propertyGroups:(NSArray<DBPROPERTIESPropertyGroup *> * _Nullable)propertyGroups hasExplicitSharedMembers:(NSNumber * _Nullable)hasExplicitSharedMembers;

/// 
/// Convenience constructor for the DBFILESFileMetadata struct (exposes only
