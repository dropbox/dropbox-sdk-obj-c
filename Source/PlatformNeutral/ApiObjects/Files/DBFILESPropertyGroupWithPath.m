...
+ (DBFILESPropertyGroupWithPath *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBPROPERTIESPropertyGroup *> *propertyGroups = [DBArraySerializer deserialize:valueDict[@"property_groups"] withBlock:^id(id elem) { return [DBPROPERTIESPropertyGroupSerializer deserialize:elem]; }];
