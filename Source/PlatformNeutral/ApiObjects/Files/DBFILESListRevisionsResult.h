...
/// 
/// Full constructor for the DBFILESListRevisionsResult struct (exposes all
/// instance variables).
/// 
...
/// show up here.
/// 
/// @return An initialized DBFILESListRevisionsResult instance.
/// 
- (nonnull instancetype)initWithIsDeleted:(NSNumber * _Nonnull)isDeleted entries:(NSArray<DBFILESFileMetadata *> * _Nonnull)entries;
