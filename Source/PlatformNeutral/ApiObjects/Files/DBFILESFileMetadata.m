...
- (instancetype)initWithName:(NSString *)name id_:(NSString *)id_ clientModified:(NSDate *)clientModified serverModified:(NSDate *)serverModified rev:(NSString *)rev size:(NSNumber *)size pathLower:(NSString *)pathLower pathDisplay:(NSString *)pathDisplay parentSharedFolderId:(NSString *)parentSharedFolderId mediaInfo:(DBFILESMediaInfo *)mediaInfo sharingInfo:(DBFILESFileSharingInfo *)sharingInfo propertyGroups:(NSArray<DBPROPERTIESPropertyGroup *> *)propertyGroups hasExplicitSharedMembers:(NSNumber *)hasExplicitSharedMembers {
    ...
    [DBStoneValidators nullableValidator:[DBStoneValidators arrayValidator:nil maxItems:nil itemValidator:nil]](propertyGroups);
...
+ (NSDictionary *)serialize:(DBFILESFileMetadata *)valueObj {
    ...
    if (valueObj.propertyGroups) {
        jsonDict[@"property_groups"] = [DBArraySerializer serialize:valueObj.propertyGroups withBlock:^id(id elem) { return [DBPROPERTIESPropertyGroupSerializer serialize:elem]; }];
    }
...
+ (DBFILESFileMetadata *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBPROPERTIESPropertyGroup *> *propertyGroups = valueDict[@"property_groups"] ? [DBArraySerializer deserialize:valueDict[@"property_groups"] withBlock:^id(id elem) { return [DBPROPERTIESPropertyGroupSerializer deserialize:elem]; }] : nil;
