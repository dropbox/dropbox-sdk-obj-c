...
/// 
/// Full constructor for the DBFILESAlphaGetMetadataArg struct (exposes all
/// instance variables).
/// 
/// @param path The path of a file or folder on Dropbox.
/// @param includeMediaInfo If true, :field:`FileMetadata.media_info` is set for
/// photo and video.
/// @param includeDeleted If true, :type:`DeletedMetadata` will be returned for
...
/// members.
/// @param includePropertyTemplates If true,
/// :field:`FileMetadata.property_groups` is set for files with custom
/// properties.
/// 
/// @return An initialized DBFILESAlphaGetMetadataArg instance.
/// 
...
/// 
/// Convenience constructor for the DBFILESAlphaGetMetadataArg struct (exposes
