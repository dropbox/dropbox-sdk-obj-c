...
///
/// Full constructor for the DBFILESAlphaGetMetadataArg struct (exposes all instance variables).
///
...
/// @param includePropertyTemplates If true, :field:`FileMetadata.property_groups` is set for files
...
///
/// Convenience constructor for the DBFILESAlphaGetMetadataArg struct (exposes only non-nullable
