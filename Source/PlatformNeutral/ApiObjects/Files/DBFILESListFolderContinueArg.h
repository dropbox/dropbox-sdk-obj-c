...
/// 
/// Full constructor for the DBFILESListFolderContinueArg struct (exposes all
/// instance variables).
/// 
/// @param cursor The cursor returned by your last call to :route:`list_folder`
/// or :route:`list_folder/continue`.
/// 
/// @return An initialized DBFILESListFolderContinueArg instance.
/// 
