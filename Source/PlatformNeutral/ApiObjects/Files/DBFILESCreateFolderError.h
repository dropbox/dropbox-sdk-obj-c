...
/// The DBFILESCreateFolderErrorTag enum type represents the possible tag states
/// with which the DBFILESCreateFolderError union can exist.
...
/// 
/// @return An initialized DBFILESCreateFolderError instance.
/// 
