...
/// The DBFILESRestoreErrorTag enum type represents the possible tag states with
/// which the DBFILESRestoreError union can exist.
...
/// An error occurs when downloading metadata for the file. Ensure the
...
/// An error occurs when trying to restore the file to that path. Ensure the
/// isPathWrite method returns true before accessing, otherwise a runtime
/// exception will be raised.
