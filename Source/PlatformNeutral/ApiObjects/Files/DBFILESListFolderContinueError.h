...
/// The DBFILESListFolderContinueErrorTag enum type represents the possible tag
/// states with which the DBFILESListFolderContinueError union can exist.
...
/// 
/// @return An initialized DBFILESListFolderContinueError instance.
/// 
