...
+ (NSDictionary *)serialize:(DBFILESListFolderResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem) { return [DBFILESMetadataSerializer serialize:elem]; }];
...
+ (DBFILESListFolderResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBFILESMetadata *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem) { return [DBFILESMetadataSerializer deserialize:elem]; }];
