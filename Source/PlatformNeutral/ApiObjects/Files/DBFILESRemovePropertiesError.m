...
- (NSString *)templateNotFound {
    if (![self isTemplateNotFound]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRemovePropertiesErrorTemplateNotFound, but was %@.", [self tagName]];
    }
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRemovePropertiesErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookUpPropertiesError *)propertyGroupLookup {
    if (![self isPropertyGroupLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESRemovePropertiesErrorPropertyGroupLookup, but was %@.", [self tagName]];
    }
