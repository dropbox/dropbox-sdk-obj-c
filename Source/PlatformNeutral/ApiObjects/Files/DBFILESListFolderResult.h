...
/// 
/// Full constructor for the DBFILESListFolderResult struct (exposes all
/// instance variables).
/// 
/// @param entries The files and (direct) subfolders in the folder.
/// @param cursor Pass the cursor into :route:`list_folder/continue` to see
...
/// 
/// @return An initialized DBFILESListFolderResult instance.
/// 
- (nonnull instancetype)initWithEntries:(NSArray<DBFILESMetadata *> * _Nonnull)entries cursor:(NSString * _Nonnull)cursor hasMore:(NSNumber * _Nonnull)hasMore;
