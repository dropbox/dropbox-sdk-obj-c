...
- (NSString *)templateNotFound {
    if (![self isTemplateNotFound]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUpdatePropertiesErrorTemplateNotFound, but was %@.", [self tagName]];
    }
...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUpdatePropertiesErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBFILESLookUpPropertiesError *)propertyGroupLookup {
    if (![self isPropertyGroupLookup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBFILESUpdatePropertiesErrorPropertyGroupLookup, but was %@.", [self tagName]];
    }
...
+ (NSDictionary *)serialize:(DBFILESUpdatePropertiesError *)valueObj {
    ...
    if ([valueObj isTemplateNotFound]) {
        ...
        jsonDict = [[DBFILESLookupErrorSerializer serialize:valueObj.path] mutableCopy];
        jsonDict[@".tag"] = @"path";
    }
        ...
        jsonDict = [[DBFILESLookUpPropertiesErrorSerializer serialize:valueObj.propertyGroupLookup] mutableCopy];
...
+ (DBFILESUpdatePropertiesError *)deserialize:(NSDictionary *)valueDict {
    ...
    if ([tag isEqualToString:@"template_not_found"]) {
        ...
        DBFILESLookUpPropertiesError *propertyGroupLookup = [DBFILESLookUpPropertiesErrorSerializer deserialize:valueDict[@"property_group_lookup"]];
