...
+ (NSDictionary *)serialize:(DBFILESUploadSessionFinishBatchResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem) { return [DBFILESUploadSessionFinishBatchResultEntrySerializer serialize:elem]; }];

    return jsonDict;
}

+ (DBFILESUploadSessionFinishBatchResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBFILESUploadSessionFinishBatchResultEntry *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem) { return [DBFILESUploadSessionFinishBatchResultEntrySerializer deserialize:elem]; }];
