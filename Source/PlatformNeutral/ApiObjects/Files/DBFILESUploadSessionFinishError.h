...
/// The DBFILESUploadSessionFinishErrorTag enum type represents the possible tag
/// states with which the DBFILESUploadSessionFinishError union can exist.
...
/// The session arguments are incorrect; the value explains the reason. Ensure
/// the isLookupFailed method returns true before accessing, otherwise a runtime
/// exception will be raised.
@property (nonatomic, readonly) DBFILESUploadSessionLookupError * _Nonnull lookupFailed;

/// Unable to save the uploaded contents to a file. Ensure the isPath method
