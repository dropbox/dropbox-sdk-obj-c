...
+ (NSDictionary *)serialize:(DBFILESListRevisionsResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem) { return [DBFILESFileMetadataSerializer serialize:elem]; }];
...
+ (DBFILESListRevisionsResult *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBFILESFileMetadata *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem) { return [DBFILESFileMetadataSerializer deserialize:elem]; }];
