...
/// 
/// Full constructor for the DBFILESPropertyGroupWithPath struct (exposes all
/// instance variables).
/// 
...
/// file.
/// 
/// @return An initialized DBFILESPropertyGroupWithPath instance.
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path propertyGroups:(NSArray<DBPROPERTIESPropertyGroup *> * _Nonnull)propertyGroups;
...
/// 
/// @param instance An instance of the DBFILESPropertyGroupWithPath API object.
/// 
