...
- (instancetype)initWithPath:(NSString *)path updatePropertyGroups:(NSArray<DBFILESPropertyGroupUpdate *> *)updatePropertyGroups {
...
+ (NSDictionary *)serialize:(DBFILESUpdatePropertyGroupArg *)valueObj {
    ...
    jsonDict[@"update_property_groups"] = [DBArraySerializer serialize:valueObj.updatePropertyGroups withBlock:^id(id elem) { return [DBFILESPropertyGroupUpdateSerializer serialize:elem]; }];
...
+ (DBFILESUpdatePropertyGroupArg *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBFILESPropertyGroupUpdate *> *updatePropertyGroups = [DBArraySerializer deserialize:valueDict[@"update_property_groups"] withBlock:^id(id elem) { return [DBFILESPropertyGroupUpdateSerializer deserialize:elem]; }];
