...
/// 
/// Full constructor for the DBFILESVideoMetadata struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithDimensions:(DBFILESDimensions * _Nullable)dimensions location:(DBFILESGpsCoordinates * _Nullable)location timeTaken:(NSDate * _Nullable)timeTaken duration:(NSNumber * _Nullable)duration;

/// 
/// Convenience constructor for the DBFILESVideoMetadata struct (exposes only
