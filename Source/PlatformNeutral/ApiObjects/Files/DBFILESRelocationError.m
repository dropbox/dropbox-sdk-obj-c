...
+ (NSDictionary *)serialize:(DBFILESRelocationError *)valueObj {
    ...
    if ([valueObj isFromLookup]) {
        jsonDict = [[DBFILESLookupErrorSerializer serialize:valueObj.fromLookup] mutableCopy];
        jsonDict[@".tag"] = @"from_lookup";
    }
    else if ([valueObj isFromWrite]) {
        jsonDict = [[DBFILESWriteErrorSerializer serialize:valueObj.fromWrite] mutableCopy];
        jsonDict[@".tag"] = @"from_write";
    }
    else if ([valueObj isTo]) {
        jsonDict = [[DBFILESWriteErrorSerializer serialize:valueObj.to] mutableCopy];
        jsonDict[@".tag"] = @"to";
    }
