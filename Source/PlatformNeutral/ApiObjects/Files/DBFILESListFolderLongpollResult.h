...
///
/// Full constructor for the DBFILESListFolderLongpollResult struct (exposes all instance
/// variables).
///
/// @param changes Indicates whether new changes are available. If true, call
/// :route:`list_folder/continue` to retrieve the changes.
/// @param backoff If present, backoff for at least this many seconds before calling
/// :route:`list_folder/longpoll` again.
///
/// @return An initialized DBFILESListFolderLongpollResult instance.
///
- (nonnull instancetype)initWithChanges:(NSNumber * _Nonnull)changes backoff:(NSNumber * _Nullable)backoff;

///
/// Convenience constructor for the DBFILESListFolderLongpollResult struct (exposes only
...
///
/// @param instance An instance of the DBFILESListFolderLongpollResult API object.
///
/// @return A json-compatible dictionary representation of the DBFILESListFolderLongpollResult API
/// object.
///
...
///
/// @param dict A json-compatible dictionary representation of the DBFILESListFolderLongpollResult
/// API object.
///
