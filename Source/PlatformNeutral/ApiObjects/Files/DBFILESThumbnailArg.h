...
/// 
/// Full constructor for the DBFILESThumbnailArg struct (exposes all instance
/// variables).
/// 
...
/// 
/// @return An initialized DBFILESThumbnailArg instance.
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path format:(DBFILESThumbnailFormat * _Nullable)format size:(DBFILESThumbnailSize * _Nullable)size;

/// 
/// Convenience constructor for the DBFILESThumbnailArg struct (exposes only
