...
///
/// Full constructor for the DBFILESThumbnailArg struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBFILESThumbnailArg struct (exposes only non-nullable instance
