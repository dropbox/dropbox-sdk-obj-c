...
/// 
/// Full constructor for the DBFILESPropertyGroupUpdate struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithTemplateId:(NSString * _Nonnull)templateId addOrUpdateFields:(NSArray<DBPROPERTIESPropertyField *> * _Nullable)addOrUpdateFields removeFields:(NSArray<NSString *> * _Nullable)removeFields;

/// 
/// Convenience constructor for the DBFILESPropertyGroupUpdate struct (exposes
