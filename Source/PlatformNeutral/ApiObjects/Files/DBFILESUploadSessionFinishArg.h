...
/// 
/// Full constructor for the DBFILESUploadSessionFinishArg struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithCursor:(DBFILESUploadSessionCursor * _Nonnull)cursor commit:(DBFILESCommitInfo * _Nonnull)commit;
