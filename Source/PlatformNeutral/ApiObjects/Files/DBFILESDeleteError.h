...
/// The DBFILESDeleteErrorTag enum type represents the possible tag states with
/// which the DBFILESDeleteError union can exist.
...
/// (no description). Ensure the isPathLookup method returns true before
/// accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) DBFILESLookupError * _Nonnull pathLookup;

/// (no description). Ensure the isPathWrite method returns true before
/// accessing, otherwise a runtime exception will be raised.
...
/// 
/// @return An initialized DBFILESDeleteError instance.
/// 
