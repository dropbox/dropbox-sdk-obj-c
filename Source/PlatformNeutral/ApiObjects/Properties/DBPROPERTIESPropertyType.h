...
/// The DBPROPERTIESPropertyTypeTag enum type represents the possible tag states
/// with which the DBPROPERTIESPropertyType union can exist.
...
/// 
/// About the String tag state: The associated property will be of type string.
