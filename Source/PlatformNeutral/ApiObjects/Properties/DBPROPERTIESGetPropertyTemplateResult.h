...
/// 
/// Full constructor for the DBPROPERTIESGetPropertyTemplateResult struct
...
/// 
/// @return An initialized DBPROPERTIESGetPropertyTemplateResult instance.
/// 
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name description_:(NSString * _Nonnull)description_ fields:(NSArray<DBPROPERTIESPropertyFieldTemplate *> * _Nonnull)fields;
...
/// 
/// @param instance An instance of the DBPROPERTIESGetPropertyTemplateResult API
/// object.
/// 
