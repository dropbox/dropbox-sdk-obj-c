...
/// 
/// Full constructor for the DBPROPERTIESPropertyFieldTemplate struct (exposes
...
/// 
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name description_:(NSString * _Nonnull)description_ type:(DBPROPERTIESPropertyType * _Nonnull)type;
