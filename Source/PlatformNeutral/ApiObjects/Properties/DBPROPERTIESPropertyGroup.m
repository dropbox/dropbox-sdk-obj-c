...
+ (NSDictionary *)serialize:(DBPROPERTIESPropertyGroup *)valueObj {
    ...
    jsonDict[@"fields"] = [DBArraySerializer serialize:valueObj.fields withBlock:^id(id elem) { return [DBPROPERTIESPropertyFieldSerializer serialize:elem]; }];
...
+ (DBPROPERTIESPropertyGroup *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBPROPERTIESPropertyField *> *fields = [DBArraySerializer deserialize:valueDict[@"fields"] withBlock:^id(id elem) { return [DBPROPERTIESPropertyFieldSerializer deserialize:elem]; }];
