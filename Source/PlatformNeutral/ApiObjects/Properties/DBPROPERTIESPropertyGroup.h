...
/// 
/// Full constructor for the DBPROPERTIESPropertyGroup struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithTemplateId:(NSString * _Nonnull)templateId fields:(NSArray<DBPROPERTIESPropertyField *> * _Nonnull)fields;
