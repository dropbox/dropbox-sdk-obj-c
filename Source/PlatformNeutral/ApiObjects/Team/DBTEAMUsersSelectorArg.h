...
/// List of member IDs. Ensure the isTeamMemberIds method returns true before
/// accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) NSArray<NSString *> * _Nonnull teamMemberIds;

/// List of external user IDs. Ensure the isExternalIds method returns true
/// before accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) NSArray<NSString *> * _Nonnull externalIds;

/// List of email addresses. Ensure the isEmails method returns true before
/// accessing, otherwise a runtime exception will be raised.
