...
/// 
/// Full constructor for the DBTEAMGroupsListResult struct (exposes all instance
/// variables).
/// 
/// @param groups (no description).
/// @param cursor Pass the cursor into :route:`groups/list/continue` to obtain
/// the additional groups.
/// @param hasMore Is true if there are additional groups that have not been
/// returned yet. An additional call to :route:`groups/list/continue` can
/// retrieve them.
/// 
/// @return An initialized DBTEAMGroupsListResult instance.
/// 
- (nonnull instancetype)initWithGroups:(NSArray<DBTEAMCOMMONGroupSummary *> * _Nonnull)groups cursor:(NSString * _Nonnull)cursor hasMore:(NSNumber * _Nonnull)hasMore;
