...
- (NSArray<NSString *> *)membersNotInTeam {
    if (![self isMembersNotInTeam]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMGroupMembersAddErrorMembersNotInTeam, but was %@.", [self tagName]];
    }
...
- (NSArray<NSString *> *)usersNotFound {
    if (![self isUsersNotFound]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMGroupMembersAddErrorUsersNotFound, but was %@.", [self tagName]];
    }
...
- (NSArray<NSString *> *)userCannotBeManagerOfCompanyManagedGroup {
    if (![self isUserCannotBeManagerOfCompanyManagedGroup]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMGroupMembersAddErrorUserCannotBeManagerOfCompanyManagedGroup, but was %@.", [self tagName]];
    }
...
+ (NSDictionary *)serialize:(DBTEAMGroupMembersAddError *)valueObj {
    ...
    if ([valueObj isGroupNotFound]) {
        ...
        jsonDict[@"members_not_in_team"] = [DBArraySerializer serialize:valueObj.membersNotInTeam withBlock:^id(id elem) { return elem; }];
        jsonDict[@".tag"] = @"members_not_in_team";
    }
    else if ([valueObj isUsersNotFound]) {
        jsonDict[@"users_not_found"] = [DBArraySerializer serialize:valueObj.usersNotFound withBlock:^id(id elem) { return elem; }];
        ...
        jsonDict[@"user_cannot_be_manager_of_company_managed_group"] = [DBArraySerializer serialize:valueObj.userCannotBeManagerOfCompanyManagedGroup withBlock:^id(id elem) { return elem; }];
...
+ (DBTEAMGroupMembersAddError *)deserialize:(NSDictionary *)valueDict {
    ...
    if ([tag isEqualToString:@"group_not_found"]) {
        ...
        NSArray<NSString *> *membersNotInTeam = [DBArraySerializer deserialize:valueDict[@"members_not_in_team"] withBlock:^id(id elem) { return elem; }];
        ...
        NSArray<NSString *> *usersNotFound = [DBArraySerializer deserialize:valueDict[@"users_not_found"] withBlock:^id(id elem) { return elem; }];
        ...
        NSArray<NSString *> *userCannotBeManagerOfCompanyManagedGroup = [DBArraySerializer deserialize:valueDict[@"user_cannot_be_manager_of_company_managed_group"] withBlock:^id(id elem) { return elem; }];
        return [[DBTEAMGroupMembersAddError alloc] initWithUserCannotBeManagerOfCompanyManagedGroup:userCannotBeManagerOfCompanyManagedGroup];
    }
