...
/// 
/// Full constructor for the DBTEAMListMembersAppsResult struct (exposes all
/// instance variables).
/// 
...
/// to :route:`linked_apps/list_members_linked_apps` to retrieve the rest.
...
/// 
/// Convenience constructor for the DBTEAMListMembersAppsResult struct (exposes
