...
/// 
/// Full constructor for the DBTEAMListMembersDevicesArg struct (exposes all
/// instance variables).
/// 
/// @param cursor At the first call to the :route:`devices/list_members_devices`
...
/// 
/// Convenience constructor for the DBTEAMListMembersDevicesArg struct (exposes
