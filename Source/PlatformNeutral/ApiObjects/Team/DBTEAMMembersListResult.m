...
- (instancetype)initWithMembers:(NSArray<DBTEAMTeamMemberInfo *> *)members cursor:(NSString *)cursor hasMore:(NSNumber *)hasMore {
...
+ (NSDictionary *)serialize:(DBTEAMMembersListResult *)valueObj {
    ...
    jsonDict[@"members"] = [DBArraySerializer serialize:valueObj.members withBlock:^id(id elem) { return [DBTEAMTeamMemberInfoSerializer serialize:elem]; }];
...
+ (DBTEAMMembersListResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMTeamMemberInfo *> *members = [DBArraySerializer deserialize:valueDict[@"members"] withBlock:^id(id elem) { return [DBTEAMTeamMemberInfoSerializer deserialize:elem]; }];
