...
/// 
/// Full constructor for the DBTEAMGroupFullInfo struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithGroupName:(NSString * _Nonnull)groupName groupId:(NSString * _Nonnull)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType * _Nonnull)groupManagementType created:(NSNumber * _Nonnull)created groupExternalId:(NSString * _Nullable)groupExternalId memberCount:(NSNumber * _Nullable)memberCount members:(NSArray<DBTEAMGroupMemberInfo *> * _Nullable)members;

/// 
/// Convenience constructor for the DBTEAMGroupFullInfo struct (exposes only
...
/// @return An initialized DBTEAMGroupFullInfo instance.
/// 
- (nonnull instancetype)initWithGroupName:(NSString * _Nonnull)groupName groupId:(NSString * _Nonnull)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType * _Nonnull)groupManagementType created:(NSNumber * _Nonnull)created;
