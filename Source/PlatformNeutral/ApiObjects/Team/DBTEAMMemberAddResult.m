...
- (DBTEAMTeamMemberInfo *)success {
    if (![self isSuccess]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultSuccess, but was %@.", [self tagName]];
    }
    return _success;
}
...
- (NSString *)teamLicenseLimit {
    if (![self isTeamLicenseLimit]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultTeamLicenseLimit, but was %@.", [self tagName]];
    }
...
- (NSString *)freeTeamMemberLimitReached {
    if (![self isFreeTeamMemberLimitReached]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultFreeTeamMemberLimitReached, but was %@.", [self tagName]];
    }
...
- (NSString *)userAlreadyOnTeam {
    if (![self isUserAlreadyOnTeam]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultUserAlreadyOnTeam, but was %@.", [self tagName]];
    }
...
- (NSString *)userOnAnotherTeam {
    if (![self isUserOnAnotherTeam]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultUserOnAnotherTeam, but was %@.", [self tagName]];
    }
...
- (NSString *)userAlreadyPaired {
    if (![self isUserAlreadyPaired]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultUserAlreadyPaired, but was %@.", [self tagName]];
    }
...
- (NSString *)userMigrationFailed {
    if (![self isUserMigrationFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultUserMigrationFailed, but was %@.", [self tagName]];
    }
...
- (NSString *)duplicateExternalMemberId {
    if (![self isDuplicateExternalMemberId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultDuplicateExternalMemberId, but was %@.", [self tagName]];
    }
...
- (NSString *)userCreationFailed {
    if (![self isUserCreationFailed]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMMemberAddResultUserCreationFailed, but was %@.", [self tagName]];
    }
