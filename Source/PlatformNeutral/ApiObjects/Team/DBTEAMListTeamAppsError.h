...
/// The DBTEAMListTeamAppsErrorTag enum type represents the possible tag states
/// with which the DBTEAMListTeamAppsError union can exist.
...
/// 
/// @return An initialized DBTEAMListTeamAppsError instance.
/// 
