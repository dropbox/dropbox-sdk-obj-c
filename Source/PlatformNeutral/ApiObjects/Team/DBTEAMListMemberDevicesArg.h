...
///
/// Full constructor for the DBTEAMListMemberDevicesArg struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBTEAMListMemberDevicesArg struct (exposes only non-nullable
