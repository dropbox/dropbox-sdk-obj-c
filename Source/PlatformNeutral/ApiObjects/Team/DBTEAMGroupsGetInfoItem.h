...
/// The DBTEAMGroupsGetInfoItemTag enum type represents the possible tag states
/// with which the DBTEAMGroupsGetInfoItem union can exist.
...
/// on how the method was called. Ensure the isIdNotFound method returns true
/// before accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly, copy) NSString * _Nonnull idNotFound;

/// Info about a group. Ensure the isGroupInfo method returns true before
