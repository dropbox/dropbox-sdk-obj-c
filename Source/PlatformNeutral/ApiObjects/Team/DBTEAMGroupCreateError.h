...
/// 
/// About the GroupNameAlreadyUsed tag state: There is already an existing group
/// with the requested name.
/// 
/// @return An initialized DBTEAMGroupCreateError instance.
/// 
...
/// 
/// Retrieves whether the union's current tag state has value GroupNameInvalid.
/// 
/// @return Whether the union's current tag state has value GroupNameInvalid.
/// 
