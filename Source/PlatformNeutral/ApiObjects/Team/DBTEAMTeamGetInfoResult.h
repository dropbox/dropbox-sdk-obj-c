...
/// 
/// Full constructor for the DBTEAMTeamGetInfoResult struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBTEAMTeamGetInfoResult instance.
/// 
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name teamId:(NSString * _Nonnull)teamId numLicensedUsers:(NSNumber * _Nonnull)numLicensedUsers numProvisionedUsers:(NSNumber * _Nonnull)numProvisionedUsers policies:(DBTEAMPOLICIESTeamMemberPolicies * _Nonnull)policies;
