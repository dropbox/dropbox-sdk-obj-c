...
/// The DBTEAMGroupMemberSelectorErrorTag enum type represents the possible tag
/// states with which the DBTEAMGroupMemberSelectorError union can exist.
...
/// 
/// @return An initialized DBTEAMGroupMemberSelectorError instance.
/// 
...
/// 
/// About the MemberNotInGroup tag state: The specified user is not a member of
/// this group.
/// 
/// @return An initialized DBTEAMGroupMemberSelectorError instance.
/// 
