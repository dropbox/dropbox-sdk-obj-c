...
/// 
/// Full constructor for the DBTEAMRevokeLinkedAppBatchResult struct (exposes
...
/// 
- (nonnull instancetype)initWithRevokeLinkedAppStatus:(NSArray<DBTEAMRevokeLinkedAppStatus *> * _Nonnull)revokeLinkedAppStatus;
