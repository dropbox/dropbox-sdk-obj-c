...
/// The DBTEAMGroupSelectorTag enum type represents the possible tag states with
/// which the DBTEAMGroupSelector union can exist.
...
/// Group ID. Ensure the isGroupId method returns true before accessing,
/// otherwise a runtime exception will be raised.
@property (nonatomic, readonly, copy) NSString * _Nonnull groupId;

/// External ID of the group. Ensure the isGroupExternalId method returns true
