...
/// 
/// Full constructor for the DBTEAMListMembersDevicesResult struct (exposes all
/// instance variables).
/// 
...
/// @param cursor Pass the cursor into :route:`devices/list_members_devices` to
...
/// 
/// Convenience constructor for the DBTEAMListMembersDevicesResult struct
