...
- (instancetype)initWithApps:(NSArray<DBTEAMMemberLinkedApps *> *)apps hasMore:(NSNumber *)hasMore cursor:(NSString *)cursor {
...
+ (NSDictionary *)serialize:(DBTEAMListTeamAppsResult *)valueObj {
    ...
    jsonDict[@"apps"] = [DBArraySerializer serialize:valueObj.apps withBlock:^id(id elem) { return [DBTEAMMemberLinkedAppsSerializer serialize:elem]; }];
...
+ (DBTEAMListTeamAppsResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMMemberLinkedApps *> *apps = [DBArraySerializer deserialize:valueDict[@"apps"] withBlock:^id(id elem) { return [DBTEAMMemberLinkedAppsSerializer deserialize:elem]; }];
