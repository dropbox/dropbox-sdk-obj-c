...
/// 
/// Full constructor for the DBTEAMMemberDevices struct (exposes all instance
/// variables).
/// 
...
/// 
/// @return An initialized DBTEAMMemberDevices instance.
/// 
- (nonnull instancetype)initWithTeamMemberId:(NSString * _Nonnull)teamMemberId webSessions:(NSArray<DBTEAMActiveWebSession *> * _Nullable)webSessions desktopClients:(NSArray<DBTEAMDesktopClientSession *> * _Nullable)desktopClients mobileClients:(NSArray<DBTEAMMobileClientSession *> * _Nullable)mobileClients;

/// 
/// Convenience constructor for the DBTEAMMemberDevices struct (exposes only
