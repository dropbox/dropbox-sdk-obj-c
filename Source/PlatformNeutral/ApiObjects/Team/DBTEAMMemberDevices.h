...
///
/// Full constructor for the DBTEAMMemberDevices struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBTEAMMemberDevices struct (exposes only non-nullable instance
