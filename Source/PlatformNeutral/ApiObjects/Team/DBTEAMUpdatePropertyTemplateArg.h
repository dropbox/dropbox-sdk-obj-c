...
///
/// Full constructor for the DBTEAMUpdatePropertyTemplateArg struct (exposes all instance
/// variables).
///
...
///
/// Convenience constructor for the DBTEAMUpdatePropertyTemplateArg struct (exposes only
