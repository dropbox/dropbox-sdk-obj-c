...
/// 
/// Full constructor for the DBTEAMUpdatePropertyTemplateArg struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBTEAMUpdatePropertyTemplateArg instance.
/// 
- (nonnull instancetype)initWithTemplateId:(NSString * _Nonnull)templateId name:(NSString * _Nullable)name description_:(NSString * _Nullable)description_ addFields:(NSArray<DBPROPERTIESPropertyFieldTemplate *> * _Nullable)addFields;

/// 
/// Convenience constructor for the DBTEAMUpdatePropertyTemplateArg struct
