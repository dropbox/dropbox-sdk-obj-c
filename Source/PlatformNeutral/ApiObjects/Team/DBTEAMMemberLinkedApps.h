...
/// 
/// Full constructor for the DBTEAMMemberLinkedApps struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithTeamMemberId:(NSString * _Nonnull)teamMemberId linkedApiApps:(NSArray<DBTEAMApiApp *> * _Nonnull)linkedApiApps;
