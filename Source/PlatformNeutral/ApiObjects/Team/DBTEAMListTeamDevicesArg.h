...
///
/// Full constructor for the DBTEAMListTeamDevicesArg struct (exposes all instance variables).
///
/// @param cursor At the first call to the :route:`devices/list_team_devices` the cursor shouldn't
...
///
/// @return An initialized DBTEAMListTeamDevicesArg instance.
///
...
///
/// Convenience constructor for the DBTEAMListTeamDevicesArg struct (exposes only non-nullable
...
///
/// @return A json-compatible dictionary representation of the DBTEAMListTeamDevicesArg API object.
///
