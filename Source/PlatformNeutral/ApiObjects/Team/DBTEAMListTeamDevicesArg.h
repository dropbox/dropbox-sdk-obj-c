...
/// 
/// Full constructor for the DBTEAMListTeamDevicesArg struct (exposes all
/// instance variables).
/// 
/// @param cursor At the first call to the :route:`devices/list_team_devices`
...
/// 
/// Convenience constructor for the DBTEAMListTeamDevicesArg struct (exposes
