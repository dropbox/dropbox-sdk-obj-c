...
+ (DBTEAMListMembersDevicesArg *)deserialize:(NSDictionary *)valueDict {
    ...
    return [[DBTEAMListMembersDevicesArg alloc] initWithCursor:cursor includeWebSessions:includeWebSessions includeDesktopClients:includeDesktopClients includeMobileClients:includeMobileClients];
}
