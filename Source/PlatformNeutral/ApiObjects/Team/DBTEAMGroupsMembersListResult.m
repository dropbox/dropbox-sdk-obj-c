...
- (instancetype)initWithMembers:(NSArray<DBTEAMGroupMemberInfo *> *)members cursor:(NSString *)cursor hasMore:(NSNumber *)hasMore {
...
+ (DBTEAMGroupsMembersListResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMGroupMemberInfo *> *members = [DBArraySerializer deserialize:valueDict[@"members"] withBlock:^id(id elem) { return [DBTEAMGroupMemberInfoSerializer deserialize:elem]; }];
