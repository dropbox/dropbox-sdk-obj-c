...
/// 
/// Full constructor for the DBTEAMGroupMembersSelector struct (exposes all
/// instance variables).
/// 
/// @param group Specify a group.
/// @param users A list of users that are members of :field:`group`.
/// 
/// @return An initialized DBTEAMGroupMembersSelector instance.
/// 
- (nonnull instancetype)initWithGroup:(DBTEAMGroupSelector * _Nonnull)group users:(DBTEAMUsersSelectorArg * _Nonnull)users;
