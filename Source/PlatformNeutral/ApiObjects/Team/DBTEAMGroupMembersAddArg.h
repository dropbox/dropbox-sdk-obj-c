...
/// 
/// Full constructor for the DBTEAMGroupMembersAddArg struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithGroup:(DBTEAMGroupSelector * _Nonnull)group members:(NSArray<DBTEAMMemberAccess *> * _Nonnull)members returnMembers:(NSNumber * _Nullable)returnMembers;

/// 
/// Convenience constructor for the DBTEAMGroupMembersAddArg struct (exposes
...
/// @return An initialized DBTEAMGroupMembersAddArg instance.
/// 
- (nonnull instancetype)initWithGroup:(DBTEAMGroupSelector * _Nonnull)group members:(NSArray<DBTEAMMemberAccess *> * _Nonnull)members;
