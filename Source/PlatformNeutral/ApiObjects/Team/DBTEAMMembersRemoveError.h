...
/// The DBTEAMMembersRemoveErrorTag enum type represents the possible tag states
/// with which the DBTEAMMembersRemoveError union can exist.
...
/// 
/// About the RemoveLastAdmin tag state: The user is the last admin of the team,
...
/// 
/// About the TransferDestUserNotFound tag state: No matching user found for the
...
/// 
/// About the TransferDestUserNotInTeam tag state: The provided transfer_dest_id
...
/// 
/// About the CannotKeepAccountAndDeleteData tag state: Cannot keep account and
