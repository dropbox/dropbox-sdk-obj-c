...
- (instancetype)initWithGroup:(DBTEAMGroupSelector *)group users:(NSArray<DBTEAMUserSelectorArg *> *)users returnMembers:(NSNumber *)returnMembers {
...
+ (NSDictionary *)serialize:(DBTEAMGroupMembersRemoveArg *)valueObj {
    ...
    jsonDict[@"users"] = [DBArraySerializer serialize:valueObj.users withBlock:^id(id elem) { return [DBTEAMUserSelectorArgSerializer serialize:elem]; }];
...
+ (DBTEAMGroupMembersRemoveArg *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBTEAMUserSelectorArg *> *users = [DBArraySerializer deserialize:valueDict[@"users"] withBlock:^id(id elem) { return [DBTEAMUserSelectorArgSerializer deserialize:elem]; }];
