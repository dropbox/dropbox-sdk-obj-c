...
/// 
/// Full constructor for the DBTEAMGroupMembersChangeResult struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBTEAMGroupMembersChangeResult instance.
/// 
- (nonnull instancetype)initWithGroupInfo:(DBTEAMGroupFullInfo * _Nonnull)groupInfo asyncJobId:(NSString * _Nonnull)asyncJobId;
