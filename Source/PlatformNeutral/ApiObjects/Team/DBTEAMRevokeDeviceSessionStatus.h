...
/// 
/// Full constructor for the DBTEAMRevokeDeviceSessionStatus struct (exposes all
/// instance variables).
/// 
/// @param success Result of the revoking request
/// @param errorType The error cause in case of a failure
/// 
/// @return An initialized DBTEAMRevokeDeviceSessionStatus instance.
/// 
- (nonnull instancetype)initWithSuccess:(NSNumber * _Nonnull)success errorType:(DBTEAMRevokeDeviceSessionError * _Nullable)errorType;

/// 
/// Convenience constructor for the DBTEAMRevokeDeviceSessionStatus struct
