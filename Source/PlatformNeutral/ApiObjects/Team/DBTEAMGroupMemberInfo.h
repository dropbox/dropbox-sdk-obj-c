...
/// 
/// Full constructor for the DBTEAMGroupMemberInfo struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithProfile:(DBTEAMMemberProfile * _Nonnull)profile accessType:(DBTEAMGroupAccessType * _Nonnull)accessType;
