...
+ (NSDictionary *)serialize:(DBTEAMRevokeDeviceSessionBatchArg *)valueObj {
    ...
    jsonDict[@"revoke_devices"] = [DBArraySerializer serialize:valueObj.revokeDevices withBlock:^id(id elem) { return [DBTEAMRevokeDeviceSessionArgSerializer serialize:elem]; }];

    return jsonDict;
}

+ (DBTEAMRevokeDeviceSessionBatchArg *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMRevokeDeviceSessionArg *> *revokeDevices = [DBArraySerializer deserialize:valueDict[@"revoke_devices"] withBlock:^id(id elem) { return [DBTEAMRevokeDeviceSessionArgSerializer deserialize:elem]; }];
