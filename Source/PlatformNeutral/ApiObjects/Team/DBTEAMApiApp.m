...
+ (DBTEAMApiApp *)deserialize:(NSDictionary *)valueDict {
    ...
    NSDate *linked = valueDict[@"linked"] ? [DBNSDateSerializer deserialize:valueDict[@"linked"] dateFormat:@"%Y-%m-%dT%H:%M:%SZ"] : nil;

    return [[DBTEAMApiApp alloc] initWithAppId:appId appName:appName isAppFolder:isAppFolder publisher:publisher publisherUrl:publisherUrl linked:linked];
}
