...
/// The DBTEAMMembersGetInfoItemTag enum type represents the possible tag states
/// with which the DBTEAMMembersGetInfoItem union can exist.
...
/// external ID, depending on how the method was called. Ensure the isIdNotFound
/// method returns true before accessing, otherwise a runtime exception will be
/// raised.
@property (nonatomic, readonly, copy) NSString * _Nonnull idNotFound;

/// Info about a team member. Ensure the isMemberInfo method returns true before
...
/// method was called.
/// 
/// @return An initialized DBTEAMMembersGetInfoItem instance.
/// 
...
/// 
/// @return Whether the union's current tag state has value MemberInfo.
/// 
- (BOOL)isMemberInfo;
