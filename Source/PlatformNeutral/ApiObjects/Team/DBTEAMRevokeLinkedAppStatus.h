...
/// 
/// Full constructor for the DBTEAMRevokeLinkedAppStatus struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithSuccess:(NSNumber * _Nonnull)success errorType:(DBTEAMRevokeLinkedAppError * _Nullable)errorType;

/// 
/// Convenience constructor for the DBTEAMRevokeLinkedAppStatus struct (exposes
