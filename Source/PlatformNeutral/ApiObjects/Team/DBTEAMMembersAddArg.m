...
+ (NSDictionary *)serialize:(DBTEAMMembersAddArg *)valueObj {
    ...
    jsonDict[@"new_members"] = [DBArraySerializer serialize:valueObj.dNewMembers withBlock:^id(id elem) { return [DBTEAMMemberAddArgSerializer serialize:elem]; }];
...
+ (DBTEAMMembersAddArg *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMMemberAddArg *> *dNewMembers = [DBArraySerializer deserialize:valueDict[@"new_members"] withBlock:^id(id elem) { return [DBTEAMMemberAddArgSerializer deserialize:elem]; }];
