...
+ (NSDictionary *)serialize:(DBTEAMMemberLinkedApps *)valueObj {
    ...
    jsonDict[@"linked_api_apps"] = [DBArraySerializer serialize:valueObj.linkedApiApps withBlock:^id(id elem) { return [DBTEAMApiAppSerializer serialize:elem]; }];
...
+ (DBTEAMMemberLinkedApps *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBTEAMApiApp *> *linkedApiApps = [DBArraySerializer deserialize:valueDict[@"linked_api_apps"] withBlock:^id(id elem) { return [DBTEAMApiAppSerializer deserialize:elem]; }];
