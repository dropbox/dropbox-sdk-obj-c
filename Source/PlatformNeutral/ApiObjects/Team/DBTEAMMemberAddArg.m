...
- (instancetype)initWithMemberEmail:(NSString *)memberEmail memberGivenName:(NSString *)memberGivenName memberSurname:(NSString *)memberSurname memberExternalId:(NSString *)memberExternalId sendWelcomeEmail:(NSNumber *)sendWelcomeEmail role:(DBTEAMAdminTier *)role {
    [DBStoneValidators stringValidator:nil maxLength:@(255) pattern:@"^['&A-Za-z0-9._%+-]+@[A-Za-z0-9-][A-Za-z0-9.-]*.[A-Za-z]{2,15}$"](memberEmail);
    ...
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:nil maxLength:@(64) pattern:nil]](memberExternalId);
...
+ (DBTEAMMemberAddArg *)deserialize:(NSDictionary *)valueDict {
    ...
    return [[DBTEAMMemberAddArg alloc] initWithMemberEmail:memberEmail memberGivenName:memberGivenName memberSurname:memberSurname memberExternalId:memberExternalId sendWelcomeEmail:sendWelcomeEmail role:role];
}
