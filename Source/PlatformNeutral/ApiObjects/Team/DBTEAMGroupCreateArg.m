...
- (instancetype)initWithGroupName:(NSString *)groupName groupExternalId:(NSString *)groupExternalId groupManagementType:(DBTEAMCOMMONGroupManagementType *)groupManagementType {
...
+ (DBTEAMGroupCreateArg *)deserialize:(NSDictionary *)valueDict {
    ...
    DBTEAMCOMMONGroupManagementType *groupManagementType = valueDict[@"group_management_type"] ? [DBTEAMCOMMONGroupManagementTypeSerializer deserialize:valueDict[@"group_management_type"]] : nil;

    return [[DBTEAMGroupCreateArg alloc] initWithGroupName:groupName groupExternalId:groupExternalId groupManagementType:groupManagementType];
}
