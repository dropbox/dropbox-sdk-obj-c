...
+ (NSDictionary *)serialize:(DBTEAMGetMembershipReport *)valueObj {
    ...
    jsonDict[@"team_size"] = [DBArraySerializer serialize:valueObj.teamSize withBlock:^id(id elem) { return elem; }];
    jsonDict[@"pending_invites"] = [DBArraySerializer serialize:valueObj.pendingInvites withBlock:^id(id elem) { return elem; }];
    jsonDict[@"members_joined"] = [DBArraySerializer serialize:valueObj.membersJoined withBlock:^id(id elem) { return elem; }];
    jsonDict[@"suspended_members"] = [DBArraySerializer serialize:valueObj.suspendedMembers withBlock:^id(id elem) { return elem; }];
    jsonDict[@"licenses"] = [DBArraySerializer serialize:valueObj.licenses withBlock:^id(id elem) { return elem; }];
...
+ (DBTEAMGetMembershipReport *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<NSNumber *> *teamSize = [DBArraySerializer deserialize:valueDict[@"team_size"] withBlock:^id(id elem) { return elem; }];
    NSArray<NSNumber *> *pendingInvites = [DBArraySerializer deserialize:valueDict[@"pending_invites"] withBlock:^id(id elem) { return elem; }];
    NSArray<NSNumber *> *membersJoined = [DBArraySerializer deserialize:valueDict[@"members_joined"] withBlock:^id(id elem) { return elem; }];
    NSArray<NSNumber *> *suspendedMembers = [DBArraySerializer deserialize:valueDict[@"suspended_members"] withBlock:^id(id elem) { return elem; }];
    NSArray<NSNumber *> *licenses = [DBArraySerializer deserialize:valueDict[@"licenses"] withBlock:^id(id elem) { return elem; }];

    return [[DBTEAMGetMembershipReport alloc] initWithStartDate:startDate teamSize:teamSize pendingInvites:pendingInvites membersJoined:membersJoined suspendedMembers:suspendedMembers licenses:licenses];
}
