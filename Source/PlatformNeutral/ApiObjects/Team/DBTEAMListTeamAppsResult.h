...
/// 
/// Full constructor for the DBTEAMListTeamAppsResult struct (exposes all
/// instance variables).
/// 
...
/// to :route:`linked_apps/list_team_linked_apps` to retrieve the rest.
...
/// 
- (nonnull instancetype)initWithApps:(NSArray<DBTEAMMemberLinkedApps *> * _Nonnull)apps hasMore:(NSNumber * _Nonnull)hasMore cursor:(NSString * _Nullable)cursor;

/// 
/// Convenience constructor for the DBTEAMListTeamAppsResult struct (exposes
...
/// @return An initialized DBTEAMListTeamAppsResult instance.
/// 
- (nonnull instancetype)initWithApps:(NSArray<DBTEAMMemberLinkedApps *> * _Nonnull)apps hasMore:(NSNumber * _Nonnull)hasMore;
