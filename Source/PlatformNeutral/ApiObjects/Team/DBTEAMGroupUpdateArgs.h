...
/// 
/// Full constructor for the DBTEAMGroupUpdateArgs struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithGroup:(DBTEAMGroupSelector * _Nonnull)group returnMembers:(NSNumber * _Nullable)returnMembers dNewGroupName:(NSString * _Nullable)dNewGroupName dNewGroupExternalId:(NSString * _Nullable)dNewGroupExternalId dNewGroupManagementType:(DBTEAMCOMMONGroupManagementType * _Nullable)dNewGroupManagementType;

/// 
/// Convenience constructor for the DBTEAMGroupUpdateArgs struct (exposes only
