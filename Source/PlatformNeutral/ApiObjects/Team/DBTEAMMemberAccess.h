...
/// 
/// Full constructor for the DBTEAMMemberAccess struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithUser:(DBTEAMUserSelectorArg * _Nonnull)user accessType:(DBTEAMGroupAccessType * _Nonnull)accessType;
