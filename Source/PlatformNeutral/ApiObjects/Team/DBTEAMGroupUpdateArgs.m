...
- (instancetype)initWithGroup:(DBTEAMGroupSelector *)group returnMembers:(NSNumber *)returnMembers dNewGroupName:(NSString *)dNewGroupName dNewGroupExternalId:(NSString *)dNewGroupExternalId dNewGroupManagementType:(DBTEAMCOMMONGroupManagementType *)dNewGroupManagementType {
...
+ (NSDictionary *)serialize:(DBTEAMGroupUpdateArgs *)valueObj {
    ...
    if (valueObj.dNewGroupManagementType) {
        jsonDict[@"new_group_management_type"] = [DBTEAMCOMMONGroupManagementTypeSerializer serialize:valueObj.dNewGroupManagementType];
    }
...
+ (DBTEAMGroupUpdateArgs *)deserialize:(NSDictionary *)valueDict {
    ...
    DBTEAMCOMMONGroupManagementType *dNewGroupManagementType = valueDict[@"new_group_management_type"] ? [DBTEAMCOMMONGroupManagementTypeSerializer deserialize:valueDict[@"new_group_management_type"]] : nil;

    return [[DBTEAMGroupUpdateArgs alloc] initWithGroup:group returnMembers:returnMembers dNewGroupName:dNewGroupName dNewGroupExternalId:dNewGroupExternalId dNewGroupManagementType:dNewGroupManagementType];
}
