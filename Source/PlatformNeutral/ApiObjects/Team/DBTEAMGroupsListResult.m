...
- (instancetype)initWithGroups:(NSArray<DBTEAMCOMMONGroupSummary *> *)groups cursor:(NSString *)cursor hasMore:(NSNumber *)hasMore {
...
+ (NSDictionary *)serialize:(DBTEAMGroupsListResult *)valueObj {
    ...
    jsonDict[@"groups"] = [DBArraySerializer serialize:valueObj.groups withBlock:^id(id elem) { return [DBTEAMCOMMONGroupSummarySerializer serialize:elem]; }];
...
+ (DBTEAMGroupsListResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMCOMMONGroupSummary *> *groups = [DBArraySerializer deserialize:valueDict[@"groups"] withBlock:^id(id elem) { return [DBTEAMCOMMONGroupSummarySerializer deserialize:elem]; }];
