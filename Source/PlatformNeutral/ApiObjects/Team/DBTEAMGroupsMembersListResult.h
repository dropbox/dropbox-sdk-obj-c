...
/// 
/// Full constructor for the DBTEAMGroupsMembersListResult struct (exposes all
/// instance variables).
/// 
/// @param members (no description).
/// @param cursor Pass the cursor into :route:`groups/members/list/continue` to
...
/// 
/// @return An initialized DBTEAMGroupsMembersListResult instance.
/// 
- (nonnull instancetype)initWithMembers:(NSArray<DBTEAMGroupMemberInfo *> * _Nonnull)members cursor:(NSString * _Nonnull)cursor hasMore:(NSNumber * _Nonnull)hasMore;
