...
- (instancetype)initWithGroup:(DBTEAMGroupSelector *)group members:(NSArray<DBTEAMMemberAccess *> *)members returnMembers:(NSNumber *)returnMembers {
...
+ (NSDictionary *)serialize:(DBTEAMGroupMembersAddArg *)valueObj {
    ...
    jsonDict[@"members"] = [DBArraySerializer serialize:valueObj.members withBlock:^id(id elem) { return [DBTEAMMemberAccessSerializer serialize:elem]; }];
...
+ (DBTEAMGroupMembersAddArg *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBTEAMMemberAccess *> *members = [DBArraySerializer deserialize:valueDict[@"members"] withBlock:^id(id elem) { return [DBTEAMMemberAccessSerializer deserialize:elem]; }];
