...
/// The DBTEAMGroupsGetInfoErrorTag enum type represents the possible tag states
/// with which the DBTEAMGroupsGetInfoError union can exist.
...
/// 
/// @return An initialized DBTEAMGroupsGetInfoError instance.
/// 
