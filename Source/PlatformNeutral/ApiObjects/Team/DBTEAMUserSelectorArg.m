...
- (NSString *)teamMemberId {
    if (![self isTeamMemberId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMUserSelectorArgTeamMemberId, but was %@.", [self tagName]];
    }
...
- (NSString *)externalId {
    if (![self isExternalId]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMUserSelectorArgExternalId, but was %@.", [self tagName]];
    }
    return _externalId;
}
...
- (NSString *)email {
    if (![self isEmail]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBTEAMUserSelectorArgEmail, but was %@.", [self tagName]];
    }
    return _email;
}
