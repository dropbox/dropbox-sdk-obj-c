...
- (instancetype)initWithUser:(DBTEAMUserSelectorArg *)user wipeData:(NSNumber *)wipeData transferDestId:(DBTEAMUserSelectorArg *)transferDestId transferAdminId:(DBTEAMUserSelectorArg *)transferAdminId keepAccount:(NSNumber *)keepAccount {
...
+ (DBTEAMMembersRemoveArg *)deserialize:(NSDictionary *)valueDict {
    ...
    DBTEAMUserSelectorArg *transferDestId = valueDict[@"transfer_dest_id"] ? [DBTEAMUserSelectorArgSerializer deserialize:valueDict[@"transfer_dest_id"]] : nil;
    DBTEAMUserSelectorArg *transferAdminId = valueDict[@"transfer_admin_id"] ? [DBTEAMUserSelectorArgSerializer deserialize:valueDict[@"transfer_admin_id"]] : nil;
    NSNumber *keepAccount = valueDict[@"keep_account"];

    return [[DBTEAMMembersRemoveArg alloc] initWithUser:user wipeData:wipeData transferDestId:transferDestId transferAdminId:transferAdminId keepAccount:keepAccount];
}
