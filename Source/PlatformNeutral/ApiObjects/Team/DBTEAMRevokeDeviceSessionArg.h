...
/// End an active session Ensure the isWebSession method returns true before
/// accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) DBTEAMDeviceSessionArg * _Nonnull webSession;

/// Unlink a linked desktop device Ensure the isDesktopClient method returns
/// true before accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) DBTEAMRevokeDesktopClientArg * _Nonnull desktopClient;

/// Unlink a linked mobile device Ensure the isMobileClient method returns true
...
/// 
/// @return An initialized DBTEAMRevokeDeviceSessionArg instance.
/// 
...
/// 
/// @return Whether the union's current tag state has value WebSession.
/// 
- (BOOL)isWebSession;
...
/// 
/// @return Whether the union's current tag state has value DesktopClient.
/// 
...
/// 
/// @return Whether the union's current tag state has value MobileClient.
/// 
- (BOOL)isMobileClient;
