...
+ (NSDictionary *)serialize:(DBTEAMRevokeLinkedAppBatchResult *)valueObj {
    ...
    jsonDict[@"revoke_linked_app_status"] = [DBArraySerializer serialize:valueObj.revokeLinkedAppStatus withBlock:^id(id elem) { return [DBTEAMRevokeLinkedAppStatusSerializer serialize:elem]; }];

    return jsonDict;
}

+ (DBTEAMRevokeLinkedAppBatchResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMRevokeLinkedAppStatus *> *revokeLinkedAppStatus = [DBArraySerializer deserialize:valueDict[@"revoke_linked_app_status"] withBlock:^id(id elem) { return [DBTEAMRevokeLinkedAppStatusSerializer deserialize:elem]; }];
