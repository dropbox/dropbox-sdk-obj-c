...
/// 
/// Full constructor for the DBTEAMRevokeDeviceSessionBatchResult struct
...
/// 
- (nonnull instancetype)initWithRevokeDevicesStatus:(NSArray<DBTEAMRevokeDeviceSessionStatus *> * _Nonnull)revokeDevicesStatus;
...
/// 
/// @param instance An instance of the DBTEAMRevokeDeviceSessionBatchResult API
/// object.
/// 
