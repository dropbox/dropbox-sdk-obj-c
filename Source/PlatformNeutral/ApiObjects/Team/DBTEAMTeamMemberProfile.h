...
///
/// Full constructor for the DBTEAMTeamMemberProfile struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBTEAMTeamMemberProfile struct (exposes only non-nullable
