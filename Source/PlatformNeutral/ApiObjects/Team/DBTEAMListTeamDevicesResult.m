...
- (instancetype)initWithDevices:(NSArray<DBTEAMMemberDevices *> *)devices hasMore:(NSNumber *)hasMore cursor:(NSString *)cursor {
...
+ (NSDictionary *)serialize:(DBTEAMListTeamDevicesResult *)valueObj {
    ...
    jsonDict[@"devices"] = [DBArraySerializer serialize:valueObj.devices withBlock:^id(id elem) { return [DBTEAMMemberDevicesSerializer serialize:elem]; }];
...
+ (DBTEAMListTeamDevicesResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBTEAMMemberDevices *> *devices = [DBArraySerializer deserialize:valueDict[@"devices"] withBlock:^id(id elem) { return [DBTEAMMemberDevicesSerializer deserialize:elem]; }];
