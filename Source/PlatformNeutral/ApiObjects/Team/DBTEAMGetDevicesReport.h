...
/// 
/// Full constructor for the DBTEAMGetDevicesReport struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithStartDate:(NSString * _Nonnull)startDate active1Day:(DBTEAMDevicesActive * _Nonnull)active1Day active7Day:(DBTEAMDevicesActive * _Nonnull)active7Day active28Day:(DBTEAMDevicesActive * _Nonnull)active28Day;
