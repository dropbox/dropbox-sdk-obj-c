...
///
/// @return A json-compatible dictionary representation of the `DBTEAMDeviceSessionArg` API object.
///
...
///
/// @param dict A json-compatible dictionary representation of the `DBTEAMDeviceSessionArg` API
/// object.
///
