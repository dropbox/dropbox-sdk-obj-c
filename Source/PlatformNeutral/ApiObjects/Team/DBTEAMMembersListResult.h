...
/// 
/// Full constructor for the DBTEAMMembersListResult struct (exposes all
/// instance variables).
/// 
/// @param members List of team members.
/// @param cursor Pass the cursor into :route:`members/list/continue` to obtain
/// the additional members.
/// @param hasMore Is true if there are additional team members that have not
/// been returned yet. An additional call to :route:`members/list/continue` can
/// retrieve them.
/// 
/// @return An initialized DBTEAMMembersListResult instance.
/// 
- (nonnull instancetype)initWithMembers:(NSArray<DBTEAMTeamMemberInfo *> * _Nonnull)members cursor:(NSString * _Nonnull)cursor hasMore:(NSNumber * _Nonnull)hasMore;
