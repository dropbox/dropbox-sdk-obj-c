...
/// 
/// Full constructor for the DBTEAMMembersRemoveArg struct (exposes all instance
/// variables).
/// 
...
/// 
/// @return An initialized DBTEAMMembersRemoveArg instance.
/// 
- (nonnull instancetype)initWithUser:(DBTEAMUserSelectorArg * _Nonnull)user wipeData:(NSNumber * _Nullable)wipeData transferDestId:(DBTEAMUserSelectorArg * _Nullable)transferDestId transferAdminId:(DBTEAMUserSelectorArg * _Nullable)transferAdminId keepAccount:(NSNumber * _Nullable)keepAccount;

/// 
/// Convenience constructor for the DBTEAMMembersRemoveArg struct (exposes only
