...
/// 
/// Full constructor for the DBTEAMMembersAddArg struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithDNewMembers:(NSArray<DBTEAMMemberAddArg *> * _Nonnull)dNewMembers forceAsync:(NSNumber * _Nullable)forceAsync;

/// 
/// Convenience constructor for the DBTEAMMembersAddArg struct (exposes only
