...
/// 
/// Full constructor for the DBTEAMGroupMembersSetAccessTypeArg struct (exposes
...
/// 
- (nonnull instancetype)initWithGroup:(DBTEAMGroupSelector * _Nonnull)group user:(DBTEAMUserSelectorArg * _Nonnull)user accessType:(DBTEAMGroupAccessType * _Nonnull)accessType returnMembers:(NSNumber * _Nullable)returnMembers;

/// 
/// Convenience constructor for the DBTEAMGroupMembersSetAccessTypeArg struct
...
/// @return An initialized DBTEAMGroupMembersSetAccessTypeArg instance.
/// 
- (nonnull instancetype)initWithGroup:(DBTEAMGroupSelector * _Nonnull)group user:(DBTEAMUserSelectorArg * _Nonnull)user accessType:(DBTEAMGroupAccessType * _Nonnull)accessType;
