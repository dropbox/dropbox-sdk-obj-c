...
/// 
/// Full constructor for the DBTEAMCOMMONGroupSummary struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBTEAMCOMMONGroupSummary instance.
/// 
- (nonnull instancetype)initWithGroupName:(NSString * _Nonnull)groupName groupId:(NSString * _Nonnull)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType * _Nonnull)groupManagementType groupExternalId:(NSString * _Nullable)groupExternalId memberCount:(NSNumber * _Nullable)memberCount;

/// 
/// Convenience constructor for the DBTEAMCOMMONGroupSummary struct (exposes
...
/// @return An initialized DBTEAMCOMMONGroupSummary instance.
/// 
- (nonnull instancetype)initWithGroupName:(NSString * _Nonnull)groupName groupId:(NSString * _Nonnull)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType * _Nonnull)groupManagementType;
