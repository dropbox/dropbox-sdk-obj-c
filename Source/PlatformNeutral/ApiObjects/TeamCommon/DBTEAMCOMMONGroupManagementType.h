...
/// The DBTEAMCOMMONGroupManagementTypeTag enum type represents the possible tag
/// states with which the DBTEAMCOMMONGroupManagementType union can exist.
...
/// 
/// About the CompanyManaged tag state: A group which is managed by team admins
/// only.
/// 
