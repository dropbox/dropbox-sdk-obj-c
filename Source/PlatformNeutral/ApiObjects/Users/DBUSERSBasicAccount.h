...
/// 
/// Full constructor for the DBUSERSBasicAccount struct (exposes all instance
/// variables).
/// 
...
/// this account is the current user's account, then this will be :val:`true`.
...
/// 
/// Convenience constructor for the DBUSERSBasicAccount struct (exposes only
...
/// @return An initialized DBUSERSBasicAccount instance.
/// 
- (nonnull instancetype)initWithAccountId:(NSString * _Nonnull)accountId name:(DBUSERSName * _Nonnull)name email:(NSString * _Nonnull)email emailVerified:(NSNumber * _Nonnull)emailVerified disabled:(NSNumber * _Nonnull)disabled isTeammate:(NSNumber * _Nonnull)isTeammate;
