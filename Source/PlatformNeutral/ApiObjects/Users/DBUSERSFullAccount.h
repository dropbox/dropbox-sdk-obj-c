...
/// 
/// Full constructor for the DBUSERSFullAccount struct (exposes all instance
/// variables).
/// 
...
/// the :field:`email_verified` field. Even then, it's possible that the user
...
/// @param referralLink The user's :link:`referral link
/// https://www.dropbox.com/referrals`.
/// @param isPaired Whether the user has a personal and work account. If the
/// current account is personal, then :field:`team` will always be :val:`null`,
...
/// codes are based on :link:`ISO 3166-1
...
/// 
/// @return An initialized DBUSERSFullAccount instance.
/// 
- (nonnull instancetype)initWithAccountId:(NSString * _Nonnull)accountId name:(DBUSERSName * _Nonnull)name email:(NSString * _Nonnull)email emailVerified:(NSNumber * _Nonnull)emailVerified disabled:(NSNumber * _Nonnull)disabled locale:(NSString * _Nonnull)locale referralLink:(NSString * _Nonnull)referralLink isPaired:(NSNumber * _Nonnull)isPaired accountType:(DBUSERSAccountType * _Nonnull)accountType profilePhotoUrl:(NSString * _Nullable)profilePhotoUrl country:(NSString * _Nullable)country team:(DBUSERSFullTeam * _Nullable)team teamMemberId:(NSString * _Nullable)teamMemberId;

/// 
/// Convenience constructor for the DBUSERSFullAccount struct (exposes only
...
/// @return An initialized DBUSERSFullAccount instance.
/// 
- (nonnull instancetype)initWithAccountId:(NSString * _Nonnull)accountId name:(DBUSERSName * _Nonnull)name email:(NSString * _Nonnull)email emailVerified:(NSNumber * _Nonnull)emailVerified disabled:(NSNumber * _Nonnull)disabled locale:(NSString * _Nonnull)locale referralLink:(NSString * _Nonnull)referralLink isPaired:(NSNumber * _Nonnull)isPaired accountType:(DBUSERSAccountType * _Nonnull)accountType;
