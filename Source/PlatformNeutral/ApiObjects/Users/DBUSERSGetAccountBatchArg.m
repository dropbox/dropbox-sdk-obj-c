...
- (instancetype)initWithAccountIds:(NSArray<NSString *> *)accountIds {
    [DBStoneValidators arrayValidator:@(1) maxItems:nil itemValidator:[DBStoneValidators stringValidator:@(40) maxLength:@(40) pattern:nil]](accountIds);
...
+ (NSDictionary *)serialize:(DBUSERSGetAccountBatchArg *)valueObj {
    ...
    jsonDict[@"account_ids"] = [DBArraySerializer serialize:valueObj.accountIds withBlock:^id(id elem) { return elem; }];

    return jsonDict;
}

+ (DBUSERSGetAccountBatchArg *)deserialize:(NSDictionary *)valueDict {
    NSArray<NSString *> *accountIds = [DBArraySerializer deserialize:valueDict[@"account_ids"] withBlock:^id(id elem) { return elem; }];
