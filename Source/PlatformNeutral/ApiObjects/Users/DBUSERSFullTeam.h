...
/// 
/// Full constructor for the DBUSERSFullTeam struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithId_:(NSString * _Nonnull)id_ name:(NSString * _Nonnull)name sharingPolicies:(DBTEAMPOLICIESTeamSharingPolicies * _Nonnull)sharingPolicies;
