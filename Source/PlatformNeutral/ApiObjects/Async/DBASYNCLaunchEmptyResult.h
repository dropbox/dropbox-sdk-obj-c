...
/// The DBASYNCLaunchEmptyResultTag enum type represents the possible tag states
/// with which the DBASYNCLaunchEmptyResult union can exist.
...
/// an id that can be used to obtain the status of the asynchronous job. Ensure
/// the isAsyncJobId method returns true before accessing, otherwise a runtime
...
/// 
/// About the AsyncJobId tag state: This response indicates that the processing
/// is asynchronous. The string is an id that can be used to obtain the status
...
/// 
/// @return An initialized DBASYNCLaunchEmptyResult instance.
/// 
