...
/// 
/// Full constructor for the DBTEAMPOLICIESTeamMemberPolicies struct (exposes
...
/// 
- (nonnull instancetype)initWithSharing:(DBTEAMPOLICIESTeamSharingPolicies * _Nonnull)sharing emmState:(DBTEAMPOLICIESEmmState * _Nonnull)emmState;
