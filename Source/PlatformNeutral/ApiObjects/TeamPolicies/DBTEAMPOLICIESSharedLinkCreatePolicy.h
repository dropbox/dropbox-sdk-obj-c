...
/// unless overridden.
/// 
/// @return An initialized DBTEAMPOLICIESSharedLinkCreatePolicy instance.
/// 
...
/// 
/// About the TeamOnly tag state: Only members of the same team can access newly
/// created shared links. Login will be required to access the shared links.
/// 
/// @return An initialized DBTEAMPOLICIESSharedLinkCreatePolicy instance.
/// 
...
/// 
/// @return Whether the union's current tag state has value DefaultPublic.
/// 
...
/// 
/// @return Whether the union's current tag state has value DefaultTeamOnly.
/// 
...
/// 
/// @param instance An instance of the DBTEAMPOLICIESSharedLinkCreatePolicy API
/// object.
/// 
