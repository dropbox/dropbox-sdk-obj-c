...
/// 
/// Full constructor for the DBAUTHRateLimitError struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithReason:(DBAUTHRateLimitReason * _Nonnull)reason retryAfter:(NSNumber * _Nullable)retryAfter;

/// 
/// Convenience constructor for the DBAUTHRateLimitError struct (exposes only
