...
/// 
/// About the TooManyRequests tag state: You are making too many requests in the
/// past few minutes.
/// 
/// @return An initialized DBAUTHRateLimitReason instance.
/// 
...
/// 
/// @return Whether the union's current tag state has value TooManyRequests.
/// 
