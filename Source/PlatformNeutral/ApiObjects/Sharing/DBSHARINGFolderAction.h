...
/// 
/// About the ChangeOptions tag state: Change folder options, such as who can be
...
/// 
/// About the InviteEditor tag state: Invite a user or group to join the folder
...
/// 
/// About the InviteViewer tag state: Invite a user or group to join the folder
...
/// 
/// About the RelinquishMembership tag state: Relinquish one's own membership in
/// the folder.
/// 
/// @return An initialized DBSHARINGFolderAction instance.
/// 
...
/// 
/// About the LeaveACopy tag state: Keep a copy of the contents upon leaving or
