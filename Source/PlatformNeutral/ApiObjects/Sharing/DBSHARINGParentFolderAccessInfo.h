...
/// 
/// Full constructor for the DBSHARINGParentFolderAccessInfo struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithFolderName:(NSString * _Nonnull)folderName sharedFolderId:(NSString * _Nonnull)sharedFolderId permissions:(NSArray<DBSHARINGMemberPermission *> * _Nonnull)permissions;
