...
/// 
/// Full constructor for the DBSHARINGMemberPermission struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithAction:(DBSHARINGMemberAction * _Nonnull)action allow:(NSNumber * _Nonnull)allow reason:(DBSHARINGPermissionDeniedReason * _Nullable)reason;

/// 
/// Convenience constructor for the DBSHARINGMemberPermission struct (exposes
