...
///
/// Full constructor for the DBSHARINGMemberPermission struct (exposes all instance variables).
///
...
/// allowed
///
/// @return An initialized DBSHARINGMemberPermission instance.
///
...
///
/// Convenience constructor for the DBSHARINGMemberPermission struct (exposes only non-nullable
...
///
/// @return A json-compatible dictionary representation of the DBSHARINGMemberPermission API object.
///
...
///
/// @param dict A json-compatible dictionary representation of the DBSHARINGMemberPermission API
/// object.
///
