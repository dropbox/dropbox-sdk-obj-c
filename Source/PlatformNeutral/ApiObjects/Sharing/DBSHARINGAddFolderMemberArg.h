...
/// 
/// Full constructor for the DBSHARINGAddFolderMemberArg struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId members:(NSArray<DBSHARINGAddMember *> * _Nonnull)members quiet:(NSNumber * _Nullable)quiet customMessage:(NSString * _Nullable)customMessage;

/// 
/// Convenience constructor for the DBSHARINGAddFolderMemberArg struct (exposes
...
/// @return An initialized DBSHARINGAddFolderMemberArg instance.
/// 
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId members:(NSArray<DBSHARINGAddMember *> * _Nonnull)members;
