...
- (DBFILESLookupError *)path {
    if (![self isPath]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBSHARINGCreateSharedLinkWithSettingsErrorPath, but was %@.", [self tagName]];
    }
    return _path;
}
...
- (DBSHARINGSharedLinkSettingsError *)settingsError {
    if (![self isSettingsError]) {
        [NSException raise:@"IllegalStateException" format:@"Invalid tag: required DBSHARINGCreateSharedLinkWithSettingsErrorSettingsError, but was %@.", [self tagName]];
    }
...
+ (NSDictionary *)serialize:(DBSHARINGCreateSharedLinkWithSettingsError *)valueObj {
    ...
    if ([valueObj isPath]) {
        ...
        jsonDict = [[DBSHARINGSharedLinkSettingsErrorSerializer serialize:valueObj.settingsError] mutableCopy];
...
+ (DBSHARINGCreateSharedLinkWithSettingsError *)deserialize:(NSDictionary *)valueDict {
    ...
    if ([tag isEqualToString:@"path"]) {
        ...
        DBSHARINGSharedLinkSettingsError *settingsError = [DBSHARINGSharedLinkSettingsErrorSerializer deserialize:valueDict[@"settings_error"]];
