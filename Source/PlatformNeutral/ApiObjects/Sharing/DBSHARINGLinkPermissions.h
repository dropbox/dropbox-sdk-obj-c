...
/// 
/// Full constructor for the DBSHARINGLinkPermissions struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithCanRevoke:(NSNumber * _Nonnull)canRevoke resolvedVisibility:(DBSHARINGResolvedVisibility * _Nullable)resolvedVisibility requestedVisibility:(DBSHARINGRequestedVisibility * _Nullable)requestedVisibility revokeFailureReason:(DBSHARINGSharedLinkAccessFailureReason * _Nullable)revokeFailureReason;

/// 
/// Convenience constructor for the DBSHARINGLinkPermissions struct (exposes
