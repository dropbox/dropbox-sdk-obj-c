...
/// The DBSHARINGPermissionDeniedReasonTag enum type represents the possible tag
/// states with which the DBSHARINGPermissionDeniedReason union can exist.
...
/// 
/// About the UserNotSameTeamAsOwner tag state: User is not on the same team as
/// the folder owner.
/// 
...
/// 
/// About the TargetIsIndirectMember tag state: Target is indirectly a member of
