...
/// 
/// Full constructor for the DBSHARINGGetFileMetadataBatchResult struct (exposes
...
/// 
- (nonnull instancetype)initWithFile:(NSString * _Nonnull)file result:(DBSHARINGGetFileMetadataIndividualResult * _Nonnull)result;
