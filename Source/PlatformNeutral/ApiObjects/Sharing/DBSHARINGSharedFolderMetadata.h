...
/// 
/// Full constructor for the DBSHARINGSharedFolderMetadata struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType isTeamFolder:(NSNumber * _Nonnull)isTeamFolder policy:(DBSHARINGFolderPolicy * _Nonnull)policy name:(NSString * _Nonnull)name sharedFolderId:(NSString * _Nonnull)sharedFolderId timeInvited:(NSDate * _Nonnull)timeInvited previewUrl:(NSString * _Nonnull)previewUrl ownerTeam:(DBUSERSTeam * _Nullable)ownerTeam parentSharedFolderId:(NSString * _Nullable)parentSharedFolderId pathLower:(NSString * _Nullable)pathLower permissions:(NSArray<DBSHARINGFolderPermission *> * _Nullable)permissions;

/// 
/// Convenience constructor for the DBSHARINGSharedFolderMetadata struct
