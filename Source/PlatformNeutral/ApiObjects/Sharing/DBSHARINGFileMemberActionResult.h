...
/// 
/// Full constructor for the DBSHARINGFileMemberActionResult struct (exposes all
/// instance variables).
/// 
/// @param member One of specified input members.
/// @param result The outcome of the action on this member.
/// 
/// @return An initialized DBSHARINGFileMemberActionResult instance.
/// 
- (nonnull instancetype)initWithMember:(DBSHARINGMemberSelector * _Nonnull)member result:(DBSHARINGFileMemberActionIndividualResult * _Nonnull)result;
