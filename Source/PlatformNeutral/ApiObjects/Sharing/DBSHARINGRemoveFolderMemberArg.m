...
- (instancetype)initWithSharedFolderId:(NSString *)sharedFolderId member:(DBSHARINGMemberSelector *)member leaveACopy:(NSNumber *)leaveACopy {
...
+ (DBSHARINGRemoveFolderMemberArg *)deserialize:(NSDictionary *)valueDict {
    ...
    return [[DBSHARINGRemoveFolderMemberArg alloc] initWithSharedFolderId:sharedFolderId member:member leaveACopy:leaveACopy];
}
