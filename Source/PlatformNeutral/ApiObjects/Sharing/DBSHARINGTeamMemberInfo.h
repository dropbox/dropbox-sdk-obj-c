...
/// 
/// Full constructor for the DBSHARINGTeamMemberInfo struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithTeamInfo:(DBUSERSTeam * _Nonnull)teamInfo displayName:(NSString * _Nonnull)displayName memberId:(NSString * _Nullable)memberId;

/// 
/// Convenience constructor for the DBSHARINGTeamMemberInfo struct (exposes only
