...
/// possible tag states with which the DBSHARINGListFileMembersIndividualResult
/// union can exist.
...
/// The results of the query for this file if it was successful Ensure the
/// isResult method returns true before accessing, otherwise a runtime exception
/// will be raised.
@property (nonatomic, readonly) DBSHARINGListFileMembersCountResult * _Nonnull result;

/// The result of the query for this file if it was an error. Ensure the
...
/// 
/// About the Result tag state: The results of the query for this file if it was
/// successful
/// 
...
/// 
/// About the AccessError tag state: The result of the query for this file if it
/// was an error.
/// 
...
/// 
/// @param instance An instance of the DBSHARINGListFileMembersIndividualResult
/// API object.
/// 
