...
- (instancetype)initWithAccessType:(DBSHARINGAccessLevel *)accessType isTeamFolder:(NSNumber *)isTeamFolder policy:(DBSHARINGFolderPolicy *)policy name:(NSString *)name sharedFolderId:(NSString *)sharedFolderId timeInvited:(NSDate *)timeInvited previewUrl:(NSString *)previewUrl {
...
+ (NSDictionary *)serialize:(DBSHARINGSharedFolderMetadata *)valueObj {
    ...
    if (valueObj.permissions) {
        jsonDict[@"permissions"] = [DBArraySerializer serialize:valueObj.permissions withBlock:^id(id elem) { return [DBSHARINGFolderPermissionSerializer serialize:elem]; }];
    }
...
+ (DBSHARINGSharedFolderMetadata *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBSHARINGFolderPermission *> *permissions = valueDict[@"permissions"] ? [DBArraySerializer deserialize:valueDict[@"permissions"] withBlock:^id(id elem) { return [DBSHARINGFolderPermissionSerializer deserialize:elem]; }] : nil;

    return [[DBSHARINGSharedFolderMetadata alloc] initWithAccessType:accessType isTeamFolder:isTeamFolder policy:policy name:name sharedFolderId:sharedFolderId timeInvited:timeInvited previewUrl:previewUrl ownerTeam:ownerTeam parentSharedFolderId:parentSharedFolderId pathLower:pathLower permissions:permissions];
}
