...
/// 
/// Full constructor for the DBSHARINGGroupInfo struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithGroupName:(NSString * _Nonnull)groupName groupId:(NSString * _Nonnull)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType * _Nonnull)groupManagementType groupType:(DBTEAMCOMMONGroupType * _Nonnull)groupType isOwner:(NSNumber * _Nonnull)isOwner sameTeam:(NSNumber * _Nonnull)sameTeam groupExternalId:(NSString * _Nullable)groupExternalId memberCount:(NSNumber * _Nullable)memberCount;

/// 
/// Convenience constructor for the DBSHARINGGroupInfo struct (exposes only
...
/// @return An initialized DBSHARINGGroupInfo instance.
/// 
- (nonnull instancetype)initWithGroupName:(NSString * _Nonnull)groupName groupId:(NSString * _Nonnull)groupId groupManagementType:(DBTEAMCOMMONGroupManagementType * _Nonnull)groupManagementType groupType:(DBTEAMCOMMONGroupType * _Nonnull)groupType isOwner:(NSNumber * _Nonnull)isOwner sameTeam:(NSNumber * _Nonnull)sameTeam;
