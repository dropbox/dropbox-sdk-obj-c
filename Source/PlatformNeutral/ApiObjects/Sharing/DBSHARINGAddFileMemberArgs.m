...
- (instancetype)initWithFile:(NSString *)file members:(NSArray<DBSHARINGMemberSelector *> *)members customMessage:(NSString *)customMessage quiet:(NSNumber *)quiet accessLevel:(DBSHARINGAccessLevel *)accessLevel addMessageAsComment:(NSNumber *)addMessageAsComment {
...
+ (NSDictionary *)serialize:(DBSHARINGAddFileMemberArgs *)valueObj {
    ...
    jsonDict[@"members"] = [DBArraySerializer serialize:valueObj.members withBlock:^id(id elem) { return [DBSHARINGMemberSelectorSerializer serialize:elem]; }];
...
+ (DBSHARINGAddFileMemberArgs *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBSHARINGMemberSelector *> *members = [DBArraySerializer deserialize:valueDict[@"members"] withBlock:^id(id elem) { return [DBSHARINGMemberSelectorSerializer deserialize:elem]; }];
    ...
    return [[DBSHARINGAddFileMemberArgs alloc] initWithFile:file members:members customMessage:customMessage quiet:quiet accessLevel:accessLevel addMessageAsComment:addMessageAsComment];
}
