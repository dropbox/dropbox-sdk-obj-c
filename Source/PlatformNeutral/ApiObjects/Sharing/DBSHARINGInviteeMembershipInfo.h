...
/// 
/// Full constructor for the DBSHARINGInviteeMembershipInfo struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType invitee:(DBSHARINGInviteeInfo * _Nonnull)invitee permissions:(NSArray<DBSHARINGMemberPermission *> * _Nullable)permissions initials:(NSString * _Nullable)initials isInherited:(NSNumber * _Nullable)isInherited user:(DBSHARINGUserInfo * _Nullable)user;

/// 
/// Convenience constructor for the DBSHARINGInviteeMembershipInfo struct
...
/// @return An initialized DBSHARINGInviteeMembershipInfo instance.
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType invitee:(DBSHARINGInviteeInfo * _Nonnull)invitee;
