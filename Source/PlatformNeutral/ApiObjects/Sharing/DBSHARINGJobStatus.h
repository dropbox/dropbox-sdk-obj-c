...
/// The DBSHARINGJobStatusTag enum type represents the possible tag states with
/// which the DBSHARINGJobStatus union can exist.
...
/// The asynchronous job returned an error. Ensure the isFailed method returns
