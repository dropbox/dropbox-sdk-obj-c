...
/// The DBSHARINGGetSharedLinkFileErrorTag enum type represents the possible tag
/// states with which the DBSHARINGGetSharedLinkFileError union can exist.
...
/// 
/// @return An initialized DBSHARINGGetSharedLinkFileError instance.
/// 
