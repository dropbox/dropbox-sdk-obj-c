...
///
/// Full constructor for the DBSHARINGLinkMetadata struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBSHARINGLinkMetadata struct (exposes only non-nullable instance
...
///
/// @param dict A json-compatible dictionary representation of the DBSHARINGLinkMetadata API object.
///
