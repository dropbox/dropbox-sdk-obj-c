...
/// 
/// Full constructor for the DBSHARINGPathLinkMetadata struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBSHARINGPathLinkMetadata instance.
/// 
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url visibility:(DBSHARINGVisibility * _Nonnull)visibility path:(NSString * _Nonnull)path expires:(NSDate * _Nullable)expires;

/// 
/// Convenience constructor for the DBSHARINGPathLinkMetadata struct (exposes
...
/// @return An initialized DBSHARINGPathLinkMetadata instance.
/// 
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url visibility:(DBSHARINGVisibility * _Nonnull)visibility path:(NSString * _Nonnull)path;
