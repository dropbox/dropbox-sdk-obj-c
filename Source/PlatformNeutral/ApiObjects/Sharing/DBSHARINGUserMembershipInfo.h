...
/// 
/// Full constructor for the DBSHARINGUserMembershipInfo struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType user:(DBSHARINGUserInfo * _Nonnull)user permissions:(NSArray<DBSHARINGMemberPermission *> * _Nullable)permissions initials:(NSString * _Nullable)initials isInherited:(NSNumber * _Nullable)isInherited;

/// 
/// Convenience constructor for the DBSHARINGUserMembershipInfo struct (exposes
...
/// @return An initialized DBSHARINGUserMembershipInfo instance.
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType user:(DBSHARINGUserInfo * _Nonnull)user;
