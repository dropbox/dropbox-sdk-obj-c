...
/// 
/// Full constructor for the DBSHARINGListFolderMembersCursorArg struct (exposes
...
/// 
- (nonnull instancetype)initWithActions:(NSArray<DBSHARINGMemberAction *> * _Nullable)actions limit:(NSNumber * _Nullable)limit;

/// 
/// Convenience constructor for the DBSHARINGListFolderMembersCursorArg struct
