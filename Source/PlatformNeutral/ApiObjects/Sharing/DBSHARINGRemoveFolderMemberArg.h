...
/// 
/// Full constructor for the DBSHARINGRemoveFolderMemberArg struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId member:(DBSHARINGMemberSelector * _Nonnull)member leaveACopy:(NSNumber * _Nonnull)leaveACopy;
