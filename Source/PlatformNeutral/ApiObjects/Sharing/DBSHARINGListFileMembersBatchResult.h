...
/// 
/// Full constructor for the DBSHARINGListFileMembersBatchResult struct (exposes
...
/// 
- (nonnull instancetype)initWithFile:(NSString * _Nonnull)file result:(DBSHARINGListFileMembersIndividualResult * _Nonnull)result;
