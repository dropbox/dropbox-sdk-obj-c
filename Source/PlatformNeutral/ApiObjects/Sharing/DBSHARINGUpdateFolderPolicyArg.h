...
/// 
/// Full constructor for the DBSHARINGUpdateFolderPolicyArg struct (exposes all
/// instance variables).
/// 
...
/// this policy to :field:`SharedLinkPolicy.members`.
/// 
/// @return An initialized DBSHARINGUpdateFolderPolicyArg instance.
/// 
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId memberPolicy:(DBSHARINGMemberPolicy * _Nullable)memberPolicy aclUpdatePolicy:(DBSHARINGAclUpdatePolicy * _Nullable)aclUpdatePolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy * _Nullable)sharedLinkPolicy;

/// 
/// Convenience constructor for the DBSHARINGUpdateFolderPolicyArg struct
