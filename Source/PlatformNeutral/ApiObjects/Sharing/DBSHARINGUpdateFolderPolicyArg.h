...
/// user must be on a team to set this policy to members in SharedLinkPolicy.
@property(nonatomic, readonly) DBSHARINGSharedLinkPolicy * _Nullable sharedLinkPolicy;

#pragma mark - Constructors

///
/// Full constructor for the DBSHARINGUpdateFolderPolicyArg struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBSHARINGUpdateFolderPolicyArg struct (exposes only non-nullable
