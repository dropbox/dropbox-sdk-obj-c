...
/// The DBSHARINGSharingFileAccessErrorTag enum type represents the possible tag
/// states with which the DBSHARINGSharingFileAccessError union can exist.
...
/// 
/// About the IsFolder tag state: A folder can't be shared this way. Use folder
...
/// 
/// About the InsidePublicFolder tag state: A file inside a public folder can't
