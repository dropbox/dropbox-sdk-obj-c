...
/// The DBSHARINGFileErrorResultTag enum type represents the possible tag states
/// with which the DBSHARINGFileErrorResult union can exist.
...
/// File specified by id was not found. Ensure the isFileNotFoundError method
/// returns true before accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly, copy) NSString * _Nonnull fileNotFoundError;

/// User does not have permission to take the specified action on the file.
/// Ensure the isInvalidFileActionError method returns true before accessing,
/// otherwise a runtime exception will be raised.
@property (nonatomic, readonly, copy) NSString * _Nonnull invalidFileActionError;

/// User does not have permission to access file specified by file.Id. Ensure
/// the isPermissionDeniedError method returns true before accessing, otherwise
...
/// 
/// About the InvalidFileActionError tag state: User does not have permission to
...
/// 
/// About the PermissionDeniedError tag state: User does not have permission to
