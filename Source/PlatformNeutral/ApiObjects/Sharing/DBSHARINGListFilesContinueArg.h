...
/// 
/// Full constructor for the DBSHARINGListFilesContinueArg struct (exposes all
/// instance variables).
/// 
/// @param cursor Cursor in :field:`ListFilesResult.cursor`
/// 
/// @return An initialized DBSHARINGListFilesContinueArg instance.
/// 
