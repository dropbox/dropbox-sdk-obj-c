...
/// 
/// Full constructor for the DBSHARINGSharedFileMetadata struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithPolicy:(DBSHARINGFolderPolicy * _Nonnull)policy previewUrl:(NSString * _Nonnull)previewUrl name:(NSString * _Nonnull)name id_:(NSString * _Nonnull)id_ permissions:(NSArray<DBSHARINGFilePermission *> * _Nullable)permissions ownerTeam:(DBUSERSTeam * _Nullable)ownerTeam parentSharedFolderId:(NSString * _Nullable)parentSharedFolderId pathLower:(NSString * _Nullable)pathLower pathDisplay:(NSString * _Nullable)pathDisplay;

/// 
/// Convenience constructor for the DBSHARINGSharedFileMetadata struct (exposes
...
/// @return An initialized DBSHARINGSharedFileMetadata instance.
/// 
- (nonnull instancetype)initWithPolicy:(DBSHARINGFolderPolicy * _Nonnull)policy previewUrl:(NSString * _Nonnull)previewUrl name:(NSString * _Nonnull)name id_:(NSString * _Nonnull)id_;
