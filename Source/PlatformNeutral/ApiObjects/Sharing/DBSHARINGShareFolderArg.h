...
/// 
/// Full constructor for the DBSHARINGShareFolderArg struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBSHARINGShareFolderArg instance.
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path memberPolicy:(DBSHARINGMemberPolicy * _Nullable)memberPolicy aclUpdatePolicy:(DBSHARINGAclUpdatePolicy * _Nullable)aclUpdatePolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy * _Nullable)sharedLinkPolicy forceAsync:(NSNumber * _Nullable)forceAsync;

/// 
/// Convenience constructor for the DBSHARINGShareFolderArg struct (exposes only
