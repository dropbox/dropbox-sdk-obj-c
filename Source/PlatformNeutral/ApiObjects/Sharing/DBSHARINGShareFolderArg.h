...
///
/// Full constructor for the DBSHARINGShareFolderArg struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBSHARINGShareFolderArg struct (exposes only non-nullable
