...
///
/// Full constructor for the DBSHARINGGetFileMetadataArg struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBSHARINGGetFileMetadataArg struct (exposes only non-nullable
