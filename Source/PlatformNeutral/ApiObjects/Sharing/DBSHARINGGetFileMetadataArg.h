...
/// 
/// Full constructor for the DBSHARINGGetFileMetadataArg struct (exposes all
/// instance variables).
/// 
/// @param file The file to query.
/// @param actions File actions to query.
/// 
/// @return An initialized DBSHARINGGetFileMetadataArg instance.
/// 
- (nonnull instancetype)initWithFile:(NSString * _Nonnull)file actions:(NSArray<DBSHARINGFileAction *> * _Nullable)actions;

/// 
/// Convenience constructor for the DBSHARINGGetFileMetadataArg struct (exposes
