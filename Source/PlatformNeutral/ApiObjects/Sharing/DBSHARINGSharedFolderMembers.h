...
/// 
/// Full constructor for the DBSHARINGSharedFolderMembers struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithUsers:(NSArray<DBSHARINGUserMembershipInfo *> * _Nonnull)users groups:(NSArray<DBSHARINGGroupMembershipInfo *> * _Nonnull)groups invitees:(NSArray<DBSHARINGInviteeMembershipInfo *> * _Nonnull)invitees cursor:(NSString * _Nullable)cursor;

/// 
/// Convenience constructor for the DBSHARINGSharedFolderMembers struct (exposes
...
/// @return An initialized DBSHARINGSharedFolderMembers instance.
/// 
- (nonnull instancetype)initWithUsers:(NSArray<DBSHARINGUserMembershipInfo *> * _Nonnull)users groups:(NSArray<DBSHARINGGroupMembershipInfo *> * _Nonnull)groups invitees:(NSArray<DBSHARINGInviteeMembershipInfo *> * _Nonnull)invitees;
