...
/// Unable to access shared folder. Ensure the isAccessError method returns true
/// before accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) DBSHARINGSharedFolderAccessError * _Nonnull accessError;

/// members in AddFolderMemberArg contains a bad invitation recipient. Ensure
/// the isBadMember method returns true before accessing, otherwise a runtime
/// exception will be raised.
@property (nonatomic, readonly) DBSHARINGAddMemberSelectorError * _Nonnull badMember;

/// The value is the member limit that was reached. Ensure the isTooManyMembers
/// method returns true before accessing, otherwise a runtime exception will be
/// raised.
@property (nonatomic, readonly, copy) NSNumber * _Nonnull tooManyMembers;

/// The value is the pending invite limit that was reached. Ensure the
...
/// 
/// About the BadMember tag state: :field:`AddFolderMemberArg.members` contains
/// a bad invitation recipient.
/// 
/// @param badMember :field:`AddFolderMemberArg.members` contains a bad
...
/// 
/// About the RateLimit tag state: The current user has hit the limit of invites
