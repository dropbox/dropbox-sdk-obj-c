...
+ (DBSHARINGFolderLinkMetadata *)deserialize:(NSDictionary *)valueDict {
    ...
    return [[DBSHARINGFolderLinkMetadata alloc] initWithUrl:url name:name linkPermissions:linkPermissions id_:id_ expires:expires pathLower:pathLower teamMemberInfo:teamMemberInfo contentOwnerTeamInfo:contentOwnerTeamInfo];
}
