...
/// 
/// Full constructor for the DBSHARINGListSharedLinksResult struct (exposes all
/// instance variables).
/// 
...
/// retrieve them.
/// @param cursor Pass the cursor into :route:`list_shared_links` to obtain the
...
/// 
- (nonnull instancetype)initWithLinks:(NSArray<DBSHARINGSharedLinkMetadata *> * _Nonnull)links hasMore:(NSNumber * _Nonnull)hasMore cursor:(NSString * _Nullable)cursor;

/// 
/// Convenience constructor for the DBSHARINGListSharedLinksResult struct
...
/// @return An initialized DBSHARINGListSharedLinksResult instance.
/// 
- (nonnull instancetype)initWithLinks:(NSArray<DBSHARINGSharedLinkMetadata *> * _Nonnull)links hasMore:(NSNumber * _Nonnull)hasMore;
