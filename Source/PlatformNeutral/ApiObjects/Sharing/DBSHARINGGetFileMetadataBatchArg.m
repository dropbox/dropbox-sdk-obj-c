...
+ (NSDictionary *)serialize:(DBSHARINGGetFileMetadataBatchArg *)valueObj {
    ...
    if (valueObj.actions) {
        jsonDict[@"actions"] = [DBArraySerializer serialize:valueObj.actions withBlock:^id(id elem) { return [DBSHARINGFileActionSerializer serialize:elem]; }];
    }
...
+ (DBSHARINGGetFileMetadataBatchArg *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBSHARINGFileAction *> *actions = valueDict[@"actions"] ? [DBArraySerializer deserialize:valueDict[@"actions"] withBlock:^id(id elem) { return [DBSHARINGFileActionSerializer deserialize:elem]; }] : nil;
