...
/// tag states with which the DBSHARINGSharedFolderMemberError union can exist.
...
/// The target member only has inherited access to the shared folder. Ensure the
/// isNoExplicitAccess method returns true before accessing, otherwise a runtime
...
/// 
/// @return An initialized DBSHARINGSharedFolderMemberError instance.
/// 
...
/// 
/// About the NotAMember tag state: The target dropbox_id is not a member of the
/// shared folder.
/// 
/// @return An initialized DBSHARINGSharedFolderMemberError instance.
/// 
