...
/// 
/// Full constructor for the DBSHARINGFolderPolicy struct (exposes all instance
/// variables).
/// 
...
/// 
- (nonnull instancetype)initWithAclUpdatePolicy:(DBSHARINGAclUpdatePolicy * _Nonnull)aclUpdatePolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy * _Nonnull)sharedLinkPolicy memberPolicy:(DBSHARINGMemberPolicy * _Nullable)memberPolicy resolvedMemberPolicy:(DBSHARINGMemberPolicy * _Nullable)resolvedMemberPolicy;

/// 
/// Convenience constructor for the DBSHARINGFolderPolicy struct (exposes only
...
/// @return An initialized DBSHARINGFolderPolicy instance.
/// 
- (nonnull instancetype)initWithAclUpdatePolicy:(DBSHARINGAclUpdatePolicy * _Nonnull)aclUpdatePolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy * _Nonnull)sharedLinkPolicy;
