...
/// 
/// Full constructor for the DBSHARINGModifySharedLinkSettingsArgs struct
...
/// link.
/// 
/// @return An initialized DBSHARINGModifySharedLinkSettingsArgs instance.
/// 
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url settings:(DBSHARINGSharedLinkSettings * _Nonnull)settings removeExpiration:(NSNumber * _Nullable)removeExpiration;

/// 
/// Convenience constructor for the DBSHARINGModifySharedLinkSettingsArgs struct
...
/// 
/// @param instance An instance of the DBSHARINGModifySharedLinkSettingsArgs API
/// object.
/// 
