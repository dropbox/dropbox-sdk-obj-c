...
/// 
/// Full constructor for the DBSHARINGMembershipInfo struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType permissions:(NSArray<DBSHARINGMemberPermission *> * _Nullable)permissions initials:(NSString * _Nullable)initials isInherited:(NSNumber * _Nullable)isInherited;

/// 
/// Convenience constructor for the DBSHARINGMembershipInfo struct (exposes only
