...
/// The DBSHARINGMemberSelectorTag enum type represents the possible tag states
/// with which the DBSHARINGMemberSelector union can exist.
...
/// Dropbox account, team member, or group ID of member. Ensure the isDropboxId
/// method returns true before accessing, otherwise a runtime exception will be
/// raised.
@property (nonatomic, readonly, copy) NSString * _Nonnull dropboxId;

/// E-mail address of member. Ensure the isEmail method returns true before
...
/// 
/// About the DropboxId tag state: Dropbox account, team member, or group ID of
/// member.
/// 
