...
/// possible tag states with which the DBSHARINGGetFileMetadataIndividualResult
/// union can exist.
...
/// The result for this file if it was successful. Ensure the isMetadata method
/// returns true before accessing, otherwise a runtime exception will be raised.
@property (nonatomic, readonly) DBSHARINGSharedFileMetadata * _Nonnull metadata;

/// The result for this file if it was an error. Ensure the isAccessError method
/// returns true before accessing, otherwise a runtime exception will be raised.
...
/// 
/// About the Metadata tag state: The result for this file if it was successful.
/// 
/// @param metadata The result for this file if it was successful.
/// 
/// @return An initialized DBSHARINGGetFileMetadataIndividualResult instance.
/// 
...
/// 
/// @param instance An instance of the DBSHARINGGetFileMetadataIndividualResult
/// API object.
/// 
