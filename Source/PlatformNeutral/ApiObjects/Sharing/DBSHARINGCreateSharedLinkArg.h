...
/// 
/// Full constructor for the DBSHARINGCreateSharedLinkArg struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path shortUrl:(NSNumber * _Nullable)shortUrl pendingUpload:(DBSHARINGPendingUploadMode * _Nullable)pendingUpload;

/// 
/// Convenience constructor for the DBSHARINGCreateSharedLinkArg struct (exposes
