...
- (instancetype)initWithAccessType:(DBSHARINGAccessLevel *)accessType isTeamFolder:(NSNumber *)isTeamFolder policy:(DBSHARINGFolderPolicy *)policy ownerTeam:(DBUSERSTeam *)ownerTeam parentSharedFolderId:(NSString *)parentSharedFolderId {
...
- (instancetype)initWithAccessType:(DBSHARINGAccessLevel *)accessType isTeamFolder:(NSNumber *)isTeamFolder policy:(DBSHARINGFolderPolicy *)policy {
...
+ (DBSHARINGSharedFolderMetadataBase *)deserialize:(NSDictionary *)valueDict {
    ...
    return [[DBSHARINGSharedFolderMetadataBase alloc] initWithAccessType:accessType isTeamFolder:isTeamFolder policy:policy ownerTeam:ownerTeam parentSharedFolderId:parentSharedFolderId];
}
