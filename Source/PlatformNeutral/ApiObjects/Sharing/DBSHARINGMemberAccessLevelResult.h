...
/// 
/// Full constructor for the DBSHARINGMemberAccessLevelResult struct (exposes
...
/// 
- (nonnull instancetype)initWithAccessLevel:(DBSHARINGAccessLevel * _Nullable)accessLevel warning:(NSString * _Nullable)warning accessDetails:(NSArray<DBSHARINGParentFolderAccessInfo *> * _Nullable)accessDetails;

/// 
/// Convenience constructor for the DBSHARINGMemberAccessLevelResult struct
