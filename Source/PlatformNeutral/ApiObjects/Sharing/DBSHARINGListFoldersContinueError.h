...
/// tag states with which the DBSHARINGListFoldersContinueError union can exist.
...
/// 
/// About the InvalidCursor tag state: :field:`ListFoldersContinueArg.cursor` is
/// invalid.
/// 
/// @return An initialized DBSHARINGListFoldersContinueError instance.
/// 
