...
+ (NSDictionary *)serialize:(DBSHARINGListFoldersResult *)valueObj {
    ...
    jsonDict[@"entries"] = [DBArraySerializer serialize:valueObj.entries withBlock:^id(id elem) { return [DBSHARINGSharedFolderMetadataSerializer serialize:elem]; }];
    if (valueObj.cursor) {
...
+ (DBSHARINGListFoldersResult *)deserialize:(NSDictionary *)valueDict {
    NSArray<DBSHARINGSharedFolderMetadata *> *entries = [DBArraySerializer deserialize:valueDict[@"entries"] withBlock:^id(id elem) { return [DBSHARINGSharedFolderMetadataSerializer deserialize:elem]; }];
