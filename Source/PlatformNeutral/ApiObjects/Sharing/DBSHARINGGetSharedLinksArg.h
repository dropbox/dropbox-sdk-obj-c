...
///
/// Full constructor for the DBSHARINGGetSharedLinksArg struct (exposes all instance variables).
///
/// @param path See :route:`get_shared_links` description.
///
/// @return An initialized DBSHARINGGetSharedLinksArg instance.
///
- (nonnull instancetype)initWithPath:(NSString * _Nullable)path;

///
/// Convenience constructor for the DBSHARINGGetSharedLinksArg struct (exposes only non-nullable
...
///
/// @return A json-compatible dictionary representation of the DBSHARINGGetSharedLinksArg API
/// object.
///
...
///
/// @param dict A json-compatible dictionary representation of the DBSHARINGGetSharedLinksArg API
/// object.
///
