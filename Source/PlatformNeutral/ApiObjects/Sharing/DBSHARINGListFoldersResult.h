...
/// 
/// Full constructor for the DBSHARINGListFoldersResult struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithEntries:(NSArray<DBSHARINGSharedFolderMetadata *> * _Nonnull)entries cursor:(NSString * _Nullable)cursor;

/// 
/// Convenience constructor for the DBSHARINGListFoldersResult struct (exposes
