...
+ (NSDictionary *)serialize:(DBSHARINGGetMetadataArgs *)valueObj {
    ...
    if (valueObj.actions) {
        jsonDict[@"actions"] = [DBArraySerializer serialize:valueObj.actions withBlock:^id(id elem) { return [DBSHARINGFolderActionSerializer serialize:elem]; }];
    }
...
+ (DBSHARINGGetMetadataArgs *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBSHARINGFolderAction *> *actions = valueDict[@"actions"] ? [DBArraySerializer deserialize:valueDict[@"actions"] withBlock:^id(id elem) { return [DBSHARINGFolderActionSerializer deserialize:elem]; }] : nil;
