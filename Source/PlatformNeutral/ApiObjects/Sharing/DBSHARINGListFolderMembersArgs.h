...
///
/// Full constructor for the DBSHARINGListFolderMembersArgs struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBSHARINGListFolderMembersArgs struct (exposes only non-nullable
