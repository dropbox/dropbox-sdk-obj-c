...
/// 
/// Full constructor for the DBSHARINGListFolderMembersArgs struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBSHARINGListFolderMembersArgs instance.
/// 
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId actions:(NSArray<DBSHARINGMemberAction *> * _Nullable)actions limit:(NSNumber * _Nullable)limit;

/// 
/// Convenience constructor for the DBSHARINGListFolderMembersArgs struct
