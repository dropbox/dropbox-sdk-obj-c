...
/// 
/// Full constructor for the DBSHARINGUserInfo struct (exposes all instance
/// variables).
/// 
...
/// 
/// Convenience constructor for the DBSHARINGUserInfo struct (exposes only
...
/// 
/// @return A json-compatible dictionary representation of the DBSHARINGUserInfo
/// API object.
/// 
