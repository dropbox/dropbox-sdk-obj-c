...
/// 
/// Full constructor for the DBSHARINGAddMember struct (exposes all instance
/// variables).
/// 
/// @param member The member to add to the shared folder.
/// @param accessLevel The access level to grant :field:`member` to the shared
/// folder.  :field:`AccessLevel.owner` is disallowed.
/// 
/// @return An initialized DBSHARINGAddMember instance.
/// 
- (nonnull instancetype)initWithMember:(DBSHARINGMemberSelector * _Nonnull)member accessLevel:(DBSHARINGAccessLevel * _Nullable)accessLevel;

/// 
/// Convenience constructor for the DBSHARINGAddMember struct (exposes only
