...
/// The current user does not have enough space to mount the shared folder.
/// Ensure the isInsufficientQuota method returns true before accessing,
...
/// 
/// About the InsideSharedFolder tag state: Mounting would cause a shared folder
/// to be inside another, which is disallowed.
/// 
/// @return An initialized DBSHARINGMountFolderError instance.
/// 
...
/// 
/// About the InsufficientQuota tag state: The current user does not have enough
