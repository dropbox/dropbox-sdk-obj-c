...
/// 
/// Full constructor for the DBSHARINGChangeFileMemberAccessArgs struct (exposes
...
/// 
- (nonnull instancetype)initWithFile:(NSString * _Nonnull)file member:(DBSHARINGMemberSelector * _Nonnull)member accessLevel:(DBSHARINGAccessLevel * _Nonnull)accessLevel;
