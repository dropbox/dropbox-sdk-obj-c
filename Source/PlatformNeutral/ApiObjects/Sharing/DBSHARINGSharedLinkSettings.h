...
/// 
/// Full constructor for the DBSHARINGSharedLinkSettings struct (exposes all
/// instance variables).
/// 
/// @param requestedVisibility The requested access for this shared link.
/// @param linkPassword If :field:`requested_visibility` is
...
/// 
- (nonnull instancetype)initWithRequestedVisibility:(DBSHARINGRequestedVisibility * _Nullable)requestedVisibility linkPassword:(NSString * _Nullable)linkPassword expires:(NSDate * _Nullable)expires;

/// 
/// Convenience constructor for the DBSHARINGSharedLinkSettings struct (exposes
