...
/// 
/// Full constructor for the DBSHARINGFilePermission struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithAction:(DBSHARINGFileAction * _Nonnull)action allow:(NSNumber * _Nonnull)allow reason:(DBSHARINGPermissionDeniedReason * _Nullable)reason;

/// 
/// Convenience constructor for the DBSHARINGFilePermission struct (exposes only
