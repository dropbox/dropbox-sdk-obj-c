...
/// in FolderPermission that describes whether the current user can perform the  FolderAction on the
/// folder.
...
///
/// Full constructor for the DBSHARINGGetMetadataArgs struct (exposes all instance variables).
///
...
/// value  :field:`FolderPermission.allow` that describes whether the current user can perform the
/// FolderAction on the folder.
///
/// @return An initialized DBSHARINGGetMetadataArgs instance.
///
...
///
/// Convenience constructor for the DBSHARINGGetMetadataArgs struct (exposes only non-nullable
...
///
/// @return A json-compatible dictionary representation of the DBSHARINGGetMetadataArgs API object.
///
