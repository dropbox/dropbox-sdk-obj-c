...
/// 
/// Full constructor for the DBSHARINGGetMetadataArgs struct (exposes all
/// instance variables).
/// 
...
/// will include a boolean value  :field:`FolderPermission.allow` that describes
...
/// 
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId actions:(NSArray<DBSHARINGFolderAction *> * _Nullable)actions;

/// 
/// Convenience constructor for the DBSHARINGGetMetadataArgs struct (exposes
