...
/// possible tag states with which the DBSHARINGFileMemberActionIndividualResult
/// union can exist.
...
/// member still has access via a parent shared folder. Ensure the isSuccess
/// method returns true before accessing, otherwise a runtime exception will be
/// raised.
@property (nonatomic, readonly) DBSHARINGAccessLevel * _Nullable success;

/// User was not able to perform this action. Ensure the isMemberError method
...
/// 
/// About the Success tag state: Member was successfully removed from this file.
/// If AccessLevel is given, the member still has access via a parent shared
/// folder.
/// 
...
/// folder.
/// 
/// @return An initialized DBSHARINGFileMemberActionIndividualResult instance.
/// 
...
/// 
/// @param instance An instance of the DBSHARINGFileMemberActionIndividualResult
/// API object.
/// 
