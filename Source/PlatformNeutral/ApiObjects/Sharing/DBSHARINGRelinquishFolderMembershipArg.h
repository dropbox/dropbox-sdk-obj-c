...
///
/// Full constructor for the DBSHARINGRelinquishFolderMembershipArg struct (exposes all instance
/// variables).
///
...
///
/// @return An initialized DBSHARINGRelinquishFolderMembershipArg instance.
///
- (nonnull instancetype)initWithSharedFolderId:(NSString * _Nonnull)sharedFolderId
                                    leaveACopy:(NSNumber * _Nullable)leaveACopy;

///
/// Convenience constructor for the DBSHARINGRelinquishFolderMembershipArg struct (exposes only
...
///
/// @param instance An instance of the DBSHARINGRelinquishFolderMembershipArg API object.
///
...
/// DBSHARINGRelinquishFolderMembershipArg API object.
///
/// @return An instantiation of the DBSHARINGRelinquishFolderMembershipArg object.
///
