...
- (instancetype)initWithSharedFolderId:(NSString *)sharedFolderId members:(NSArray<DBSHARINGAddMember *> *)members quiet:(NSNumber *)quiet customMessage:(NSString *)customMessage {
    ...
    [DBStoneValidators nullableValidator:[DBStoneValidators stringValidator:@(1) maxLength:nil pattern:nil]](customMessage);
...
+ (NSDictionary *)serialize:(DBSHARINGAddFolderMemberArg *)valueObj {
    ...
    jsonDict[@"members"] = [DBArraySerializer serialize:valueObj.members withBlock:^id(id elem) { return [DBSHARINGAddMemberSerializer serialize:elem]; }];
...
+ (DBSHARINGAddFolderMemberArg *)deserialize:(NSDictionary *)valueDict {
    ...
    NSArray<DBSHARINGAddMember *> *members = [DBArraySerializer deserialize:valueDict[@"members"] withBlock:^id(id elem) { return [DBSHARINGAddMemberSerializer deserialize:elem]; }];
    NSNumber *quiet = valueDict[@"quiet"];
    NSString *customMessage = valueDict[@"custom_message"] ?: nil;

    return [[DBSHARINGAddFolderMemberArg alloc] initWithSharedFolderId:sharedFolderId members:members quiet:quiet customMessage:customMessage];
}
