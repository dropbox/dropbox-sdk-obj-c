...
/// 
/// Full constructor for the DBSHARINGCollectionLinkMetadata struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url visibility:(DBSHARINGVisibility * _Nonnull)visibility expires:(NSDate * _Nullable)expires;

/// 
/// Convenience constructor for the DBSHARINGCollectionLinkMetadata struct
