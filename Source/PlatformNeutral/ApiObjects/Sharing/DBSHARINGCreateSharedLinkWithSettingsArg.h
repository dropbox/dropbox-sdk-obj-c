...
/// 
/// Full constructor for the DBSHARINGCreateSharedLinkWithSettingsArg struct
...
/// 
/// @return An initialized DBSHARINGCreateSharedLinkWithSettingsArg instance.
/// 
- (nonnull instancetype)initWithPath:(NSString * _Nonnull)path settings:(DBSHARINGSharedLinkSettings * _Nullable)settings;

/// 
/// Convenience constructor for the DBSHARINGCreateSharedLinkWithSettingsArg
...
/// 
/// @param instance An instance of the DBSHARINGCreateSharedLinkWithSettingsArg
/// API object.
/// 
