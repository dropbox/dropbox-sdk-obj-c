...
///
/// Full constructor for the DBSHARINGCreateSharedLinkWithSettingsArg struct (exposes all instance
/// variables).
///
...
///
/// Convenience constructor for the DBSHARINGCreateSharedLinkWithSettingsArg struct (exposes only
