...
/// 
/// Full constructor for the DBSHARINGListFilesResult struct (exposes all
/// instance variables).
/// 
...
/// 
- (nonnull instancetype)initWithEntries:(NSArray<DBSHARINGSharedFileMetadata *> * _Nonnull)entries cursor:(NSString * _Nullable)cursor;

/// 
/// Convenience constructor for the DBSHARINGListFilesResult struct (exposes
