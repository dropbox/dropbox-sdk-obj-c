...
///
/// Full constructor for the DBSHARINGGroupMembershipInfo struct (exposes all instance variables).
///
...
///
/// Convenience constructor for the DBSHARINGGroupMembershipInfo struct (exposes only non-nullable
...
///
/// @param dict A json-compatible dictionary representation of the DBSHARINGGroupMembershipInfo API
/// object.
///
