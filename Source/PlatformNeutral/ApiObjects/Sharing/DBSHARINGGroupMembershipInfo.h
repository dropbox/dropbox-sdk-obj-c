...
/// 
/// Full constructor for the DBSHARINGGroupMembershipInfo struct (exposes all
/// instance variables).
/// 
...
/// 
/// @return An initialized DBSHARINGGroupMembershipInfo instance.
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType group:(DBSHARINGGroupInfo * _Nonnull)group permissions:(NSArray<DBSHARINGMemberPermission *> * _Nullable)permissions initials:(NSString * _Nullable)initials isInherited:(NSNumber * _Nullable)isInherited;

/// 
/// Convenience constructor for the DBSHARINGGroupMembershipInfo struct (exposes
...
/// @return An initialized DBSHARINGGroupMembershipInfo instance.
/// 
- (nonnull instancetype)initWithAccessType:(DBSHARINGAccessLevel * _Nonnull)accessType group:(DBSHARINGGroupInfo * _Nonnull)group;
