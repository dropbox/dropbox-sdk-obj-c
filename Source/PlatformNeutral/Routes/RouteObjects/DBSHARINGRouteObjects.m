...
+ (DBRoute *)DBSHARINGAddFileMember {
    if (!DBSHARINGAddFileMember) {
        DBSHARINGAddFileMember = [[DBRoute alloc] init:
            ...
            arrayDeserialBlock:^id(id array) { return [DBArraySerializer deserialize:array withBlock:^id(id elem) { return [DBSHARINGFileMemberActionResultSerializer deserialize:elem]; }]; }
        ];
    }
...
+ (DBRoute *)DBSHARINGChangeFileMemberAccess {
    if (!DBSHARINGChangeFileMemberAccess) {
        DBSHARINGChangeFileMemberAccess = [[DBRoute alloc] init:
    ...
    if (!DBSHARINGGetFileMetadataBatch) {
        DBSHARINGGetFileMetadataBatch = [[DBRoute alloc] init:
            ...
            attrs:@{@"host": @"api",
                    @"style": @"rpc"}
            arraySerialBlock:nil
            arrayDeserialBlock:^id(id array) { return [DBArraySerializer deserialize:array withBlock:^id(id elem) { return [DBSHARINGGetFileMetadataBatchResultSerializer deserialize:elem]; }]; }
        ];
    }
    ...
    if (!DBSHARINGListFileMembersBatch) {
        DBSHARINGListFileMembersBatch = [[DBRoute alloc] init:
            ...
            attrs:@{@"host": @"api",
                    @"style": @"rpc"}
            arraySerialBlock:nil
            arrayDeserialBlock:^id(id array) { return [DBArraySerializer deserialize:array withBlock:^id(id elem) { return [DBSHARINGListFileMembersBatchResultSerializer deserialize:elem]; }]; }
        ];
    }
