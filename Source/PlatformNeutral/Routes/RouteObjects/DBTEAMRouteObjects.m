...
+ (DBRoute *)DBTEAMAlphaGroupsCreate {
    if (!DBTEAMAlphaGroupsCreate) {
        DBTEAMAlphaGroupsCreate = [[DBRoute alloc] init:
            @"alpha/groups/create"
            namespace_:@"team"
            deprecated:@NO
...
+ (DBRoute *)DBTEAMAlphaGroupsGetInfo {
    if (!DBTEAMAlphaGroupsGetInfo) {
        DBTEAMAlphaGroupsGetInfo = [[DBRoute alloc] init:
            ...
            attrs:@{@"host": @"api",
                    @"style": @"rpc"}
            arraySerialBlock:nil
            arrayDeserialBlock:^id(id array) { return [DBArraySerializer deserialize:array withBlock:^id(id elem) { return [DBTEAMGroupsGetInfoItemSerializer deserialize:elem]; }]; }
        ];
    }
...
+ (DBRoute *)DBTEAMAlphaGroupsList {
    if (!DBTEAMAlphaGroupsList) {
        DBTEAMAlphaGroupsList = [[DBRoute alloc] init:
            @"alpha/groups/list"
            namespace_:@"team"
            deprecated:@NO
...
+ (DBRoute *)DBTEAMAlphaGroupsListContinue {
    if (!DBTEAMAlphaGroupsListContinue) {
        DBTEAMAlphaGroupsListContinue = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMAlphaGroupsUpdate {
    if (!DBTEAMAlphaGroupsUpdate) {
        DBTEAMAlphaGroupsUpdate = [[DBRoute alloc] init:
            @"alpha/groups/update"
            namespace_:@"team"
            deprecated:@NO
            resultType:[DBTEAMGroupFullInfo class]
    ...
    if (!DBTEAMMembersGetInfo) {
        DBTEAMMembersGetInfo = [[DBRoute alloc] init:
            ...
            attrs:@{@"host": @"api",
                    @"style": @"rpc"}
            arraySerialBlock:nil
            arrayDeserialBlock:^id(id array) { return [DBArraySerializer deserialize:array withBlock:^id(id elem) { return [DBTEAMMembersGetInfoItemSerializer deserialize:elem]; }]; }
        ];
    }
...
+ (DBRoute *)DBTEAMPropertiesTemplateList {
    if (!DBTEAMPropertiesTemplateList) {
        DBTEAMPropertiesTemplateList = [[DBRoute alloc] init:
...
+ (DBRoute *)DBTEAMPropertiesTemplateUpdate {
    if (!DBTEAMPropertiesTemplateUpdate) {
        DBTEAMPropertiesTemplateUpdate = [[DBRoute alloc] init:
