...
/// Initializes the DBSHARINGRoutes namespace container object with a networking
/// client.
...
/// 
/// @return Through the response callback, the caller will receive a NSArray<DBSHARINGFileMemberActionResult *> *
/// _Nonnull object on success or a DBSHARINGAddFileMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGFileMemberActionResult *> *, DBSHARINGAddFileMemberError *> * _Nonnull)addFileMember:(NSString * _Nonnull)file members:(NSArray<DBSHARINGMemberSelector *> * _Nonnull)members;
...
/// DBSHARINGAddFolderMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGAddFolderMemberError *> * _Nonnull)addFolderMember:(NSString * _Nonnull)sharedFolderId members:(NSArray<DBSHARINGAddMember *> * _Nonnull)members;
...
/// DBSHARINGAddFolderMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGAddFolderMemberError *> * _Nonnull)addFolderMember:(NSString * _Nonnull)sharedFolderId members:(NSArray<DBSHARINGAddMember *> * _Nonnull)members quiet:(NSNumber * _Nullable)quiet customMessage:(NSString * _Nullable)customMessage;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGFileMemberActionResult * _Nonnull object
/// on success or a DBSHARINGFileMemberActionError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGFileMemberActionResult *, DBSHARINGFileMemberActionError *> * _Nonnull)changeFileMemberAccess:(NSString * _Nonnull)file member:(DBSHARINGMemberSelector * _Nonnull)member accessLevel:(DBSHARINGAccessLevel * _Nonnull)accessLevel;
...
/// the job.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGJobStatus * _Nonnull object on success or
/// a DBASYNCPollError * _Nonnull object on failure.
/// 
...
/// the job.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGRemoveMemberJobStatus * _Nonnull object on
/// success or a DBASYNCPollError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGRemoveMemberJobStatus *, DBASYNCPollError *> * _Nonnull)checkRemoveMemberJobStatus:(NSString * _Nonnull)asyncJobId;
...
/// the job.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGShareFolderJobStatus * _Nonnull object on
/// success or a DBASYNCPollError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGShareFolderJobStatus *, DBASYNCPollError *> * _Nonnull)checkShareJobStatus:(NSString * _Nonnull)asyncJobId;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGPathLinkMetadata * _Nonnull object on
/// success or a DBSHARINGCreateSharedLinkError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGPathLinkMetadata *, DBSHARINGCreateSharedLinkError *> * _Nonnull)createSharedLink:(NSString * _Nonnull)path __deprecated_msg("create_shared_link is deprecated. Use create_shared_link_with_settings.");
...
/// success or a DBSHARINGCreateSharedLinkError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGPathLinkMetadata *, DBSHARINGCreateSharedLinkError *> * _Nonnull)createSharedLink:(NSString * _Nonnull)path shortUrl:(NSNumber * _Nullable)shortUrl pendingUpload:(DBSHARINGPendingUploadMode * _Nullable)pendingUpload __deprecated_msg("create_shared_link is deprecated. Use create_shared_link_with_settings.");
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedLinkMetadata * _Nonnull object on
/// success or a DBSHARINGCreateSharedLinkWithSettingsError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGCreateSharedLinkWithSettingsError *> * _Nonnull)createSharedLinkWithSettings:(NSString * _Nonnull)path;
...
/// success or a DBSHARINGCreateSharedLinkWithSettingsError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGCreateSharedLinkWithSettingsError *> * _Nonnull)createSharedLinkWithSettings:(NSString * _Nonnull)path settings:(DBSHARINGSharedLinkSettings * _Nullable)settings;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFileMetadata * _Nonnull object on
/// success or a DBSHARINGGetFileMetadataError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMetadata *, DBSHARINGGetFileMetadataError *> * _Nonnull)getFileMetadata:(NSString * _Nonnull)file;
...
/// success or a DBSHARINGGetFileMetadataError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMetadata *, DBSHARINGGetFileMetadataError *> * _Nonnull)getFileMetadata:(NSString * _Nonnull)file actions:(NSArray<DBSHARINGFileAction *> * _Nullable)actions;
...
/// _Nonnull object on success or a DBSHARINGSharingUserError * _Nonnull object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGGetFileMetadataBatchResult *> *, DBSHARINGSharingUserError *> * _Nonnull)getFileMetadataBatch:(NSArray<NSString *> * _Nonnull)files;
...
/// _Nonnull object on success or a DBSHARINGSharingUserError * _Nonnull object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGGetFileMetadataBatchResult *> *, DBSHARINGSharingUserError *> * _Nonnull)getFileMetadataBatch:(NSArray<NSString *> * _Nonnull)files actions:(NSArray<DBSHARINGFileAction *> * _Nullable)actions;
...
/// @param sharedFolderId The ID for the shared folder.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFolderMetadata * _Nonnull object on
/// success or a DBSHARINGSharedFolderAccessError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGSharedFolderAccessError *> * _Nonnull)getFolderMetadata:(NSString * _Nonnull)sharedFolderId;
...
/// success or a DBSHARINGSharedFolderAccessError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGSharedFolderAccessError *> * _Nonnull)getFolderMetadata:(NSString * _Nonnull)sharedFolderId actions:(NSArray<DBSHARINGFolderAction *> * _Nullable)actions;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedLinkMetadata * _Nonnull object on
/// success or a DBSHARINGGetSharedLinkFileError * _Nonnull object on failure.
/// 
- (DBDownloadURLTask<DBSHARINGSharedLinkMetadata *, DBSHARINGGetSharedLinkFileError *> * _Nonnull)getSharedLinkFileURL:(NSString * _Nonnull)url overwrite:(BOOL)overwrite destination:(NSURL * _Nonnull)destination;
...
/// success or a DBSHARINGGetSharedLinkFileError * _Nonnull object on failure.
/// 
- (DBDownloadURLTask<DBSHARINGSharedLinkMetadata *, DBSHARINGGetSharedLinkFileError *> * _Nonnull)getSharedLinkFileURL:(NSString * _Nonnull)url path:(NSString * _Nullable)path linkPassword:(NSString * _Nullable)linkPassword overwrite:(BOOL)overwrite destination:(NSURL * _Nonnull)destination;
...
/// success or a DBSHARINGGetSharedLinkFileError * _Nonnull object on failure.
/// 
- (DBDownloadDataTask<DBSHARINGSharedLinkMetadata *, DBSHARINGGetSharedLinkFileError *> * _Nonnull)getSharedLinkFileData:(NSString * _Nonnull)url;
...
/// success or a DBSHARINGGetSharedLinkFileError * _Nonnull object on failure.
/// 
- (DBDownloadDataTask<DBSHARINGSharedLinkMetadata *, DBSHARINGGetSharedLinkFileError *> * _Nonnull)getSharedLinkFileData:(NSString * _Nonnull)url path:(NSString * _Nullable)path linkPassword:(NSString * _Nullable)linkPassword;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedLinkMetadata * _Nonnull object on
/// success or a DBSHARINGSharedLinkError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGSharedLinkError *> * _Nonnull)getSharedLinkMetadata:(NSString * _Nonnull)url;
...
/// success or a DBSHARINGSharedLinkError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGSharedLinkError *> * _Nonnull)getSharedLinkMetadata:(NSString * _Nonnull)url path:(NSString * _Nullable)path linkPassword:(NSString * _Nullable)linkPassword;
...
/// 
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGGetSharedLinksResult * _Nonnull object on
/// success or a DBSHARINGGetSharedLinksError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGGetSharedLinksResult *, DBSHARINGGetSharedLinksError *> * _Nonnull)getSharedLinks __deprecated_msg("get_shared_links is deprecated. Use list_shared_links.");
...
/// success or a DBSHARINGGetSharedLinksError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGGetSharedLinksResult *, DBSHARINGGetSharedLinksError *> * _Nonnull)getSharedLinks:(NSString * _Nullable)path __deprecated_msg("get_shared_links is deprecated. Use list_shared_links.");
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFileMembers * _Nonnull object on
/// success or a DBSHARINGListFileMembersError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMembers *, DBSHARINGListFileMembersError *> * _Nonnull)listFileMembers:(NSString * _Nonnull)file;
...
/// success or a DBSHARINGListFileMembersError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMembers *, DBSHARINGListFileMembersError *> * _Nonnull)listFileMembers:(NSString * _Nonnull)file actions:(NSArray<DBSHARINGMemberAction *> * _Nullable)actions includeInherited:(NSNumber * _Nullable)includeInherited limit:(NSNumber * _Nullable)limit;
...
/// _Nonnull object on success or a DBSHARINGSharingUserError * _Nonnull object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGListFileMembersBatchResult *> *, DBSHARINGSharingUserError *> * _Nonnull)listFileMembersBatch:(NSArray<NSString *> * _Nonnull)files;
...
/// _Nonnull object on success or a DBSHARINGSharingUserError * _Nonnull object on failure.
/// 
- (DBRpcTask<NSArray<DBSHARINGListFileMembersBatchResult *> *, DBSHARINGSharingUserError *> * _Nonnull)listFileMembersBatch:(NSArray<NSString *> * _Nonnull)files limit:(NSNumber * _Nullable)limit;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFileMembers * _Nonnull object on
/// success or a DBSHARINGListFileMembersContinueError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFileMembers *, DBSHARINGListFileMembersContinueError *> * _Nonnull)listFileMembersContinue:(NSString * _Nonnull)cursor;
...
/// @param sharedFolderId The ID for the shared folder.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFolderMembers * _Nonnull object on
/// success or a DBSHARINGSharedFolderAccessError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMembers *, DBSHARINGSharedFolderAccessError *> * _Nonnull)listFolderMembers:(NSString * _Nonnull)sharedFolderId;
...
/// success or a DBSHARINGSharedFolderAccessError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMembers *, DBSHARINGSharedFolderAccessError *> * _Nonnull)listFolderMembers:(NSString * _Nonnull)sharedFolderId actions:(NSArray<DBSHARINGMemberAction *> * _Nullable)actions limit:(NSNumber * _Nullable)limit;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFolderMembers * _Nonnull object on
/// success or a DBSHARINGListFolderMembersContinueError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMembers *, DBSHARINGListFolderMembersContinueError *> * _Nonnull)listFolderMembersContinue:(NSString * _Nonnull)cursor;
...
/// 
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGListFoldersResult * _Nonnull object on
...
/// @param actions This is a list indicating whether each returned folder data entry will include a boolean field allow
/// in FolderPermission that describes whether the current user can perform the `FolderAction` on the folder.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGListFoldersResult * _Nonnull object on
/// success or a void object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBNilObject *> * _Nonnull)listFolders:(NSNumber * _Nullable)limit actions:(NSArray<DBSHARINGFolderAction *> * _Nullable)actions;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGListFoldersResult * _Nonnull object on
/// success or a DBSHARINGListFoldersContinueError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBSHARINGListFoldersContinueError *> * _Nonnull)listFoldersContinue:(NSString * _Nonnull)cursor;
...
/// success or a void object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBNilObject *> * _Nonnull)listMountableFolders:(NSNumber * _Nullable)limit actions:(NSArray<DBSHARINGFolderAction *> * _Nullable)actions;
...
/// success or a DBSHARINGListFoldersContinueError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGListFoldersResult *, DBSHARINGListFoldersContinueError *> * _Nonnull)listMountableFoldersContinue:(NSString * _Nonnull)cursor;
...
/// 
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGListFilesResult * _Nonnull object on
/// success or a DBSHARINGSharingUserError * _Nonnull object on failure.
/// 
...
/// success or a DBSHARINGSharingUserError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGListFilesResult *, DBSHARINGSharingUserError *> * _Nonnull)listReceivedFiles:(NSNumber * _Nullable)limit actions:(NSArray<DBSHARINGFileAction *> * _Nullable)actions;

/// 
/// Get more results with a cursor from listReceivedFiles.
/// 
/// @param cursor Cursor in cursor in ListFilesResult
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGListFilesResult * _Nonnull object on
/// success or a DBSHARINGListFilesContinueError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGListFilesResult *, DBSHARINGListFilesContinueError *> * _Nonnull)listReceivedFilesContinue:(NSString * _Nonnull)cursor;
...
/// 
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGListSharedLinksResult * _Nonnull object on
/// success or a DBSHARINGListSharedLinksError * _Nonnull object on failure.
/// 
...
/// success or a DBSHARINGListSharedLinksError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGListSharedLinksResult *, DBSHARINGListSharedLinksError *> * _Nonnull)listSharedLinks:(NSString * _Nullable)path cursor:(NSString * _Nullable)cursor directOnly:(NSNumber * _Nullable)directOnly;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedLinkMetadata * _Nonnull object on
/// success or a DBSHARINGModifySharedLinkSettingsError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGModifySharedLinkSettingsError *> * _Nonnull)modifySharedLinkSettings:(NSString * _Nonnull)url settings:(DBSHARINGSharedLinkSettings * _Nonnull)settings;
...
/// success or a DBSHARINGModifySharedLinkSettingsError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedLinkMetadata *, DBSHARINGModifySharedLinkSettingsError *> * _Nonnull)modifySharedLinkSettings:(NSString * _Nonnull)url settings:(DBSHARINGSharedLinkSettings * _Nonnull)settings removeExpiration:(NSNumber * _Nullable)removeExpiration;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFolderMetadata * _Nonnull object on
/// success or a DBSHARINGMountFolderError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGMountFolderError *> * _Nonnull)mountFolder:(NSString * _Nonnull)sharedFolderId;
...
/// 
/// @return Through the response callback, the caller will receive a void object on success or a
/// DBSHARINGRelinquishFileMembershipError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGRelinquishFileMembershipError *> * _Nonnull)relinquishFileMembership:(NSString * _Nonnull)file;
...
/// success or a DBSHARINGRelinquishFolderMembershipError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGRelinquishFolderMembershipError *> * _Nonnull)relinquishFolderMembership:(NSString * _Nonnull)sharedFolderId;
...
/// success or a DBSHARINGRelinquishFolderMembershipError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGRelinquishFolderMembershipError *> * _Nonnull)relinquishFolderMembership:(NSString * _Nonnull)sharedFolderId leaveACopy:(NSNumber * _Nullable)leaveACopy;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGFileMemberActionIndividualResult *
/// _Nonnull object on success or a DBSHARINGRemoveFileMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGFileMemberActionIndividualResult *, DBSHARINGRemoveFileMemberError *> * _Nonnull)removeFileMember:(NSString * _Nonnull)file member:(DBSHARINGMemberSelector * _Nonnull)member __deprecated_msg("remove_file_member is deprecated. Use remove_file_member_2.");
...
/// of a user (not an invitee) if the user's main account corresponds to that email address.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGFileMemberRemoveActionResult * _Nonnull
/// object on success or a DBSHARINGRemoveFileMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGFileMemberRemoveActionResult *, DBSHARINGRemoveFileMemberError *> * _Nonnull)removeFileMember2:(NSString * _Nonnull)file member:(DBSHARINGMemberSelector * _Nonnull)member;
...
/// 
/// @return Through the response callback, the caller will receive a DBASYNCLaunchResultBase * _Nonnull object on
/// success or a DBSHARINGRemoveFolderMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchResultBase *, DBSHARINGRemoveFolderMemberError *> * _Nonnull)removeFolderMember:(NSString * _Nonnull)sharedFolderId member:(DBSHARINGMemberSelector * _Nonnull)member leaveACopy:(NSNumber * _Nonnull)leaveACopy;
...
/// 
/// @return Through the response callback, the caller will receive a void object on success or a
/// DBSHARINGRevokeSharedLinkError * _Nonnull object on failure.
/// 
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGShareFolderLaunch * _Nonnull object on
/// success or a DBSHARINGShareFolderError * _Nonnull object on failure.
/// 
...
/// success or a DBSHARINGShareFolderError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGShareFolderLaunch *, DBSHARINGShareFolderError *> * _Nonnull)shareFolder:(NSString * _Nonnull)path memberPolicy:(DBSHARINGMemberPolicy * _Nullable)memberPolicy aclUpdatePolicy:(DBSHARINGAclUpdatePolicy * _Nullable)aclUpdatePolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy * _Nullable)sharedLinkPolicy forceAsync:(NSNumber * _Nullable)forceAsync;
...
/// 
/// @return Through the response callback, the caller will receive a void object on success or a
/// DBSHARINGTransferFolderError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBNilObject *, DBSHARINGTransferFolderError *> * _Nonnull)transferFolder:(NSString * _Nonnull)sharedFolderId toDropboxId:(NSString * _Nonnull)toDropboxId;
...
/// 
/// @return Through the response callback, the caller will receive a void object on success or a
/// DBSHARINGUnmountFolderError * _Nonnull object on failure.
/// 
...
/// 
/// @return Through the response callback, the caller will receive a void object on success or a
/// DBSHARINGUnshareFileError * _Nonnull object on failure.
/// 
...
/// 
/// @return Through the response callback, the caller will receive a DBASYNCLaunchEmptyResult * _Nonnull object on
/// success or a DBSHARINGUnshareFolderError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGUnshareFolderError *> * _Nonnull)unshareFolder:(NSString * _Nonnull)sharedFolderId;
...
/// success or a DBSHARINGUnshareFolderError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBASYNCLaunchEmptyResult *, DBSHARINGUnshareFolderError *> * _Nonnull)unshareFolder:(NSString * _Nonnull)sharedFolderId leaveACopy:(NSNumber * _Nullable)leaveACopy;
...
/// 
/// @param sharedFolderId The ID for the shared folder.
/// @param member The member of the shared folder to update.  Only the dropboxId in MemberSelector may be set at this
/// time.
/// @param accessLevel The new access level for member. owner in AccessLevel is disallowed.
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGMemberAccessLevelResult * _Nonnull object
/// on success or a DBSHARINGUpdateFolderMemberError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGMemberAccessLevelResult *, DBSHARINGUpdateFolderMemberError *> * _Nonnull)updateFolderMember:(NSString * _Nonnull)sharedFolderId member:(DBSHARINGMemberSelector * _Nonnull)member accessLevel:(DBSHARINGAccessLevel * _Nonnull)accessLevel;
...
/// 
/// @return Through the response callback, the caller will receive a DBSHARINGSharedFolderMetadata * _Nonnull object on
/// success or a DBSHARINGUpdateFolderPolicyError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGUpdateFolderPolicyError *> * _Nonnull)updateFolderPolicy:(NSString * _Nonnull)sharedFolderId;
...
/// success or a DBSHARINGUpdateFolderPolicyError * _Nonnull object on failure.
/// 
- (DBRpcTask<DBSHARINGSharedFolderMetadata *, DBSHARINGUpdateFolderPolicyError *> * _Nonnull)updateFolderPolicy:(NSString * _Nonnull)sharedFolderId memberPolicy:(DBSHARINGMemberPolicy * _Nullable)memberPolicy aclUpdatePolicy:(DBSHARINGAclUpdatePolicy * _Nullable)aclUpdatePolicy sharedLinkPolicy:(DBSHARINGSharedLinkPolicy * _Nullable)sharedLinkPolicy;
