...
+ (NSArray<NSString *> *)getAll {
    NSMutableDictionary <NSString *, id> * query = [DBKeychain queryWithDict:@{(NSString *)kSecReturnAttributes: (id)kCFBooleanTrue, (NSString *)kSecMatchLimit: (id)kSecMatchLimitAll }];
